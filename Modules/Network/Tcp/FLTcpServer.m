...
- (void) _addConnection:(FLTcpConnection*) connection {
    ...
    [connection addObserver: [FLNetworkConnectionObserver networkConnectionObserver:self]];
...
//        fprintf(stderr, "CFStreamCreatePairWithSocket() failed\n");
    ...
    [newConnection openConnectionOnCurrentThread];
}
...
void FLTcpServerAcceptCallBack(
    ...
    void *info)
{
    FLTcpServer* server = (FLTcpServer*) info;
    [server _handleNewConnection:socket 
        addressData:(NSData*) address 
...
//	}
    ...
    if (CFSocketSetAddress(_socket, (CFDataRef) addressData) != kCFSocketSuccess) {
