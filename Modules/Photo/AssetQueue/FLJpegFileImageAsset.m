...
- (void) dealloc
{
	...
	FLReleaseWithNil(m_fullScreenImageFile);
	FLReleaseWithNil(m_originalImageFile);
	FLReleaseWithNil(m_thumbnailImageFile);
	FLSuperDealloc();
}
...
- (id<FLStorableImage>) original
{
	...
	{
		m_originalImageFile = [[FLJpegFile alloc] initWithJpegData:nil 
			folder:m_folder
...
- (id<FLStorableImage>) thumbnail
{
	...
	{
		m_thumbnailImageFile = [[FLJpegFile alloc] initWithJpegData:nil 
			folder:m_folder
...
- (id<FLStorableImage>) fullScreen
{
	...
	{
		m_fullScreenImageFile = [[FLJpegFile alloc] initWithJpegData:nil 
			folder:m_folder
...
//	  FLAssert(startImage != nil, @"no image to create thumbnail with");
//	
...
//		[original shrinkImage:&fullSized maxLongSide:s_fullSize makeSquare:NO];
		...
		FLAssert(self.original.hasImage, @"no image to create full screen version");
