...
NSError* DisplayDiagnosticError(NSError* error)
{
    @try {
        ...
        if(error) 
        {
            FLAlertViewController* alertView =  [FLAlertViewController alertViewController:@"-- DIAGNOSTIC ERROR --" message:[error description]];
...
- (BOOL) locationServicesAreAuthorized
{
    ...
    switch([CLLocationManager authorizationStatus])
    {
        ...
        case kCLAuthorizationStatusNotDetermined:
            ...
            FLAssertFailed(@"Should never get here!");
...
- (void) beginLoadingGroupOfGroupType:(ALAssetsGroupType) groupType 
                         ...
                         shouldCancel:(FLShouldCancelBlock) shouldCancel
{
    FLAssertIsNotNil(doneBlock);
    FLAssertIsNotNil(shouldCancel);
