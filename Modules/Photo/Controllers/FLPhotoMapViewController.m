...
- (void) viewDidLoad
{
	...
	[self.buttonbar addViewToRightSide:[FLButtonbarView createImageButtonByName:@"map_pin.png" imageColor:FLImageColorBlack target:self action:@selector(_resetZoom:)] forKey:@"zoom" animated:NO];
