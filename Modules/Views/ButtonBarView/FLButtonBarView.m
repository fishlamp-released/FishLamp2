...
@interface FLButtonbarView ()
- (void) updateLayout:(BOOL) animated;
@end

@implementation FLButtonbarView {
@private
	UILabel* _label;
...
//{
//	UIButton* button = [FLButtonbarView createImageButton:image target:target action:action];
//	button.tag = kResizableView;
//	[self addViewToRightSide:button forKey:key animated:animated];
//}
//
...
{
    FLButtonbarView* toolbar = FLReturnAutoreleased([[FLButtonbarView alloc] initWithFrame:CGRectMake(0,0,viewController.view.frame.size.width, 44)]);
