...
+ (FLSqliteTable*) sharedSqliteTable
{
    ...
    dispatch_once(&pred, ^{
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"userName" columnType:FLSqliteTypeText columnConstraints:[NSArray arrayWithObjects:[FLSqliteColumn uniqueConstraint], nil]]];
        [s_table addIndex:[FLSqliteIndex sqliteIndex:@"userName" indexProperties:FLSqliteColumnIndexPropertyUnique]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"isAuthenticated" columnType:FLSqliteTypeInteger columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"authToken" columnType:FLSqliteTypeText columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"email" columnType:FLSqliteTypeText columnConstraints:[NSArray arrayWithObjects:[FLSqliteColumn uniqueConstraint], nil]]];
        [s_table addIndex:[FLSqliteIndex sqliteIndex:@"email" indexProperties:FLSqliteColumnIndexPropertyUnique]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"authTokenLastUpdateTime" columnType:FLSqliteTypeFloat columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"userValue" columnType:FLSqliteTypeInteger columnConstraints:nil]];
    });
    return s_table;
}
