...
- (id) initWithCoder:(NSCoder*) aDecoder
{
    if((self = [super init]))
    {
        ...
        __appName = FLReturnRetained([aDecoder decodeObjectForKey:@"__appName"]);
        __oauth_token = FLReturnRetained([aDecoder decodeObjectForKey:@"__oauth_token"]);
        __oauth_token_secret = FLReturnRetained([aDecoder decodeObjectForKey:@"__oauth_token_secret"]);
        __user_id = FLReturnRetained([aDecoder decodeObjectForKey:@"__user_id"]);
        __screen_name = FLReturnRetained([aDecoder decodeObjectForKey:@"__screen_name"]);
    }
    return self;
}
...
{
    return FLReturnAutoreleased([[FLOAuthSession alloc] init]);
}
...
+ (FLSqliteTable*) sharedSqliteTable
{
    ...
    dispatch_once(&pred, ^{
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"userGuid" columnType:FLSqliteTypeText columnConstraints:[NSArray arrayWithObject:[FLSqliteColumn primaryKeyConstraint]]]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"appName" columnType:FLSqliteTypeText columnConstraints:[NSArray arrayWithObjects:[FLSqliteColumn notNullConstraint], nil]]];
        [s_table addIndex:[FLSqliteIndex sqliteIndex:@"appName" indexProperties:FLSqliteColumnIndexPropertyNone]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"oauth_token" columnType:FLSqliteTypeText columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"oauth_token_secret" columnType:FLSqliteTypeText columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"user_id" columnType:FLSqliteTypeText columnConstraints:nil]];
        [s_table addIndex:[FLSqliteIndex sqliteIndex:@"user_id" indexProperties:FLSqliteColumnIndexPropertyNone]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"screen_name" columnType:FLSqliteTypeText columnConstraints:nil]];
    });
    return s_table;
}
