...
+ (FLSqliteTable*) sharedSqliteTable
{
    ...
    dispatch_once(&pred, ^{
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"oauth_callback_confirmed" columnType:FLSqliteTypeText columnConstraints:nil]];
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"oauth_verifier" columnType:FLSqliteTypeText columnConstraints:nil]];
    });
    return s_table;
}
