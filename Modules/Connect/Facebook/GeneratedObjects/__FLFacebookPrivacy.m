...
{
    return FLReturnAutoreleased([[FLFacebookPrivacy alloc] init]);
}
...
- (id) initWithCoder:(NSCoder*) aDecoder
{
    if((self = [super init]))
    {
        __value = FLReturnRetained([aDecoder decodeObjectForKey:@"__value"]);
        __friends = FLReturnRetained([aDecoder decodeObjectForKey:@"__friends"]);
        __networks = FLReturnRetained([aDecoder decodeObjectForKey:@"__networks"]);
        __deny = FLReturnRetained([aDecoder decodeObjectForKey:@"__deny"]);
...
+ (FLSqliteTable*) sharedSqliteTable
{
    ...
    dispatch_once(&pred, ^{
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"value" columnType:FLSqliteTypeText columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"friends" columnType:FLSqliteTypeText columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"networks" columnType:FLSqliteTypeText columnConstraints:nil]];
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"deny" columnType:FLSqliteTypeText columnConstraints:nil]];
