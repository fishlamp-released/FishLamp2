...
@implementation FLFacebookCommentList
...
- (void) copySelfTo:(id) object
{
    ...
    ((FLFacebookCommentList*)object).count = FLCopyOrRetainObject(__count);
    ((FLFacebookCommentList*)object).data = FLCopyOrRetainObject(__data);
}
...
{
    return FLReturnAutoreleased([[FLFacebookCommentList alloc] init]);
}
...
@implementation FLFacebookCommentList (ValueProperties) 
