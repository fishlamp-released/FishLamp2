...
+ (FLSqliteTable*) sharedSqliteTable
{
    ...
    dispatch_once(&pred, ^{
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"start_time" columnType:FLSqliteTypeDate columnConstraints:nil]];
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"venue" columnType:FLSqliteTypeText columnConstraints:nil]];
