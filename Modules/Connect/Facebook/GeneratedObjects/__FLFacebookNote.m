...
{
    return FLReturnAutoreleased([[FLFacebookNote alloc] init]);
}
...
- (id) initWithCoder:(NSCoder*) aDecoder
{
    if((self = [super initWithCoder:aDecoder]))
    {
        ...
        __subject = FLReturnRetained([aDecoder decodeObjectForKey:@"__subject"]);
...
+ (FLSqliteTable*) sharedSqliteTable
{
    ...
    dispatch_once(&pred, ^{
        ...
        [s_table addColumn:[FLSqliteColumn sqliteColumnWithColumnName:@"subject" columnType:FLSqliteTypeText columnConstraints:nil]];
