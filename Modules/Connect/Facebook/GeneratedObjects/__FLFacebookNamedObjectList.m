...
- (void) copySelfTo:(id) object
{
    ...
    ((FLFacebookNamedObjectList*)object).count = FLCopyOrRetainObject(__count);
    ((FLFacebookNamedObjectList*)object).data = FLCopyOrRetainObject(__data);
}
...
{
    return FLReturnAutoreleased([[FLFacebookNamedObjectList alloc] init]);
}
...
@implementation FLFacebookNamedObjectList (ValueProperties) 
