...
//	email.delegate = self;
	...
	FLStringBuilder* builder = [[FLStringBuilder alloc] init];
				  ...
				  error:(NSError *)error
{
	if(result == MFMailComposeResultFailed) {
		FLAlertViewController* alert = [FLAlertViewController alertViewController:NSLocalizedString(@"Sending email failed", nil)
