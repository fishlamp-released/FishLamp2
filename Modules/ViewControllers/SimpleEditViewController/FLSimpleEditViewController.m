...
{
    self.contentView.subviewArrangement = [FLFillInBoundsArrangement arrangement];
}
...
//                                        UIViewAutoresizingFlexibleWidth;
    _contentView.subviewArrangement.arrangementInsets = FLEdgeInsets10;
...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    if(self.floatingViewController)
	{
        ...
        contentView.frameOptimizedForLocation = FLRectSetSizeWithSize(contentView.frame, 
            [contentView.subviewArrangement performArrangement:contentView.subviews inBounds:contentView.bounds]);
        
//        [contentView.subviewArrangement setViewSize:contentView];
