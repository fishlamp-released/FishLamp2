...
{
    if(FLBitTest(self.buttonMode, FLWebViewControllerButtonModeNavigationButtonsOnTop))
    {
    ...
    else if(FLBitTest(self.buttonMode, FLWebViewControllerButtonModeNavigationButtonsOnBottom))
    {
...
- (void) viewDidLoad
{
	...
	if(FLBitTest(self.buttonMode, FLWebViewControllerButtonModeNavigationButtonsOnTop))
	{
		[self.buttonbar addViewToLeftSide:[FLButtonbarView createImageButtonByName:@"back.png" imageColor:FLImageColorBlack target:self action:@selector(buttonClickBack:)]  forKey:@"back" animated:NO]; 

		[self.buttonbar addViewToLeftSide:[FLButtonbarView createImageButtonByName:@"forward.png" imageColor:FLImageColorBlack target:self action:@selector(buttonClickForward:)]  forKey:@"forward" animated:NO]; 
			
		[self.buttonbar addViewToRightSide:[FLButtonbarView createImageButtonByName:@"reload.png" imageColor:FLImageColorBlack target:self action:@selector(buttonClickReload:)]  forKey:@"reload" animated:NO]; 
	}
    else if(FLBitTest(self.buttonMode, FLWebViewControllerButtonModeNavigationButtonsOnBottom))
    {
    ...
    if(FLBitTest(self.buttonMode, FLWebViewControllerButtonModeCanCancel))
    {
