...
{
	FLAssertIsNotNil(cachedImage);
	FLAssert([cachedImage isKindOfClass:[FLCachedImage class]], @"wrong type of class for image cache");
...
- (id) loadObjectFromMemoryCache:(FLCachedImage*) inputObject
{
	...
	FLAssert([inputObject isKindOfClass:[FLCachedImage class]], @"wrong type of class for image cache");
...
{
	FLAssertIsNotNil(cachedImage);
	FLAssert([cachedImage isKindOfClass:[FLCachedImage class]], @"wrong class in image cache");
...
- (id) createNewObjectForOutput:(FLCachedImage*) inputObject
{
	FLAssert([inputObject isKindOfClass:[FLCachedImage class]], @"wrong class in image cache");
