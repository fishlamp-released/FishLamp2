...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.subviewArrangement = [FLCenterJustifiedColumnArrangement arrangement];
        self.subviewArrangement.arrangeableInsets = UIEdgeInsetsMake(0,5,0,5);
    }
    return self;
}
...
- (void) layoutSubviews {
    ...
    [self layoutSubviewsWithArrangement:self.subviewArrangement
                         adjustViewSize:NO];
}
