...
/*
FLDialogViewStyleBlock FLAlertViewControllerStyleDefault = ^(FLDialogView* alert) {
    alert.padding = 20.0f;
...
FLDialogViewStyleBlock FLAlertViewControllerStyleNotificationBar = ^(FLDialogView* alert) {
    alert.padding = 10.0f;
...
//    view.buttonContainerView.subviewArrangement = [FLCenterJustifiedColumnArrangement arrangement];
//    view.buttonContainerView.subviewArrangement.arrangeableInsets = UIEdgeInsetsMake(0,5,0,5);
