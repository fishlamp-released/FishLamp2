...
+(void) didRegisterObjectDescriber:(FLObjectDescriber*) describer {
    [describer addContainerType:[FLPropertyDescriber propertyDescriber:@"comment" propertyClass:[FLFacebookComment class]] forContainerProperty:@"data"];
}
