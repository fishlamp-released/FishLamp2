...
@interface ZFApiSoapShareFavoritesSet : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFShareFavoritesSet* _input;
    ZFShareFavoritesSetResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFShareFavoritesSet* input;
@property (readonly, strong, nonatomic) NSString* location;
@property (readonly, strong, nonatomic) NSString* operationName;
@property (readwrite, strong, nonatomic) ZFShareFavoritesSetResponse* output;
