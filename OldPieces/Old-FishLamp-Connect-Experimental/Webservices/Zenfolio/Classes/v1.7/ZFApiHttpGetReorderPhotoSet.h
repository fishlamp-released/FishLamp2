...
@interface ZFApiHttpGetReorderPhotoSet : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFReorderPhotoSetHttpGetIn* _input;
    ZFReorderPhotoSetHttpGetOut* _output;
}

@property (readwrite, strong, nonatomic) ZFReorderPhotoSetHttpGetIn* input;
@property (readonly, strong, nonatomic) NSString* location;
@property (readonly, strong, nonatomic) NSString* operationName;
@property (readwrite, strong, nonatomic) ZFReorderPhotoSetHttpGetOut* output;
