...
@interface ZFApiSoapReplacePhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFReplacePhoto* _input;
    ZFReplacePhotoResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFReplacePhoto* input;
@property (readonly, strong, nonatomic) NSString* location;
@property (readonly, strong, nonatomic) NSString* operationName;
@property (readwrite, strong, nonatomic) ZFReplacePhotoResponse* output;
