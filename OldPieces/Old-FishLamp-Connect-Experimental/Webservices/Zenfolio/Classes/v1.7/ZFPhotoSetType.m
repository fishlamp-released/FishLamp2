...
+ (id) enumSet:(NSString*) concatenatedEnumString {
    ZFPhotoSetTypeEnumSet* outObject = FLAutorelease([[[self class] alloc] initWithValueLookup:(FLEnumSetEnumValueLookup*)  ZFPhotoSetTypeEnumFromString stringLookup:(FLEnumSetEnumStringLookup*) ZFPhotoSetTypeStringFromEnum]);
