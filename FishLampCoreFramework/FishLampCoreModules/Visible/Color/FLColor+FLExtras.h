...
#if IOS
#define FLRgbColor(r,g,b,a) [FLColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:a]
#else
#define FLRgbColor(r,g,b,a) [FLColor colorWithDeviceRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:a]
#endif

@interface FLColor (FLExtras)
