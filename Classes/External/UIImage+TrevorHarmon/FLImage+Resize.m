...
#import "FLImage+RoundedCorner.h"
...
- (FLImage *)croppedImage:(FLRect)bounds {
#if IOS
	CGImageRef imageRef = CGImageCreateWithImageInRect([self CGImage], bounds);
	FLImage *croppedImage = [FLImage imageWithCGImage:imageRef];
				 ...
				 makeSquare:(BOOL) makeSquare 
{
	...
	FLImage *resizedImage = [self resizedImageWithContentMode:UIViewContentModeScaleAspectFill
	...
	FLImage *transparentBorderImage = borderSize ? [resizedImage transparentBorderImage:borderSize] : resizedImage;
...
- (FLImage *)resizedImage:(FLSize)newSize
	...
	if(bitmap)
	{
		...
		// Get the resized image from the context and a FLImage
		CGImageRef newImageRef = CGBitmapContextCreateImage(bitmap);
		if(newImageRef)
		{
			newImage = [FLImage imageWithCGImage:newImageRef];
		}
