...
typedef NSString* (^FLNetworkTimeoutObserverFormatMessage)(FLNetworkConnectionIdleObserver* observer, FLNetworkConnection* connection); 

@interface FLNetworkConnectionIdleObserver : FLNetworkConnectionObserver {
@private
