...
NSString* GtPrettyStringForCoordinate(CLLocationCoordinate2D coordinate)
{
...
CLLocationCoordinate2D GtCoordinateFromGpsExif(NSDictionary* gpsDict)
{
...
void GtAddLocationToGpsExif(NSMutableDictionary* locDict, CLLocation* lastLocation)
{
...
NSString* GtGpsDateFormattedForExif(NSDate* date)
{
