...
- (void)base64Encode:(NSData**) outData
{
	...
	@try
	{
		...
		{
			GtThrowError([NSError errorWithDomain:NSCocoaErrorDomain code:NSFormattingError userInfo:nil]);
		}
	}
	@finally
	{
