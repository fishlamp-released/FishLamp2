...
{
   FLBannerTableViewCell* cell = FLReturnAutoreleased([[[self class] alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"FLBannerTableCell"]);
...
{
   FLCenteredBannerTableViewCell* cell = FLReturnAutoreleased([[FLCenteredBannerTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"FLCenteredBannerCell"]);
   cell.textLabelText = banner;
   return cell;
}
