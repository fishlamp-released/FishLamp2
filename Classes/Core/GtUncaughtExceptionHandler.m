...
{
	GtLog(@"unhandled exception: %@", [exception description]);
...
void HandleException(NSException *exception)
{
	...
	NSArray *callStack = [GtUncaughtExceptionHandler backtrace];
	...
	[GtReturnAutoreleased([[GtUncaughtExceptionHandler alloc] init])
