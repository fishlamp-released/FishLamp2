...
/// @brief GtLinkedList is a class for fast linked lists. 
...
///
/// For example, if you had a list of sprites that are GtLinkedListElement objects 
...
@interface GtLinkedList : NSObject<NSFastEnumeration> {
@private
	id _firstObject;
	id _lastObject;
...
- (GtLinkedList*) moveAllObjectsToNewList; // not thread safe. 
