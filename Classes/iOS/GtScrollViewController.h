...
@interface GtScrollViewController : GtViewController<GtPullToRefreshHeaderViewDelegate, UIScrollViewDelegate> {
@private

    UIScrollView* m_scrollView;
	GtPullToRefreshHeaderView* m_pullToRefreshView;
	struct {
		unsigned int wantsPullToRefresh:1;
	} m_scrollViewControllerFlags;
}
