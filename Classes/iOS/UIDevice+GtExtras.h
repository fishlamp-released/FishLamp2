...
#define GtNavigationBarHeightPortrait 44
#define GtNavigationBarHeightLandscape 32
#define GtKeyboardHeight 216
#define GtStatusBarHeight 20
#define GtToolbarHeightPortrait 44
#define GtToolbarHeightLandscape 44
