...
@implementation GtTableCellBackgroundWidget
@synthesize selectionStyle = m_selectionStyle;

- (void) setHighlighted:(BOOL) highlighted
{
	if(!highlighted || m_selectionStyle != UITableViewCellSelectionStyleNone)
	{
