...
@interface ZFApiHttpPostSetGroupTitlePhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFSetGroupTitlePhotoHttpPostIn* input;
@property (readwrite, strong, nonatomic) ZFSetGroupTitlePhotoHttpPostOut* output;
