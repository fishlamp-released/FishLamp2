...
@interface ZFApiHttpPostCreateVideoFromUrl : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFCreateVideoFromUrlHttpPostIn* _input;
    long _output;
}

@property (readwrite, strong, nonatomic) ZFCreateVideoFromUrlHttpPostIn* input;
