...
@interface ZFApiHttpPostReorderGroup : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFReorderGroupHttpPostIn* input;
@property (readwrite, strong, nonatomic) ZFReorderGroupHttpPostOut* output;
