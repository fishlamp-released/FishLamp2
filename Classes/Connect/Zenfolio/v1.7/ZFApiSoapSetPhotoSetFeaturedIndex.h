...
@interface ZFApiSoapSetPhotoSetFeaturedIndex : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFSetPhotoSetFeaturedIndex* _input;
    ZFSetPhotoSetFeaturedIndexResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFSetPhotoSetFeaturedIndexResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFSetPhotoSetFeaturedIndex* input;
