...
@interface ZFApiHttpPostReplacePhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFReplacePhotoHttpPostIn* input;
@property (readwrite, strong, nonatomic) ZFReplacePhotoHttpPostOut* output;
