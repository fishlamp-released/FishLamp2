...
@interface ZFApiHttpPostAuthenticateVisitor : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFAuthenticateVisitorHttpPostIn* _input;
    NSString* _output;
}

@property (readwrite, strong, nonatomic) ZFAuthenticateVisitorHttpPostIn* input;
