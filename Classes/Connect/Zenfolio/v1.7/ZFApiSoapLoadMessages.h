...
@interface ZFApiSoapLoadMessages : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFLoadMessages* _input;
    ZFLoadMessagesResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFLoadMessagesResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFLoadMessages* input;
