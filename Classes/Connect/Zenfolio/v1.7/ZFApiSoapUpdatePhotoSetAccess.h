...
@interface ZFApiSoapUpdatePhotoSetAccess : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFUpdatePhotoSetAccess* _input;
    ZFUpdatePhotoSetAccessResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFUpdatePhotoSetAccessResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFUpdatePhotoSetAccess* input;
