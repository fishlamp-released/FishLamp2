...
@interface ZFApiHttpGetSetGroupTitlePhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFSetGroupTitlePhotoHttpGetIn* input;
@property (readwrite, strong, nonatomic) ZFSetGroupTitlePhotoHttpGetOut* output;
