...
@interface ZFApiHttpPostCollectionAddPhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFCollectionAddPhotoHttpPostIn* _input;
    ZFCollectionAddPhotoHttpPostOut* _output;
}

@property (readwrite, strong, nonatomic) ZFCollectionAddPhotoHttpPostIn* input;
@property (readonly, strong, nonatomic) NSString* location;
@property (readonly, strong, nonatomic) NSString* operationName;
@property (readwrite, strong, nonatomic) ZFCollectionAddPhotoHttpPostOut* output;
