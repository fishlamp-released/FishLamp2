...
@interface ZFApiHttpPostCollectionRemovePhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFCollectionRemovePhotoHttpPostIn* input;
@property (readwrite, strong, nonatomic) ZFCollectionRemovePhotoHttpPostOut* output;
