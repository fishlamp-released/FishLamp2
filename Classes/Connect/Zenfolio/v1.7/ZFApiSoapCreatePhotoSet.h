...
@interface ZFApiSoapCreatePhotoSet : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFCreatePhotoSet* _input;
    ZFCreatePhotoSetResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFCreatePhotoSetResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFCreatePhotoSet* input;
