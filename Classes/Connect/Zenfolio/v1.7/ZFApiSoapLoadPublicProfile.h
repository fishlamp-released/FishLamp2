...
@interface ZFApiSoapLoadPublicProfile : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFLoadPublicProfile* _input;
    ZFLoadPublicProfileResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFLoadPublicProfileResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFLoadPublicProfile* input;
