...
@interface ZFApiHttpPostLoadGroupHierarchy : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFLoadGroupHierarchyHttpPostIn* input;
