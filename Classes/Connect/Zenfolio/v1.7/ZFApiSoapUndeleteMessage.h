...
@interface ZFApiSoapUndeleteMessage : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFUndeleteMessage* _input;
    ZFUndeleteMessageResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFUndeleteMessageResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFUndeleteMessage* input;
