...
@class ZFLoadGroup;
@interface ZFApiSoapLoadGroup : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFLoadGroup* _input;
    ZFLoadGroupResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFLoadGroupResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFLoadGroup* input;
