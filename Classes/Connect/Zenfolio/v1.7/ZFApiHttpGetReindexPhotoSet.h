...
@interface ZFApiHttpGetReindexPhotoSet : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFReindexPhotoSetHttpGetIn* input;
@property (readwrite, strong, nonatomic) ZFReindexPhotoSetHttpGetOut* output;
