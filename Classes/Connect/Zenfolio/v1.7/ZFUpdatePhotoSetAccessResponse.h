...
@interface ZFUpdatePhotoSetAccessResponse : FLModelObject {
@private
    long _updatePhotoSetAccessResult;
}

@property (readwrite, assign, nonatomic) long updatePhotoSetAccessResult;
