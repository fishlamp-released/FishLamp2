...
@interface ZFApiHttpGetGetVideoPlaybackUrl : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFGetVideoPlaybackUrlHttpGetIn* _input;
    NSString* _output;
}

@property (readwrite, strong, nonatomic) ZFGetVideoPlaybackUrlHttpGetIn* input;
