...
@interface ZFApiHttpPostReorderPhotoSet : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFReorderPhotoSetHttpPostIn* input;
@property (readwrite, strong, nonatomic) ZFReorderPhotoSetHttpPostOut* output;
