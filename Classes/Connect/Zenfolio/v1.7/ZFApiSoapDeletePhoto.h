...
@interface ZFApiSoapDeletePhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFDeletePhoto* _input;
    ZFDeletePhotoResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFDeletePhoto* input;
@property (readonly, strong, nonatomic) NSString* location;
@property (readonly, strong, nonatomic) NSString* operationName;
@property (readwrite, strong, nonatomic) ZFDeletePhotoResponse* output;
