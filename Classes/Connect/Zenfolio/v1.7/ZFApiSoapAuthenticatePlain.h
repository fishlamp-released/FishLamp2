...
@interface ZFApiSoapAuthenticatePlain : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFAuthenticatePlain* _input;
    ZFAuthenticatePlainResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFAuthenticatePlain* input;
@property (readonly, strong, nonatomic) NSString* location;
@property (readonly, strong, nonatomic) NSString* operationName;
@property (readwrite, strong, nonatomic) ZFAuthenticatePlainResponse* output;
