...
@interface ZFApiHttpGetGetDownloadOriginalKey : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFGetDownloadOriginalKeyHttpGetIn* input;
