...
@interface ZFApiSoapLoadPhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFLoadPhoto* _input;
    ZFLoadPhotoResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFLoadPhotoResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFLoadPhoto* input;
