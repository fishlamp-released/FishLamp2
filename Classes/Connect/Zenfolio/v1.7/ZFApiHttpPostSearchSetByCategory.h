...
@interface ZFApiHttpPostSearchSetByCategory : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFSearchSetByCategoryHttpPostIn* input;
