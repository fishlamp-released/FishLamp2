...
@interface ZFApiHttpPostDeleteMessage : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFDeleteMessageHttpPostIn* input;
@property (readwrite, strong, nonatomic) ZFDeleteMessageHttpPostOut* output;
