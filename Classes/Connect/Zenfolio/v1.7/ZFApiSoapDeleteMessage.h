...
@interface ZFApiSoapDeleteMessage : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFDeleteMessage* _input;
    ZFDeleteMessageResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFDeleteMessageResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFDeleteMessage* input;
