...
@interface ZFApiSoapCollectionAddPhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFCollectionAddPhoto* _input;
    ZFCollectionAddPhotoResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFCollectionAddPhotoResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFCollectionAddPhoto* input;
