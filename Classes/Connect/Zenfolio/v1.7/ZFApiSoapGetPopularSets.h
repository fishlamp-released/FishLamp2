...
@interface ZFApiSoapGetPopularSets : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFGetPopularSets* _input;
    ZFGetPopularSetsResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFGetPopularSets* input;
@property (readonly, strong, nonatomic) NSString* location;
@property (readonly, strong, nonatomic) NSString* operationName;
@property (readwrite, strong, nonatomic) ZFGetPopularSetsResponse* output;
