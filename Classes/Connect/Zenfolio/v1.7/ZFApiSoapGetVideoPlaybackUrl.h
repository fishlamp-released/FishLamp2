...
@interface ZFApiSoapGetVideoPlaybackUrl : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFGetVideoPlaybackUrl* _input;
    ZFGetVideoPlaybackUrlResponse* _output;
}

@property (readwrite, strong, nonatomic) ZFGetVideoPlaybackUrlResponse* output;
@property (readonly, strong, nonatomic) NSString* targetNamespace;
@property (readwrite, strong, nonatomic) ZFGetVideoPlaybackUrl* input;
