...
@interface ZFApiHttpGetDeletePhoto : FLModelObject<FLHttpRequestDescriptor> {
@private
...
@property (readwrite, strong, nonatomic) ZFDeletePhotoHttpGetIn* input;
@property (readwrite, strong, nonatomic) ZFDeletePhotoHttpGetOut* output;
