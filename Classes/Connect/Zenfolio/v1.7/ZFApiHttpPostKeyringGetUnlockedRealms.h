...
@interface ZFApiHttpPostKeyringGetUnlockedRealms : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFKeyringGetUnlockedRealmsHttpPostIn* _input;
    NSMutableArray* _output;
}

@property (readwrite, strong, nonatomic) ZFKeyringGetUnlockedRealmsHttpPostIn* input;
