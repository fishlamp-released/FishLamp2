...
@implementation GtFacebookLikeList
...
- (void) copySelfTo:(id) object
{
	...
	((GtFacebookLikeList*)object).count = GtCopyOrRetainObject(m_count);
	((GtFacebookLikeList*)object).data = GtCopyOrRetainObject(m_data);
}
...
{
	return GtReturnAutoreleased([[GtFacebookLikeList alloc] init]);
}
...
@implementation GtFacebookLikeList (ValueProperties) 
