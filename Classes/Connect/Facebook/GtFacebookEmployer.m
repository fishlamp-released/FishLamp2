...
@implementation GtFacebookEmployer
...
- (void) copySelfTo:(id) object
{
	...
	((GtFacebookEmployer*)object).employer = GtCopyOrRetainObject(m_employer);
	((GtFacebookEmployer*)object).start_date = GtCopyOrRetainObject(m_start_date);
	((GtFacebookEmployer*)object).end_date = GtCopyOrRetainObject(m_end_date);
	((GtFacebookEmployer*)object).position = GtCopyOrRetainObject(m_position);
	((GtFacebookEmployer*)object).location = GtCopyOrRetainObject(m_location);
}
...
{
	return GtReturnAutoreleased([[GtFacebookEmployer alloc] init]);
}
	...
	if(!s_describer)
	{
		@synchronized(self) {
			if(!s_describer)
			{
				...
				[s_describer setPropertyDescriber:[GtPropertyDescription propertyDescription:@"employer" propertyClass:[NSString class] propertyType:GtDataTypeString] forPropertyName:@"employer"];
				...
				[s_describer setPropertyDescriber:[GtPropertyDescription propertyDescription:@"position" propertyClass:[NSString class] propertyType:GtDataTypeString] forPropertyName:@"position"];
	...
	if(!s_table)
	{
		@synchronized(self) {
			if(!s_table)
			{
				...
				[s_table addColumn:[GtSqliteColumn sqliteColumnWithColumnName:@"employer" columnType:GtSqliteTypeText columnConstraints:nil]];
				[s_table addColumn:[GtSqliteColumn sqliteColumnWithColumnName:@"location" columnType:GtSqliteTypeText columnConstraints:nil]];
				[s_table addColumn:[GtSqliteColumn sqliteColumnWithColumnName:@"position" columnType:GtSqliteTypeText columnConstraints:nil]];
...
@implementation GtFacebookEmployer (ValueProperties) 
@end
