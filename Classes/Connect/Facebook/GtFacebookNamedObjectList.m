...
@implementation GtFacebookNamedObjectList
...
- (void) copySelfTo:(id) object
{
	...
	((GtFacebookNamedObjectList*)object).count = GtCopyOrRetainObject(m_count);
	((GtFacebookNamedObjectList*)object).data = GtCopyOrRetainObject(m_data);
}
...
{
	return GtReturnAutoreleased([[GtFacebookNamedObjectList alloc] init]);
}
...
@implementation GtFacebookNamedObjectList (ValueProperties) 
