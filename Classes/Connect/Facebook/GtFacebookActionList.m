...
@implementation GtFacebookActionList
...
- (void) copySelfTo:(id) object
{
	...
	((GtFacebookActionList*)object).count = GtCopyOrRetainObject(m_count);
	((GtFacebookActionList*)object).data = GtCopyOrRetainObject(m_data);
}
...
{
	return GtReturnAutoreleased([[GtFacebookActionList alloc] init]);
}
...
@implementation GtFacebookActionList (ValueProperties) 
