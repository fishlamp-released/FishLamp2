...
const struct FLContentMode FLContentModeNone = {	FLContentModeHorizontalNone,	 FLContentModeVerticalNone, {0,0} };
const struct FLContentMode FLContentModeFill = {	FLContentModeHorizontalFill, FLContentModeVerticalFill, {0,0}};
const struct FLContentMode FLContentModeCentered = { FLContentModeHorizontalCentered, FLContentModeVerticalCentered, {0,0}};
const struct FLContentMode FLContentModeAspectFit = {	FLContentModeHorizontalFit, FLContentModeVerticalFit, {0,0} };
const struct FLContentMode FLContentModeCenteredTop = {	FLContentModeHorizontalCentered, FLContentModeVerticalTop, {0,0} };
const struct FLContentMode FLContentModeCenteredBottom = {	FLContentModeHorizontalCentered, FLContentModeVerticalBottom, {0,0} };
