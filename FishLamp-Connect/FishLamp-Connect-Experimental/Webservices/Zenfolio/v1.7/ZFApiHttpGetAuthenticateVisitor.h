...
@interface ZFApiHttpGetAuthenticateVisitor : FLModelObject<FLHttpRequestDescriptor> {
@private
    ZFAuthenticateVisitorHttpGetIn* _input;
    NSString* _output;
}

@property (readwrite, strong, nonatomic) ZFAuthenticateVisitorHttpGetIn* input;
