...
@implementation GtWsdlEnumeration
...
{
	return [[[GtWsdlEnumeration alloc] init] autorelease];
}

@end

@implementation GtWsdlEnumeration (ValueProperties) 
@end


@implementation GtWsdlEnumeration (ObjectMembers) 
@end
