...
@private
    ...
    FLCallback _viewControllerFactory;
    CGRect _frame;
    NSString* _title;
...
@property (readwrite, assign, nonatomic) FLCallback viewControllerFactory;
...
- (id) initWithViewControllerFactory:(FLCallback) viewControllerFactory title:(NSString*) title;

+ (FLViewControllerPlaceholder*) viewControllerPlaceholder:(NSString*) title viewControllerClass:(Class) viewControllerClass;
+ (FLViewControllerPlaceholder*) viewControllerPlaceholder:(NSString*) title viewControllerFactory:(FLCallback) factory;
