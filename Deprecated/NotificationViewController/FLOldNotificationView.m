...
- (NSString*) htmlDocument
{
	...
	FLHtmlBuilder* builder = [[FLHtmlBuilder alloc] init];
	
	NSString* colorHex = [self.textColor toHexString:YES];
	NSString* linkColorHex = [[UIColor lightSkyBlueColor] toHexString:YES];
    
    [builder addDocTypeDeclaration:FLXmlDocTypeHtml4_01Strict];
    [builder openHtmlElement];
...
//    <meta name='viewport' content='width=device-width; initial-scale=1.0; maximum-scale=1.0;'>"];
	...
	[builder pushAttribute:@"type" value:@"text/css"];
...
- (void) simpleHtmlView:(FLSimpleHtmlView*) view didFinishLoading:(NSError*) error
{
	...
	{
		FLLog(@"Html view failed to load: %@", error);
	}
#endif 
}
