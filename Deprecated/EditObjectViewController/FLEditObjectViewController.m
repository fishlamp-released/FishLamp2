...
//	else
//	{
//		FLGradientView* view = [[[FLGradientView alloc] initWithFrame:CGRectMake(0,0,320,480)] autorelease];		
...
- (void) viewDidLoad
{
	...
	FLAssert(self.tableView.style == UITableViewStylePlain, @"TableView must be UITableViewStylePlain");
	FLAssert(self.tableView.separatorStyle == UITableViewCellSeparatorStyleNone, @"TableView.seperatorStyle must be UITableViewCellSeparatorStyleNone");
...
//    }
	...
	FLAssert([self.tableView isKindOfClass:[FLTableView class]], @"TableView needs to be a FLTableView");
...
//			[FLButtonbarView createImageButtonByName:@"help-white.png" imageColor:FLImageColorBlack target:self action:@selector(buttonClickForHelpButton:)] forKey:@"help" animated:NO];
//	}
...
{
	FLAlertViewController* alert = [FLAlertViewController alertViewController:NSLocalizedString(@"Are you sure?", nil)
