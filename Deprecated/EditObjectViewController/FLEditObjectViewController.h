...
@property (readwrite, assign, nonatomic) FLCallback dataChangedEvent;
...
// cancelling
//@property (readwrite, copy, nonatomic) FLEventCallback didCancelCallback;
