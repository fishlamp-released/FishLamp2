...
#import "FLTextViewProxy.h"

@implementation FLTextViewProxy
...
- (UILabel*) labelView
{
	FLAssert([_proxiedView isKindOfClass:[UILabel class]], @"not a UILabel");
	return (UILabel*) _proxiedView;
}
- (UITextField*) textField
{
	FLAssert([_proxiedView isKindOfClass:[UITextField class]], @"not a UITextField");
	return (UITextField*) _proxiedView;
}
- (UITextView*) textView
{
	FLAssert([_proxiedView isKindOfClass:[UITextView class]], @"not a UITextView");
