...
//		  self.borderColor.color_t;
	...
	{
		if(FLBitTestAny(self.drawMode, FLTableViewCellSectionDrawModeBorder|FLTableViewCellSectionDrawModeFill))
		{
			...
			switch(self.positionInSection)
			{
				case FLTableViewCellSectionWidgetPositionInSectionAll:
				{
					...
					if(FLBitTest(self.drawMode, FLTableViewCellSectionDrawModeFill))
					{
						CGContextAddPath(context, borderPath);
						CGContextFillPath(context);
					}
					if(FLBitTest(self.drawMode, FLTableViewCellSectionDrawModeBorder))
					{
						CGContextAddPath(context, borderPath);
	...
	if( FLBitTest(self.drawMode, FLTableViewCellSectionDrawModeSeperatorLine) &&
