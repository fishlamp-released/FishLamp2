...
- (id) initWithFrame:(CGRect) frame
{
	if(self = [super initWithFrame:frame])
	{
		...
		_leftButton = FLRetain([UIButton buttonWithType:UIButtonTypeRoundedRect]);
		...
		_centerButton = FLRetain([UIButton buttonWithType:UIButtonTypeRoundedRect]);
...
//		  _focusView.hidden = YES;
		...
		_flipCameraButton = FLRetain([UIButton buttonWithType:UIButtonTypeRoundedRect]);
		...
		_flashButton = FLRetain([UIButton buttonWithType:UIButtonTypeRoundedRect]);
