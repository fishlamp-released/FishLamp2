...
@implementation FLZfUploadablePhotoBase
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUploadablePhotoBase*)object).takenDate = FLCopyOrRetainObject(_takenDate);
	((FLZfUploadablePhotoBase*)object).photoDataFileName = FLCopyOrRetainObject(_photoDataFileName);
	((FLZfUploadablePhotoBase*)object).dimensions = FLCopyOrRetainObject(_dimensions);
	((FLZfUploadablePhotoBase*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfUploadablePhotoBase*)object).wasSavedToPhotoGallery = FLCopyOrRetainObject(_wasSavedToPhotoGallery);
	((FLZfUploadablePhotoBase*)object).uploadSize = FLCopyOrRetainObject(_uploadSize);
	((FLZfUploadablePhotoBase*)object).isCameraImage = FLCopyOrRetainObject(_isCameraImage);
	((FLZfUploadablePhotoBase*)object).originalFileName = FLCopyOrRetainObject(_originalFileName);
	((FLZfUploadablePhotoBase*)object).uploadedPhotoId = FLCopyOrRetainObject(_uploadedPhotoId);
	((FLZfUploadablePhotoBase*)object).sortId = FLCopyOrRetainObject(_sortId);
	((FLZfUploadablePhotoBase*)object).saveToPhoneGalleryOnUpload = FLCopyOrRetainObject(_saveToPhoneGalleryOnUpload);
	((FLZfUploadablePhotoBase*)object).uploadFileId = FLCopyOrRetainObject(_uploadFileId);
	((FLZfUploadablePhotoBase*)object).uploaded = FLCopyOrRetainObject(_uploaded);
	((FLZfUploadablePhotoBase*)object).modifiedDate = FLCopyOrRetainObject(_modifiedDate);
	((FLZfUploadablePhotoBase*)object).uploadGallery = FLCopyOrRetainObject(_uploadGallery);
	((FLZfUploadablePhotoBase*)object).categoryArray = FLCopyOrRetainObject(_categoryArray);
	((FLZfUploadablePhotoBase*)object).accessDescriptor = FLCopyOrRetainObject(_accessDescriptor);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"uploadGallery" propertyClass:[FLZfUploadGallery class] propertyType:FLDataTypeObject] forPropertyName:@"uploadGallery"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"uploadSize" propertyClass:[NSNumber class] propertyType:FLDataTypeNSInteger] forPropertyName:@"uploadSize"];
...
{
	return FLAutorelease([[FLZfUploadablePhotoBase alloc] init]);
}

@end

@implementation FLZfUploadablePhotoBase (ValueProperties) 
