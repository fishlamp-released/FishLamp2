...
@implementation FLZfUploadGallery
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUploadGallery*)object).name = FLCopyOrRetainObject(_name);
	((FLZfUploadGallery*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfUploadGallery*)object).uploadUrl = FLCopyOrRetainObject(_uploadUrl);
}
...
{
	return FLAutorelease([[FLZfUploadGallery alloc] init]);
}

@end

@implementation FLZfUploadGallery (ValueProperties) 
