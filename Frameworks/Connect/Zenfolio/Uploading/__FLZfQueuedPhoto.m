...
@implementation FLZfQueuedPhoto
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfQueuedPhoto*)object).zenfolioCategories = FLCopyOrRetainObject(_zenfolioCategories);
	((FLZfQueuedPhoto*)object).wasSavedToDeviceBeforeUpload = FLCopyOrRetainObject(_wasSavedToDeviceBeforeUpload);
	((FLZfQueuedPhoto*)object).accessDescriptor = FLCopyOrRetainObject(_accessDescriptor);
	((FLZfQueuedPhoto*)object).scaledUploadSize = FLCopyOrRetainObject(_scaledUploadSize);
	((FLZfQueuedPhoto*)object).saveToDeviceBeforeUpload = FLCopyOrRetainObject(_saveToDeviceBeforeUpload);
	((FLZfQueuedPhoto*)object).categoryArray = FLCopyOrRetainObject(_categoryArray);
}
...
{
	return FLAutorelease([[FLZfQueuedPhoto alloc] init]);
}
...
@implementation FLZfQueuedPhoto (ValueProperties) 
