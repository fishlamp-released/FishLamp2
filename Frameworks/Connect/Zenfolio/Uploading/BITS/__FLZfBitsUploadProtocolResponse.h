...
// --------------------------------------------------------------------
// FLZfBitsUploadProtocolResponse
// --------------------------------------------------------------------
@interface FLZfBitsUploadProtocolResponse : NSObject<NSCopying, NSCoding>{ 
@private
...
@interface FLZfBitsUploadProtocolResponse (ValueProperties) 
@end
