...
//
//	FLZenfolioBitsUploadProtocolResponse.m
//	Project: FishLamp
//	Schema: ZenObjects
//
...
@implementation FLZenfolioBitsUploadProtocolResponse
...
{
	return FLAutorelease([[FLZenfolioBitsUploadProtocolResponse alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioBitsUploadProtocolResponse*)object).hostId = FLCopyOrRetainObject(_hostId);
	((FLZenfolioBitsUploadProtocolResponse*)object).protocol = FLCopyOrRetainObject(_protocol);
	((FLZenfolioBitsUploadProtocolResponse*)object).errorCode = FLCopyOrRetainObject(_errorCode);
	((FLZenfolioBitsUploadProtocolResponse*)object).acceptEncoding = FLCopyOrRetainObject(_acceptEncoding);
	((FLZenfolioBitsUploadProtocolResponse*)object).receivedContentRange = FLCopyOrRetainObject(_receivedContentRange);
	((FLZenfolioBitsUploadProtocolResponse*)object).sessionId = FLCopyOrRetainObject(_sessionId);
	((FLZenfolioBitsUploadProtocolResponse*)object).received = FLCopyOrRetainObject(_received);
	((FLZenfolioBitsUploadProtocolResponse*)object).errorContext = FLCopyOrRetainObject(_errorContext);
	((FLZenfolioBitsUploadProtocolResponse*)object).packetType = FLCopyOrRetainObject(_packetType);
	((FLZenfolioBitsUploadProtocolResponse*)object).replyURL = FLCopyOrRetainObject(_replyURL);
	((FLZenfolioBitsUploadProtocolResponse*)object).hostIdFallbackTimeout = FLCopyOrRetainObject(_hostIdFallbackTimeout);
}
...
@implementation FLZenfolioBitsUploadProtocolResponse (ValueProperties) 
@end
