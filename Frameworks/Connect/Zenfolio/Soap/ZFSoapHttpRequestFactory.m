...
#define ZFSoapHttpRequestFrom(__SUBCLASS__, __REQUEST_OBJECT_NAME__, __RESULT_OBJECT_NAME__, __RETURNED_OBJECT_NAME__) \
    [ZFSoapHttpRequestFactory soapHttpRequest:[__SUBCLASS__ class] operationDescriptor:FLAutorelease([[__REQUEST_OBJECT_NAME__ alloc] init]) \
                                              element:[FLPropertyDescriber propertyDescriber:__RESULT_OBJECT_NAME__ propertyClass:[__RETURNED_OBJECT_NAME__ class]]]
...
+ (FLResult) zenfolioResultFromSoapResponse:(FLParsedItem*) parsedSoap 
    ...
    FLParsedItem* objectXML = [parsedSoap findElementWithName:element.propertyName maxDepth:2];
    ...
    id zenfolioObject = [[FLSoapObjectBuilder instance] buildObjectWithXmlElement:objectXML withObjectDescriber:element.propertyType];
    
//    objectFromXML:objectXML withTypeDesc:element];
