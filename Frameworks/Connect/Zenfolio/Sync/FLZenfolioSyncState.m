...
@implementation FLZenfolioSyncState
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioSyncState*)object).syncObjectId = FLCopyOrRetainObject(_syncObjectId);
	((FLZenfolioSyncState*)object).isSynced = FLCopyOrRetainObject(_isSynced);
	((FLZenfolioSyncState*)object).lastSyncDate = FLCopyOrRetainObject(_lastSyncDate);
}
...
{
	return FLAutorelease([[FLZenfolioSyncState alloc] init]);
}

@end

@implementation FLZenfolioSyncState (ValueProperties) 
