...
@implementation FLZfGroupElementSyncInfo
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGroupElementSyncInfo*)object).isGroup = FLCopyOrRetainObject(_isGroup);
	((FLZfGroupElementSyncInfo*)object).syncObjectId = FLCopyOrRetainObject(_syncObjectId);
	((FLZfGroupElementSyncInfo*)object).name = FLCopyOrRetainObject(_name);
}
...
+ (FLZfGroupElementSyncInfo*) groupElementSyncInfo
{
	return FLAutorelease([[FLZfGroupElementSyncInfo alloc] init]);
}
...
@implementation FLZfGroupElementSyncInfo (ValueProperties) 
