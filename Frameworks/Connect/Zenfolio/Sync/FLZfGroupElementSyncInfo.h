...
// --------------------------------------------------------------------
// FLZfGroupElementSyncInfo
// --------------------------------------------------------------------
@interface FLZfGroupElementSyncInfo : NSObject<NSCopying, NSCoding>{ 
@private
	NSNumber* _isGroup;
...
@interface FLZfGroupElementSyncInfo (ValueProperties) 
