...
@implementation NSObject (FLZenfolioCache)
- (SEL) deleteSelectorForCache {    
    return @selector(deleteObjectFromCache:);
}
@end

@implementation FLZenfolioPhotoSet (FLZenfolioCache)
- (SEL) deleteSelectorForCache {    
    return @selector(deletePhotoSetFromCache:);
}
@end
@implementation FLZenfolioPhoto (FLZenfolioCache)

- (SEL) deleteSelectorForCache {    
    return @selector(deletePhotoFromCache:);
}
@end
@implementation FLZenfolioGroup (FLZenfolioCache)
...
@implementation FLZenfolioCache
