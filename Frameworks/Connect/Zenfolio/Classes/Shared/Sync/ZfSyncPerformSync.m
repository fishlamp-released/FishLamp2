...
{
	BOOL loadPhoto = YES;
	ZFPhoto* inCache = [[[self.context userStorageService].cacheDatabase loadObject:photo];
	if(inCache)
	{
...
// the image in _decideToLoadPhoto
    ...
    ZFLoadImageFromCacheOperation* loadThumbnail =
        [ZFLoadImageFromCacheOperation cachedObjectOperation:
            [ZFDownloadImageHttpRequest downloadImageOperation:photo photoSize:kGalleryThumbnailDownloadSize]];
    ...
    ZFLoadImageFromCacheOperation* downloadImage =
        [ZFLoadImageFromCacheOperation cachedObjectOperation:
            [ZFDownloadImageHttpRequest downloadImageOperation:photo photoSize:kImageDownloadSize]];
	...
	if(_downloadLargeImages) {
		...
		ZFDownloadImageHttpRequest* downloadHighResPhoto =
            [ZFDownloadImageHttpRequest downloadImageOperation:photo photoSize:kImageHighResDownloadSize];
