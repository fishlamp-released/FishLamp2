//
//  ZFConvertToGoListToDatabaseLengthyTask.m
//  ZenLib
//
...
#import "ZFConvertToGoListToDatabaseLengthyTask.h"
#import "ZFSyncService.h"
#import "ZFStorageService.h"

#define kFileName @"ToGo.plist"

@implementation ZFConvertToGoListToDatabaseLengthyTask
...
- (void) executeSelf
{
	...
	@synchronized([self.context syncService]) {
		if([[[self.context userStorageService] documentsFolder] fileExistsInFolder:kFileName])
		{
			...
			for(ZFGroupElementSyncInfo* info in file.objectEnumerator)
			{
