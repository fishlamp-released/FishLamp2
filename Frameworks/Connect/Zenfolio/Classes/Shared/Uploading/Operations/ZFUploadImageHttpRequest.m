...
//        FLThrowErrorCode_v(ZFErrorDomain, ZFErrorCodeUploadPhotoSetNotFound, @"PhotoSet not found: %@", _photo.uploadGallery.name);
//    }
...
//        }
//        else {
//            FLThrowErrorCode_v(ZFErrorDomain, ZFErrorCodeUnknownObjectId, @"invalid photo id returned from server");
//        }
//    }
//    
//    return nil;
