...
@implementation ZFAuthenticator

- (ZFAuthChallenge*) sendChallengeRequest {
...
- (NSString*) sendAuthenticateRequestWithChallenge:(ZFAuthChallenge*) challenge {
    ...
    FLHttpRequest* authRequest = [ZFHttpRequest  authenticateHttpRequest:encodedChallenge proof:encodedProof];
...
- (FLResult) runOperation  {
    ...
    ZFAuthChallenge* response = [self sendChallengeRequest];
