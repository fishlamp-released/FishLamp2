...
- (void)downloadPhoto:(ZFPhoto *)photo toFolder:(NSString *)folder {
    ...
    @try {
        ...
        if ( !image ) {
            ...
            ZFDownloadImageHttpRequest* downloader = [ZFDownloadImageHttpRequest downloadImageOperation:photo imageSize:[ZFImageSize originalImageSize]];
...
- (FLResult) runOperation {
    ...
    @try {
        [[self.context rootGroup] visitAllElements:^(ZFGroupElement* element, BOOL* stop) {
