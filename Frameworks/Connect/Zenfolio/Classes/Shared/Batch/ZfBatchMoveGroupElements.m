...
@implementation ZFBatchMoveGroupElements
...
- (FLAction*) createActionWithCurrentQueueObject:(id) object
{
	...
	{
		ZFApiSoapMoveGroup* moveGroup = [[ZFApiSoapMoveGroup alloc] initWithServerContext:[ZFApiSoap instance]];
...
//        [moveGroup setDidPerformCallback:self action:@selector(updateCacheAfterMoving:)];
	...
	{
		ZFApiSoapMovePhotoSet* moveGallery = [[ZFApiSoapMovePhotoSet alloc] initWithServerContext:[ZFApiSoap instance]];
