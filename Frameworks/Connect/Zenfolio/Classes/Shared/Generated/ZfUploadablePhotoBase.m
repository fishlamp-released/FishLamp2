...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"uploadGallery" propertyClass:[ZFUploadGallery class] propertyType:FLDataTypeObject] forPropertyName:@"uploadGallery"];
