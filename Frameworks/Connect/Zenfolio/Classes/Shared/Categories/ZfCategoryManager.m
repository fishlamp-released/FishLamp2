...
- (void) setCategoryArray:(NSArray*) zfArray
{
	...
	for(ZFCategory* cat in zfArray)
	{
		ZFParsedCategory* zfCat = [[ZFParsedCategory alloc] initWithCategory:cat];
...
{
	if(!_categories) {
		FLThrowErrorCode_v(ZFErrorDomain, ZFErrorCodeCategoriesNotLoaded, @"Categories not loaded");
	}
