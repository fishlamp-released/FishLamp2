...
- (id) initWithCategory:(FLZfCategory*) categoryObject
{
	if((self = [super init]))
	{
...
+ (NSString*) displayFormatterDataToString:(FLZfParsedCategory*) aCat
{
...
+ (FLZfParsedCategory*) emptyCategory
{
	return FLAutorelease([[FLZfParsedCategory alloc] initEmptyCategory]);
}
