...
//
//	FLZenfolioLoadGroupHierarchyHttpPostIn.m
...
@implementation FLZenfolioLoadGroupHierarchyHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadGroupHierarchyHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
+ (FLZenfolioLoadGroupHierarchyHttpPostIn*) loadGroupHierarchyHttpPostIn
{
	return FLAutorelease([[FLZenfolioLoadGroupHierarchyHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioLoadGroupHierarchyHttpPostIn (ValueProperties) 
@end
