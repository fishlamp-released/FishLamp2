...
//
//	FLZenfolioSearchPhotoByTextHttpPostIn.h
...
// --------------------------------------------------------------------
// FLZenfolioSearchPhotoByTextHttpPostIn
// --------------------------------------------------------------------
@interface FLZenfolioSearchPhotoByTextHttpPostIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _searchId;
	NSString* _sortOrder;
	NSString* _query;
...
@interface FLZenfolioSearchPhotoByTextHttpPostIn (ValueProperties) 
@end
