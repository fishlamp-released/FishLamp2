...
@implementation FLZenfolioGetRecentPhotos
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetRecentPhotos*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetRecentPhotos*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZenfolioGetRecentPhotos alloc] init]);
}
...
@implementation FLZenfolioGetRecentPhotos (ValueProperties) 
