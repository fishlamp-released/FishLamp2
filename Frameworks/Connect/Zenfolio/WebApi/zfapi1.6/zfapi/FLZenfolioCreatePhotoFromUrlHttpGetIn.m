...
//
//	FLZenfolioCreatePhotoFromUrlHttpGetIn.m
...
@implementation FLZenfolioCreatePhotoFromUrlHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioCreatePhotoFromUrlHttpGetIn*)object).url = FLCopyOrRetainObject(_url);
	((FLZenfolioCreatePhotoFromUrlHttpGetIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZenfolioCreatePhotoFromUrlHttpGetIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZenfolioCreatePhotoFromUrlHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioCreatePhotoFromUrlHttpGetIn (ValueProperties) 
@end
