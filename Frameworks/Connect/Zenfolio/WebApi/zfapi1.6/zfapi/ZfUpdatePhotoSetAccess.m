...
- (void) copySelfTo:(id) object
{
	...
	((ZFUpdatePhotoSetAccess*)object).updater = FLCopyOrRetainObject(_updater);
	((ZFUpdatePhotoSetAccess*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[ZFUpdatePhotoSetAccess alloc] init]);
}

@end

@implementation ZFUpdatePhotoSetAccess (ValueProperties) 
