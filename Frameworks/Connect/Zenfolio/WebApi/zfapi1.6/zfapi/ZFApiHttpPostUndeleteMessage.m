...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFUndeleteMessageHttpPostIn class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFUndeleteMessageHttpPostOut class]];
	});
