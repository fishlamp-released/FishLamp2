...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioDeleteGroupHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioDeleteGroupHttpPostOut class]];
	});
	return s_describer;
}
