...
//
//	FLZenfolioUndeleteMessageHttpGetIn.m
...
@implementation FLZenfolioUndeleteMessageHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioUndeleteMessageHttpGetIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZenfolioUndeleteMessageHttpGetIn*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
+ (FLZenfolioUndeleteMessageHttpGetIn*) undeleteMessageHttpGetIn
{
	return FLAutorelease([[FLZenfolioUndeleteMessageHttpGetIn alloc] init]);
}

@end

@implementation FLZenfolioUndeleteMessageHttpGetIn (ValueProperties) 
@end
