...
//
//	FLZenfolioGetVideoPlaybackUrlHttpPostIn.m
...
@implementation FLZenfolioGetVideoPlaybackUrlHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetVideoPlaybackUrlHttpPostIn*)object).height = FLCopyOrRetainObject(_height);
	((FLZenfolioGetVideoPlaybackUrlHttpPostIn*)object).width = FLCopyOrRetainObject(_width);
	((FLZenfolioGetVideoPlaybackUrlHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZenfolioGetVideoPlaybackUrlHttpPostIn*)object).mode = FLCopyOrRetainObject(_mode);
}
...
{
	return FLAutorelease([[FLZenfolioGetVideoPlaybackUrlHttpPostIn alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"width" propertyClass:[NSString class] propertyType:FLDataTypeString] forPropertyName:@"width"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"height" propertyClass:[NSString class] propertyType:FLDataTypeString] forPropertyName:@"height"];
	});
	return s_describer;
}
...
@implementation FLZenfolioGetVideoPlaybackUrlHttpPostIn (ValueProperties) 
@end
