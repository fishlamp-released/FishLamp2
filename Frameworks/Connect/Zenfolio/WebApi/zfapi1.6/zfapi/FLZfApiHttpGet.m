...
@implementation FLZfApiHttpGet


FLSynthesizeSingleton(FLZfApiHttpGet);

+ (FLZfApiHttpGet*) apiHttpGet
{
	return FLAutorelease([[FLZfApiHttpGet alloc] init]);
}
...
@implementation FLZfApiHttpGet (ValueProperties) 
@end
