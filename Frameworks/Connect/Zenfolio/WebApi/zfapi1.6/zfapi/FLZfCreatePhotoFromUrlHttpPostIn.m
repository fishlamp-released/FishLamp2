...
//
//	FLZfCreatePhotoFromUrlHttpPostIn.m
...
@implementation FLZfCreatePhotoFromUrlHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreatePhotoFromUrlHttpPostIn*)object).url = FLCopyOrRetainObject(_url);
	((FLZfCreatePhotoFromUrlHttpPostIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZfCreatePhotoFromUrlHttpPostIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZfCreatePhotoFromUrlHttpPostIn alloc] init]);
}
...
@implementation FLZfCreatePhotoFromUrlHttpPostIn (ValueProperties) 
@end
