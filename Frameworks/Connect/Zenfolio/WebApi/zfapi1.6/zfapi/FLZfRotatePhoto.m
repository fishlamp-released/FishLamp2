...
@implementation FLZfRotatePhoto
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfRotatePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfRotatePhoto*)object).rotation = FLCopyOrRetainObject(_rotation);
}
...
{
	return FLAutorelease([[FLZfRotatePhoto alloc] init]);
}
...
@implementation FLZfRotatePhoto (ValueProperties) 
