...
@implementation FLZfGetCategoriesResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetCategoriesResponse*)object).GetCategoriesResult = FLCopyOrRetainObject(_GetCategoriesResult);
}
...
{
	return FLAutorelease([[FLZfGetCategoriesResponse alloc] init]);
}
...
@implementation FLZfGetCategoriesResponse (ValueProperties) 
@end
