...
@implementation FLZenfolioResolveReference
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioResolveReference*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZenfolioResolveReference*)object).reference = FLCopyOrRetainObject(_reference);
}
...
{
	return FLAutorelease([[FLZenfolioResolveReference alloc] init]);
}
...
@implementation FLZenfolioResolveReference (ValueProperties) 
@end
