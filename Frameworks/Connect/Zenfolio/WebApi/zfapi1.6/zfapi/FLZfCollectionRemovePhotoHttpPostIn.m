...
//
//	FLZfCollectionRemovePhotoHttpPostIn.m
...
@implementation FLZfCollectionRemovePhotoHttpPostIn
...
{
	return FLAutorelease([[FLZfCollectionRemovePhotoHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCollectionRemovePhotoHttpPostIn*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZfCollectionRemovePhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZfCollectionRemovePhotoHttpPostIn (ValueProperties) 
@end
