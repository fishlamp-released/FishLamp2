...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"mapping" withArrayTypes:[NSArray arrayWithObjects:[FLPropertyDescriber propertyDescriber:@"int" class:[FLIntegerNumber class]], nil]];
	});
