...
@implementation FLZenfolioUpdateGroup
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioUpdateGroup*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZenfolioUpdateGroup*)object).updater = FLCopyOrRetainObject(_updater);
}
...
{
	return FLAutorelease([[FLZenfolioUpdateGroup alloc] init]);
}

@end

@implementation FLZenfolioUpdateGroup (ValueProperties) 
