...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFSearchPhotoByCategoryHttpGetIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
