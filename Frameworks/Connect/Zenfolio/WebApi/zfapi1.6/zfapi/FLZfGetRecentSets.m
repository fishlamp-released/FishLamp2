...
@implementation FLZfGetRecentSets
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetRecentSets*)object).type = FLCopyOrRetainObject(_type);
	((FLZfGetRecentSets*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetRecentSets*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetRecentSets alloc] init]);
}
...
@implementation FLZfGetRecentSets (ValueProperties) 
