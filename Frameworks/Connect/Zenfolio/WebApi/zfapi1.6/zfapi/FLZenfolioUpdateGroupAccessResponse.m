...
//
//	FLZenfolioUpdateGroupAccessResponse.m
...
@implementation FLZenfolioUpdateGroupAccessResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioUpdateGroupAccessResponse*)object).UpdateGroupAccessResult = FLCopyOrRetainObject(_UpdateGroupAccessResult);
}
...
{
	return FLAutorelease([[FLZenfolioUpdateGroupAccessResponse alloc] init]);
}

@end

@implementation FLZenfolioUpdateGroupAccessResponse (ValueProperties) 
