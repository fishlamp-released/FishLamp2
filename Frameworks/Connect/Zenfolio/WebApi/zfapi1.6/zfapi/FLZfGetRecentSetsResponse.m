...
@implementation FLZfGetRecentSetsResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetRecentSetsResponse*)object).GetRecentSetsResult = FLCopyOrRetainObject(_GetRecentSetsResult);
}
...
{
	return FLAutorelease([[FLZfGetRecentSetsResponse alloc] init]);
}
...
@implementation FLZfGetRecentSetsResponse (ValueProperties) 
@end
