...
- (ZFGetPopularSetsHttpGetIn*) input
{
	if(!_input)
	{
		_input = [[ZFGetPopularSetsHttpGetIn alloc] init];
	}
	return _input;
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFGetPopularSetsHttpGetIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"output" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[ZFPhotoSet class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"output"];
	});
	return s_describer;
}
...
@implementation ZFApiHttpGetGetPopularSets (ValueProperties) 
@end


@implementation ZFApiHttpGetGetPopularSets (ObjectMembers) 

// This returns _input. It does NOT create it if it's NIL.
- (ZFGetPopularSetsHttpGetIn*) inputObject
{
	return _input;
}
