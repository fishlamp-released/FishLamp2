...
//
//	FLZfDeletePhotoSetHttpPostIn.m
...
@implementation FLZfDeletePhotoSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeletePhotoSetHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfDeletePhotoSetHttpPostIn alloc] init]);
}
...
@implementation FLZfDeletePhotoSetHttpPostIn (ValueProperties) 
@end
