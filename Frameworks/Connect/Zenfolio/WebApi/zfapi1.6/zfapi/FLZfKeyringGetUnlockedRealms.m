...
//
//	FLZfKeyringGetUnlockedRealms.m
...
@implementation FLZfKeyringGetUnlockedRealms
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfKeyringGetUnlockedRealms*)object).keyring = FLCopyOrRetainObject(_keyring);
}
...
{
	return FLAutorelease([[FLZfKeyringGetUnlockedRealms alloc] init]);
}
...
@implementation FLZfKeyringGetUnlockedRealms (ValueProperties) 
@end
