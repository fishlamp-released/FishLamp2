...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioMoveGroupHttpGetIn class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioMoveGroupHttpGetOut class]];
	});
	return s_describer;
}
