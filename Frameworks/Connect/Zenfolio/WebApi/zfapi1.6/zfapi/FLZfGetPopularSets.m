...
@implementation FLZfGetPopularSets
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetPopularSets*)object).type = FLCopyOrRetainObject(_type);
	((FLZfGetPopularSets*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetPopularSets*)object).offset = FLCopyOrRetainObject(_offset);
}
...
+ (FLZfGetPopularSets*) getPopularSets
{
	return FLAutorelease([[FLZfGetPopularSets alloc] init]);
}
...
@implementation FLZfGetPopularSets (ValueProperties) 
