...
@implementation FLZfLoadAccessRealm
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadAccessRealm*)object).realmId = FLCopyOrRetainObject(_realmId);
}
...
{
	return FLAutorelease([[FLZfLoadAccessRealm alloc] init]);
}
...
@implementation FLZfLoadAccessRealm (ValueProperties) 
