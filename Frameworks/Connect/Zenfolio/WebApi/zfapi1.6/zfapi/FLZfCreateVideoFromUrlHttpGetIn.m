...
//
//	FLZfCreateVideoFromUrlHttpGetIn.m
...
@implementation FLZfCreateVideoFromUrlHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreateVideoFromUrlHttpGetIn*)object).url = FLCopyOrRetainObject(_url);
	((FLZfCreateVideoFromUrlHttpGetIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZfCreateVideoFromUrlHttpGetIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZfCreateVideoFromUrlHttpGetIn alloc] init]);
}
...
@implementation FLZfCreateVideoFromUrlHttpGetIn (ValueProperties) 
@end
