...
- (void) copySelfTo:(id) object
{
	...
	((ZFGetChallenge*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
+ (ZFGetChallenge*) getChallenge
{
	return FLAutorelease([[ZFGetChallenge alloc] init]);
}
...
@implementation ZFGetChallenge (ValueProperties) 
@end
