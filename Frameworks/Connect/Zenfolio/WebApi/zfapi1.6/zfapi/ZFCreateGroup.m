...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"parentId" withClass:[FLIntegerNumber class] ];
		[s_describer addChildDescriberWithName:@"updater" withClass:[ZFGroupUpdater class]];
	});
	return s_describer;
}
