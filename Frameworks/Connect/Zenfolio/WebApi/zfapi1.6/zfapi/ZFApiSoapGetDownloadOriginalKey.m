...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFGetDownloadOriginalKey class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFGetDownloadOriginalKeyResponse class]];
	});
	return s_describer;
}
