...
- (void) copySelfTo:(id) object
{
	...
	((ZFGetPopularSets*)object).type = FLCopyOrRetainObject(_type);
	((ZFGetPopularSets*)object).limit = FLCopyOrRetainObject(_limit);
	((ZFGetPopularSets*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[ZFGetPopularSets alloc] init]);
}
...
@implementation ZFGetPopularSets (ValueProperties) 
