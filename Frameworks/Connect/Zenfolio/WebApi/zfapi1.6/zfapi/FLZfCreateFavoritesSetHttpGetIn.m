...
//
//	FLZfCreateFavoritesSetHttpGetIn.m
...
@implementation FLZfCreateFavoritesSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreateFavoritesSetHttpGetIn*)object).name = FLCopyOrRetainObject(_name);
	((FLZfCreateFavoritesSetHttpGetIn*)object).photographerLogin = FLCopyOrRetainObject(_photographerLogin);
	((FLZfCreateFavoritesSetHttpGetIn*)object).photoIds = FLCopyOrRetainObject(_photoIds);
}
...
{
	return FLAutorelease([[FLZfCreateFavoritesSetHttpGetIn alloc] init]);
}
...
@implementation FLZfCreateFavoritesSetHttpGetIn (ValueProperties) 
@end
