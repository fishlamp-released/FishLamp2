...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFLoadPhotoSetPhotos class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFLoadPhotoSetPhotosResponse class]];
	});
	return s_describer;
}
