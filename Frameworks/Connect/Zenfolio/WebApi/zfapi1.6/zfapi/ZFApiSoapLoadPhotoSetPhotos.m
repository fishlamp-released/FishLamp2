...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFLoadPhotoSetPhotos class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFLoadPhotoSetPhotosResponse class]];
	});
