...
// --------------------------------------------------------------------
// ZFSearchSetByTextHttpPostIn
// --------------------------------------------------------------------
@interface ZFSearchSetByTextHttpPostIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _searchId;
	NSString* _type;
	NSString* _sortOrder;
...
@interface ZFSearchSetByTextHttpPostIn (ValueProperties) 
@end
