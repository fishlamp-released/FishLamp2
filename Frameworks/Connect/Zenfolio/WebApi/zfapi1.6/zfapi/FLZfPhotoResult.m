...
@implementation FLZfPhotoResult
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfPhotoResult*)object).Photos = FLCopyOrRetainObject(_Photos);
	((FLZfPhotoResult*)object).TotalCount = FLCopyOrRetainObject(_TotalCount);
}
...
{
	return FLAutorelease([[FLZfPhotoResult alloc] init]);
}
...
@implementation FLZfPhotoResult (ValueProperties) 
