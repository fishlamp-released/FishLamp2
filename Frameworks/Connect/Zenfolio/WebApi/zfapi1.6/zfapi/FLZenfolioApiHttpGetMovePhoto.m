...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioMovePhotoHttpGetIn class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioMovePhotoHttpGetOut class]];
	});
	return s_describer;
}
