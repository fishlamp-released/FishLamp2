...
//
//	FLZfAuthenticatePlainHttpGetIn.m
...
@implementation FLZfAuthenticatePlainHttpGetIn
...
{
	return FLAutorelease([[FLZfAuthenticatePlainHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticatePlainHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfAuthenticatePlainHttpGetIn*)object).password = FLCopyOrRetainObject(_password);
}
...
@implementation FLZfAuthenticatePlainHttpGetIn (ValueProperties) 
@end
