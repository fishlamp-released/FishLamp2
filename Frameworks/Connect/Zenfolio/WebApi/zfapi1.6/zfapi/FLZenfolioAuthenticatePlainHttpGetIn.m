...
//
//	FLZenfolioAuthenticatePlainHttpGetIn.m
...
@implementation FLZenfolioAuthenticatePlainHttpGetIn
...
{
	return FLAutorelease([[FLZenfolioAuthenticatePlainHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioAuthenticatePlainHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZenfolioAuthenticatePlainHttpGetIn*)object).password = FLCopyOrRetainObject(_password);
}
...
@implementation FLZenfolioAuthenticatePlainHttpGetIn (ValueProperties) 
@end
