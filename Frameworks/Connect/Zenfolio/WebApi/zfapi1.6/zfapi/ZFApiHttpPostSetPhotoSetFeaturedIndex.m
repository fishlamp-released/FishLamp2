...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFSetPhotoSetFeaturedIndexHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[ZFSetPhotoSetFeaturedIndexHttpPostOut class]];
	});
	return s_describer;
}
