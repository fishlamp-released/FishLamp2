...
@implementation FLZfReorderPhotoSet
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReorderPhotoSet*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfReorderPhotoSet*)object).shiftOrder = FLCopyOrRetainObject(_shiftOrder);
}
...
{
	return FLAutorelease([[FLZfReorderPhotoSet alloc] init]);
}
...
@implementation FLZfReorderPhotoSet (ValueProperties) 
...
- (FLZfShiftOrder) shiftOrderValue
{
	return [[FLZfApi1_6EnumLookup instance] shiftOrderFromString:self.shiftOrder];
}

- (void) setShiftOrderValue:(FLZfShiftOrder) inEnumValue
{
	self.shiftOrder = [[FLZfApi1_6EnumLookup instance] stringFromShiftOrder:inEnumValue];
}
@end
