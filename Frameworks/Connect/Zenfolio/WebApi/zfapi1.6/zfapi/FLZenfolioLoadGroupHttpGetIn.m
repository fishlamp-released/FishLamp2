...
//
//	FLZenfolioLoadGroupHttpGetIn.m
...
@implementation FLZenfolioLoadGroupHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadGroupHttpGetIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZenfolioLoadGroupHttpGetIn*)object).level = FLCopyOrRetainObject(_level);
	((FLZenfolioLoadGroupHttpGetIn*)object).includeChildren = FLCopyOrRetainObject(_includeChildren);
}
...
{
	return FLAutorelease([[FLZenfolioLoadGroupHttpGetIn alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"groupId" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"level" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"includeChildren" propertyClass:[NSString class] ] ];
	});
	return s_describer;
}
...
@implementation FLZenfolioLoadGroupHttpGetIn (ValueProperties) 
@end
