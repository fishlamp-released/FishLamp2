...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFRotatePhoto class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFRotatePhotoResponse class]];
	});
	return s_describer;
}
