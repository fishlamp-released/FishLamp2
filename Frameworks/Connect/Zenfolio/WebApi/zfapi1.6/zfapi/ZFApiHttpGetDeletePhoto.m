...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFDeletePhotoHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFDeletePhotoHttpGetOut class]];
	});
	return s_describer;
}
