...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"LoadGroupResult" propertyClass:[ZFGroup class] propertyType:FLDataTypeObject] forPropertyName:@"LoadGroupResult"];
	});
	return s_describer;
}
