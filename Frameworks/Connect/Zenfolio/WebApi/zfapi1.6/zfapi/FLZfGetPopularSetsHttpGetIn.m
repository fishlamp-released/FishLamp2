...
@implementation FLZfGetPopularSetsHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetPopularSetsHttpGetIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZfGetPopularSetsHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetPopularSetsHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetPopularSetsHttpGetIn alloc] init]);
}
...
@implementation FLZfGetPopularSetsHttpGetIn (ValueProperties) 
@end
