...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"LoadAccessRealmResult" propertyClass:[ZFAccessDescriptor class] propertyType:FLDataTypeObject] forPropertyName:@"LoadAccessRealmResult"];
	});
	return s_describer;
}
