...
//
//	FLZfKeyringAddKeyPlainHttpGetIn.m
...
@implementation FLZfKeyringAddKeyPlainHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfKeyringAddKeyPlainHttpGetIn*)object).keyring = FLCopyOrRetainObject(_keyring);
	((FLZfKeyringAddKeyPlainHttpGetIn*)object).realmId = FLCopyOrRetainObject(_realmId);
	((FLZfKeyringAddKeyPlainHttpGetIn*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[FLZfKeyringAddKeyPlainHttpGetIn alloc] init]);
}
...
@implementation FLZfKeyringAddKeyPlainHttpGetIn (ValueProperties) 
@end
