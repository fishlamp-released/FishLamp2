...
//
//	FLZfKeyringGetUnlockedRealmsHttpGetIn.m
...
@implementation FLZfKeyringGetUnlockedRealmsHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfKeyringGetUnlockedRealmsHttpGetIn*)object).keyring = FLCopyOrRetainObject(_keyring);
}
...
{
	return FLAutorelease([[FLZfKeyringGetUnlockedRealmsHttpGetIn alloc] init]);
}
...
@implementation FLZfKeyringGetUnlockedRealmsHttpGetIn (ValueProperties) 
@end
