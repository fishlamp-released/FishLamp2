...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"CreatePhotoSetResult" propertyClass:[ZFPhotoSet class] propertyType:FLDataTypeObject] forPropertyName:@"CreatePhotoSetResult"];
	});
	return s_describer;
}
