...
- (void) copySelfTo:(id) object
{
	...
	((ZFSetPhotoSetTitlePhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((ZFSetPhotoSetTitlePhotoHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[ZFSetPhotoSetTitlePhotoHttpPostIn alloc] init]);
}
...
@implementation ZFSetPhotoSetTitlePhotoHttpPostIn (ValueProperties) 
@end
