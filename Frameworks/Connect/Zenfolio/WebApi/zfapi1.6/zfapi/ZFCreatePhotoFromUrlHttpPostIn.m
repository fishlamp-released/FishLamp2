...
- (void) copySelfTo:(id) object
{
	...
	((ZFCreatePhotoFromUrlHttpPostIn*)object).url = FLCopyOrRetainObject(_url);
	((ZFCreatePhotoFromUrlHttpPostIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((ZFCreatePhotoFromUrlHttpPostIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[ZFCreatePhotoFromUrlHttpPostIn alloc] init]);
}
...
@implementation ZFCreatePhotoFromUrlHttpPostIn (ValueProperties) 
@end
