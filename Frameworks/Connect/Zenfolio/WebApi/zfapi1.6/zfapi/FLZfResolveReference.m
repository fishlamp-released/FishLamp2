...
@implementation FLZfResolveReference
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfResolveReference*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfResolveReference*)object).reference = FLCopyOrRetainObject(_reference);
}
...
{
	return FLAutorelease([[FLZfResolveReference alloc] init]);
}
...
@implementation FLZfResolveReference (ValueProperties) 
@end
