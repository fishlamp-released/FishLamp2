...
//
//	FLZfAuthenticateVisitorResponse.m
...
@implementation FLZfAuthenticateVisitorResponse
...
{
	return FLAutorelease([[FLZfAuthenticateVisitorResponse alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticateVisitorResponse*)object).AuthenticateVisitorResult = FLCopyOrRetainObject(_AuthenticateVisitorResult);
}
...
@implementation FLZfAuthenticateVisitorResponse (ValueProperties) 
@end
