...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFSetGroupTitlePhoto class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFSetGroupTitlePhotoResponse class]];
	});
	return s_describer;
}
