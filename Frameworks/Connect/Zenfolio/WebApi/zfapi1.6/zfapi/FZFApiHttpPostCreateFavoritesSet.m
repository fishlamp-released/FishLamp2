...
//
//	FLZenfolioApiHttpPostCreateFavoritesSet.m
...
- (FLZenfolioCreateFavoritesSetHttpPostIn*) input
{
	if(!_input)
	{
		_input = [[FLZenfolioCreateFavoritesSetHttpPostIn alloc] init];
	}
	return _input;
}
...
{
	return FLAutorelease([[FLZenfolioApiHttpPostCreateFavoritesSet alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[FLZenfolioCreateFavoritesSetHttpPostIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
...
@implementation FLZenfolioApiHttpPostCreateFavoritesSet (ValueProperties) 
...
@implementation FLZenfolioApiHttpPostCreateFavoritesSet (ObjectMembers) 

// This returns _input. It does NOT create it if it's NIL.
- (FLZenfolioCreateFavoritesSetHttpPostIn*) inputObject
{
	return _input;
}
