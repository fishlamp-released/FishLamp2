...
//
//	FLZenfolioDeleteMessageHttpPostIn.m
...
@implementation FLZenfolioDeleteMessageHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioDeleteMessageHttpPostIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZenfolioDeleteMessageHttpPostIn*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZenfolioDeleteMessageHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioDeleteMessageHttpPostIn (ValueProperties) 
@end
