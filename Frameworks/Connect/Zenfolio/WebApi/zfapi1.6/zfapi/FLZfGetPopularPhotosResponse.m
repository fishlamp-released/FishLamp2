...
//
//	FLZfGetPopularPhotosResponse.m
...
@implementation FLZfGetPopularPhotosResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetPopularPhotosResponse*)object).GetPopularPhotosResult = FLCopyOrRetainObject(_GetPopularPhotosResult);
}
...
{
	return FLAutorelease([[FLZfGetPopularPhotosResponse alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"GetPopularPhotosResult" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"Photo" propertyClass:[FLZfPhoto class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"GetPopularPhotosResult"];
	});
	return s_describer;
}
...
@implementation FLZfGetPopularPhotosResponse (ValueProperties) 
@end
