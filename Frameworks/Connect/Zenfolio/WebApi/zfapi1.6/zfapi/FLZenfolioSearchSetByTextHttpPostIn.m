...
//
//	FLZenfolioSearchSetByTextHttpPostIn.m
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioSearchSetByTextHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioSearchSetByTextHttpPostIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZenfolioSearchSetByTextHttpPostIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZenfolioSearchSetByTextHttpPostIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZenfolioSearchSetByTextHttpPostIn*)object).query = FLCopyOrRetainObject(_query);
	((FLZenfolioSearchSetByTextHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZenfolioSearchSetByTextHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioSearchSetByTextHttpPostIn (ValueProperties) 
@end
