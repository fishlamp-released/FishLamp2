...
@implementation FLZenfolioCheckPrivilege
...
{
	return FLAutorelease([[FLZenfolioCheckPrivilege alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioCheckPrivilege*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZenfolioCheckPrivilege*)object).privilegeName = FLCopyOrRetainObject(_privilegeName);
}
...
@implementation FLZenfolioCheckPrivilege (ValueProperties) 
@end
