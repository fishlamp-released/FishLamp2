...
@implementation FLZfDeletePhotoSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeletePhotoSetHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
+ (FLZfDeletePhotoSetHttpGetIn*) deletePhotoSetHttpGetIn
{
	return FLAutorelease([[FLZfDeletePhotoSetHttpGetIn alloc] init]);
}
...
@implementation FLZfDeletePhotoSetHttpGetIn (ValueProperties) 
@end
