...
@implementation FLZfGetChallengeHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetChallengeHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZfGetChallengeHttpPostIn alloc] init]);
}
...
@implementation FLZfGetChallengeHttpPostIn (ValueProperties) 
@end
