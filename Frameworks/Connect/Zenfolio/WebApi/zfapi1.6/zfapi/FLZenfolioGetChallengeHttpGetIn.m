...
//
//	FLZenfolioGetChallengeHttpGetIn.m
...
@implementation FLZenfolioGetChallengeHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetChallengeHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZenfolioGetChallengeHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioGetChallengeHttpGetIn (ValueProperties) 
@end
