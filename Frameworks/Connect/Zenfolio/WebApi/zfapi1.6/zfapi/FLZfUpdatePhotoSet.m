...
@implementation FLZfUpdatePhotoSet
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUpdatePhotoSet*)object).updater = FLCopyOrRetainObject(_updater);
	((FLZfUpdatePhotoSet*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfUpdatePhotoSet alloc] init]);
}

@end

@implementation FLZfUpdatePhotoSet (ValueProperties) 
