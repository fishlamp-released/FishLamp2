...
@implementation FLZfLoadGroupHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadGroupHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfLoadGroupHttpPostIn*)object).level = FLCopyOrRetainObject(_level);
	((FLZfLoadGroupHttpPostIn*)object).includeChildren = FLCopyOrRetainObject(_includeChildren);
}
...
{
	return FLAutorelease([[FLZfLoadGroupHttpPostIn alloc] init]);
}
...
@implementation FLZfLoadGroupHttpPostIn (ValueProperties) 
@end
