...
@implementation FLZenfolioDeleteMessage
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioDeleteMessage*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZenfolioDeleteMessage*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZenfolioDeleteMessage alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"messageIndex" propertyClass:[NSNumber class] propertyType:FLDataTypeInteger] forPropertyName:@"messageIndex"];
	});
	return s_describer;
}
...
@implementation FLZenfolioDeleteMessage (ValueProperties) 
