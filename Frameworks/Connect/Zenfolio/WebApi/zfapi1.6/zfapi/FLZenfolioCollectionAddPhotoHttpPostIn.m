...
//
//	FLZenfolioCollectionAddPhotoHttpPostIn.m
...
@implementation FLZenfolioCollectionAddPhotoHttpPostIn
...
{
	return FLAutorelease([[FLZenfolioCollectionAddPhotoHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioCollectionAddPhotoHttpPostIn*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZenfolioCollectionAddPhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZenfolioCollectionAddPhotoHttpPostIn (ValueProperties) 
@end
