...
//
//	FLZfReindexPhotoSetHttpPostIn.m
...
@implementation FLZfReindexPhotoSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReindexPhotoSetHttpPostIn*)object).startIndex = FLCopyOrRetainObject(_startIndex);
	((FLZfReindexPhotoSetHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfReindexPhotoSetHttpPostIn*)object).mapping = FLCopyOrRetainObject(_mapping);
}
...
{
	return FLAutorelease([[FLZfReindexPhotoSetHttpPostIn alloc] init]);
}
...
@implementation FLZfReindexPhotoSetHttpPostIn (ValueProperties) 
@end
