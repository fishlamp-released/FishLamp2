...
- (void) copySelfTo:(id) object
{
	...
	((ZFGetDownloadOriginalKey*)object).photoIds = FLCopyOrRetainObject(_photoIds);
	((ZFGetDownloadOriginalKey*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[ZFGetDownloadOriginalKey alloc] init]);
}
...
@implementation ZFGetDownloadOriginalKey (ValueProperties) 
@end
