...
@implementation FLZfGroupUpdater
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGroupUpdater*)object).Title = FLCopyOrRetainObject(_Title);
	((FLZfGroupUpdater*)object).Caption = FLCopyOrRetainObject(_Caption);
	((FLZfGroupUpdater*)object).CustomReference = FLCopyOrRetainObject(_CustomReference);
}
...
{
	return FLAutorelease([[FLZfGroupUpdater alloc] init]);
}
...
@implementation FLZfGroupUpdater (ValueProperties) 
@end
