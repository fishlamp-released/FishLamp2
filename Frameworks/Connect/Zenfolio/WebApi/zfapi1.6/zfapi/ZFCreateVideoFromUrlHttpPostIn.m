...
//
//	ZFCreateVideoFromUrlHttpPostIn.m
...
@implementation ZFCreateVideoFromUrlHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((ZFCreateVideoFromUrlHttpPostIn*)object).url = FLCopyOrRetainObject(_url);
	((ZFCreateVideoFromUrlHttpPostIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((ZFCreateVideoFromUrlHttpPostIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[ZFCreateVideoFromUrlHttpPostIn alloc] init]);
}
...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"galleryId" withClass:[NSString class]];
...
@implementation ZFCreateVideoFromUrlHttpPostIn (ValueProperties) 
@end
