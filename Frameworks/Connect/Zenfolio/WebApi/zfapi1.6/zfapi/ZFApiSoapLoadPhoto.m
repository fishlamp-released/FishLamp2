...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFLoadPhoto class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFLoadPhotoResponse class]];
	});
	return s_describer;
}
