...
//
//	FLZenfolioSearchPhotoByCategoryHttpGetIn.h
...
// --------------------------------------------------------------------
// FLZenfolioSearchPhotoByCategoryHttpGetIn
// --------------------------------------------------------------------
@interface FLZenfolioSearchPhotoByCategoryHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _searchId;
	NSString* _sortOrder;
...
@interface FLZenfolioSearchPhotoByCategoryHttpGetIn (ValueProperties) 
@end
