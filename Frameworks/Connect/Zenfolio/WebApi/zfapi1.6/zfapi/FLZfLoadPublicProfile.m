...
@implementation FLZfLoadPublicProfile
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPublicProfile*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
+ (FLZfLoadPublicProfile*) loadPublicProfile
{
	return FLAutorelease([[FLZfLoadPublicProfile alloc] init]);
}
...
@implementation FLZfLoadPublicProfile (ValueProperties) 
@end
