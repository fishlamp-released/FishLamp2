...
//
//	FLZfSearchSetByTextHttpPostIn.m
...
@implementation FLZfSearchSetByTextHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchSetByTextHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfSearchSetByTextHttpPostIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchSetByTextHttpPostIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchSetByTextHttpPostIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZfSearchSetByTextHttpPostIn*)object).query = FLCopyOrRetainObject(_query);
	((FLZfSearchSetByTextHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfSearchSetByTextHttpPostIn alloc] init]);
}
...
@implementation FLZfSearchSetByTextHttpPostIn (ValueProperties) 
@end
