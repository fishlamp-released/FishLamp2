...
@implementation FLZfReplacePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReplacePhotoHttpGetIn*)object).originalId = FLCopyOrRetainObject(_originalId);
	((FLZfReplacePhotoHttpGetIn*)object).replacedId = FLCopyOrRetainObject(_replacedId);
}
...
+ (FLZfReplacePhotoHttpGetIn*) replacePhotoHttpGetIn
{
	return FLAutorelease([[FLZfReplacePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZfReplacePhotoHttpGetIn (ValueProperties) 
@end
