...
@implementation FLZfMovePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfMovePhotoHttpGetIn*)object).destSetId = FLCopyOrRetainObject(_destSetId);
	((FLZfMovePhotoHttpGetIn*)object).index = FLCopyOrRetainObject(_index);
	((FLZfMovePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfMovePhotoHttpGetIn*)object).srcSetId = FLCopyOrRetainObject(_srcSetId);
}
...
{
	return FLAutorelease([[FLZfMovePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZfMovePhotoHttpGetIn (ValueProperties) 
@end
