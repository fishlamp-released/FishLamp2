...
//
//	FLZenfolioCreateVideoFromUrlHttpPostIn.m
...
@implementation FLZenfolioCreateVideoFromUrlHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioCreateVideoFromUrlHttpPostIn*)object).url = FLCopyOrRetainObject(_url);
	((FLZenfolioCreateVideoFromUrlHttpPostIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZenfolioCreateVideoFromUrlHttpPostIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZenfolioCreateVideoFromUrlHttpPostIn alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"galleryId" withClass:[NSString class]];
...
@implementation FLZenfolioCreateVideoFromUrlHttpPostIn (ValueProperties) 
@end
