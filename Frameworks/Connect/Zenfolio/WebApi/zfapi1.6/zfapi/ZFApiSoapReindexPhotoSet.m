...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFReindexPhotoSet class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFReindexPhotoSetResponse class]];
	});
	return s_describer;
}
