...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFReindexPhotoSet class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFReindexPhotoSetResponse class]];
	});
