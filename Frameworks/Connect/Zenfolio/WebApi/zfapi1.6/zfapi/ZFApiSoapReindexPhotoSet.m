...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFReindexPhotoSet class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFReindexPhotoSetResponse class]];
	});
	return s_describer;
}
