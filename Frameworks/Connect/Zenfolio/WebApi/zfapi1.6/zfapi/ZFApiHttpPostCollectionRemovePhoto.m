...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFCollectionRemovePhotoHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[ZFCollectionRemovePhotoHttpPostOut class]];
	});
	return s_describer;
}
