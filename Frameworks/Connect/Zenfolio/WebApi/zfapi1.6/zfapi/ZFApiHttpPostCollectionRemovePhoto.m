...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFCollectionRemovePhotoHttpPostIn class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFCollectionRemovePhotoHttpPostOut class]];
	});
