...
@implementation FLZfAccessDescriptor
...
{
	return FLAutorelease([[FLZfAccessDescriptor alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAccessDescriptor*)object).RealmId = FLCopyOrRetainObject(_RealmId);
	((FLZfAccessDescriptor*)object).SrcPasswordHint = FLCopyOrRetainObject(_SrcPasswordHint);
	((FLZfAccessDescriptor*)object).password = FLCopyOrRetainObject(_password);
	((FLZfAccessDescriptor*)object).IsDerived = FLCopyOrRetainObject(_IsDerived);
	((FLZfAccessDescriptor*)object).Viewers = FLCopyOrRetainObject(_Viewers);
	((FLZfAccessDescriptor*)object).protectedObjectClassName = FLCopyOrRetainObject(_protectedObjectClassName);
	((FLZfAccessDescriptor*)object).AccessMask = FLCopyOrRetainObject(_AccessMask);
	((FLZfAccessDescriptor*)object).PasswordHint = FLCopyOrRetainObject(_PasswordHint);
	((FLZfAccessDescriptor*)object).AccessType = FLCopyOrRetainObject(_AccessType);
}
...
@implementation FLZfAccessDescriptor (ValueProperties) 
