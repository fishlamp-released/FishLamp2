...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFGetVisitorKey class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFGetVisitorKeyResponse class]];
	});
	return s_describer;
}
