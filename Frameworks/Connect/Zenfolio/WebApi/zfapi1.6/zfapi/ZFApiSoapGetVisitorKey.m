...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFGetVisitorKey class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFGetVisitorKeyResponse class]];
	});
	return s_describer;
}
