...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFResolveReferenceHttpGetIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
