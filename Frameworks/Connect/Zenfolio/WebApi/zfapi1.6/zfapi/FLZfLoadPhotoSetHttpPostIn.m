...
@implementation FLZfLoadPhotoSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPhotoSetHttpPostIn*)object).level = FLCopyOrRetainObject(_level);
	((FLZfLoadPhotoSetHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfLoadPhotoSetHttpPostIn*)object).includePhotos = FLCopyOrRetainObject(_includePhotos);
}
...
{
	return FLAutorelease([[FLZfLoadPhotoSetHttpPostIn alloc] init]);
}
...
@implementation FLZfLoadPhotoSetHttpPostIn (ValueProperties) 
@end
