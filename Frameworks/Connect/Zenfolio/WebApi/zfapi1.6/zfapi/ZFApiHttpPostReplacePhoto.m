...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFReplacePhotoHttpPostIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFReplacePhotoHttpPostOut class]];
	});
	return s_describer;
}
