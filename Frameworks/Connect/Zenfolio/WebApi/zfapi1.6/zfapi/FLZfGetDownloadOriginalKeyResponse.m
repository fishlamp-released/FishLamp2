...
//
//	FLZfGetDownloadOriginalKeyResponse.m
...
@implementation FLZfGetDownloadOriginalKeyResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetDownloadOriginalKeyResponse*)object).GetDownloadOriginalKeyResult = FLCopyOrRetainObject(_GetDownloadOriginalKeyResult);
}
...
+ (FLZfGetDownloadOriginalKeyResponse*) getDownloadOriginalKeyResponse
{
	return FLAutorelease([[FLZfGetDownloadOriginalKeyResponse alloc] init]);
}
...
@implementation FLZfGetDownloadOriginalKeyResponse (ValueProperties) 
@end
