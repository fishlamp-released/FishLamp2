...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFAuthenticateVisitorHttpGetIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
