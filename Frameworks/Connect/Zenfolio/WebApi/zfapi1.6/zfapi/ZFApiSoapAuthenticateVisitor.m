...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFAuthenticateVisitor class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFAuthenticateVisitorResponse class]];
	});
	return s_describer;
}
