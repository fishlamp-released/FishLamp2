...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFAuthenticateVisitor class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFAuthenticateVisitorResponse class]];
	});
