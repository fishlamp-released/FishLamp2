...
//
//	FLZenfolioGetRecentSetsHttpPostIn.m
...
@implementation FLZenfolioGetRecentSetsHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetRecentSetsHttpPostIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZenfolioGetRecentSetsHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetRecentSetsHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
+ (FLZenfolioGetRecentSetsHttpPostIn*) getRecentSetsHttpPostIn
{
	return FLAutorelease([[FLZenfolioGetRecentSetsHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioGetRecentSetsHttpPostIn (ValueProperties) 
@end
