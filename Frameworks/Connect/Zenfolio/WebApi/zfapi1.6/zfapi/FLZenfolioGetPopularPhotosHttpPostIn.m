...
//
//	FLZenfolioGetPopularPhotosHttpPostIn.m
...
@implementation FLZenfolioGetPopularPhotosHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetPopularPhotosHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetPopularPhotosHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZenfolioGetPopularPhotosHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioGetPopularPhotosHttpPostIn (ValueProperties) 
@end
