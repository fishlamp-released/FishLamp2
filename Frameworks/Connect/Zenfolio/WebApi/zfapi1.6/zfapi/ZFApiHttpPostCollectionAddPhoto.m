...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFCollectionAddPhotoHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[ZFCollectionAddPhotoHttpPostOut class]];
	});
	return s_describer;
}
