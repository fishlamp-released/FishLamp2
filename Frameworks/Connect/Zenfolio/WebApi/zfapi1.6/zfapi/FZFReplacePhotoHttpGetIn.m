...
//
//	FLZenfolioReplacePhotoHttpGetIn.m
...
@implementation FLZenfolioReplacePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioReplacePhotoHttpGetIn*)object).originalId = FLCopyOrRetainObject(_originalId);
	((FLZenfolioReplacePhotoHttpGetIn*)object).replacedId = FLCopyOrRetainObject(_replacedId);
}
...
{
	return FLAutorelease([[FLZenfolioReplacePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioReplacePhotoHttpGetIn (ValueProperties) 
@end
