...
@implementation FLZfMoveGroupHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfMoveGroupHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfMoveGroupHttpPostIn*)object).destGroupId = FLCopyOrRetainObject(_destGroupId);
	((FLZfMoveGroupHttpPostIn*)object).index = FLCopyOrRetainObject(_index);
}
...
{
	return FLAutorelease([[FLZfMoveGroupHttpPostIn alloc] init]);
}
...
@implementation FLZfMoveGroupHttpPostIn (ValueProperties) 
@end
