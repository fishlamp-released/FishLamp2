...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFMovePhoto class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFMovePhotoResponse class]];
	});
	return s_describer;
}
