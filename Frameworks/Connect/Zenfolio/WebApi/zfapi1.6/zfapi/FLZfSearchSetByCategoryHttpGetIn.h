...
//
//	FLZfSearchSetByCategoryHttpGetIn.h
...
// --------------------------------------------------------------------
// FLZfSearchSetByCategoryHttpGetIn
// --------------------------------------------------------------------
@interface FLZfSearchSetByCategoryHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _searchId;
	NSString* _type;
	NSString* _sortOrder;
...
@interface FLZfSearchSetByCategoryHttpGetIn (ValueProperties) 
@end
