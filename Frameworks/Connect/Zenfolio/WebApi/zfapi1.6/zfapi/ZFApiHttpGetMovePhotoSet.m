...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFMovePhotoSetHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFMovePhotoSetHttpGetOut class]];
	});
	return s_describer;
}
