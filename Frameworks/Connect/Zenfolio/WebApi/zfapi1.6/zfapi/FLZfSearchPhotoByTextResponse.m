...
//
//	FLZfSearchPhotoByTextResponse.m
...
@implementation FLZfSearchPhotoByTextResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchPhotoByTextResponse*)object).SearchPhotoByTextResult = FLCopyOrRetainObject(_SearchPhotoByTextResult);
}
...
{
	return FLAutorelease([[FLZfSearchPhotoByTextResponse alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"SearchPhotoByTextResult" propertyClass:[FLZfPhotoResult class] propertyType:FLDataTypeObject] forPropertyName:@"SearchPhotoByTextResult"];
	});
	return s_describer;
}
...
@implementation FLZfSearchPhotoByTextResponse (ValueProperties) 
@end
