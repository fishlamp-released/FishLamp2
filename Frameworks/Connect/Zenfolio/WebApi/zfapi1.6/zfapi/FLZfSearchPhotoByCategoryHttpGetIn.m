...
//
//	FLZfSearchPhotoByCategoryHttpGetIn.m
...
@implementation FLZfSearchPhotoByCategoryHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchPhotoByCategoryHttpGetIn*)object).categoryCode = FLCopyOrRetainObject(_categoryCode);
	((FLZfSearchPhotoByCategoryHttpGetIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchPhotoByCategoryHttpGetIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchPhotoByCategoryHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZfSearchPhotoByCategoryHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
{
	return FLAutorelease([[FLZfSearchPhotoByCategoryHttpGetIn alloc] init]);
}
...
@implementation FLZfSearchPhotoByCategoryHttpGetIn (ValueProperties) 
@end
