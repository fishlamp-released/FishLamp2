...
@implementation FLZfMessageUpdater
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfMessageUpdater*)object).PosterName = FLCopyOrRetainObject(_PosterName);
	((FLZfMessageUpdater*)object).PosterUrl = FLCopyOrRetainObject(_PosterUrl);
	((FLZfMessageUpdater*)object).IsPrivate = FLCopyOrRetainObject(_IsPrivate);
	((FLZfMessageUpdater*)object).PosterEmail = FLCopyOrRetainObject(_PosterEmail);
	((FLZfMessageUpdater*)object).Body = FLCopyOrRetainObject(_Body);
}
...
{
	return FLAutorelease([[FLZfMessageUpdater alloc] init]);
}
...
@implementation FLZfMessageUpdater (ValueProperties) 
