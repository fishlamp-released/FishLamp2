...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"Group" propertyClass:[ZFGroup class] propertyType:FLDataTypeObject] forPropertyName:@"Group"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[ZFPhotoSet class] propertyType:FLDataTypeObject] forPropertyName:@"PhotoSet"];
	});
	return s_describer;
}
