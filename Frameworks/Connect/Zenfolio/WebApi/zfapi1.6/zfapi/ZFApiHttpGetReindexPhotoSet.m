...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFReindexPhotoSetHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFReindexPhotoSetHttpGetOut class]];
	});
	return s_describer;
}
