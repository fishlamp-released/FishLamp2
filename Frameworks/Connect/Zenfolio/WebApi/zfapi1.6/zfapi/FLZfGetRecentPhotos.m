...
@implementation FLZfGetRecentPhotos
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetRecentPhotos*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetRecentPhotos*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetRecentPhotos alloc] init]);
}
...
@implementation FLZfGetRecentPhotos (ValueProperties) 
