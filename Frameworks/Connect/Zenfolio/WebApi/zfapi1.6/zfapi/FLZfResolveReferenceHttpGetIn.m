...
//
//	FLZfResolveReferenceHttpGetIn.m
...
@implementation FLZfResolveReferenceHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfResolveReferenceHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfResolveReferenceHttpGetIn*)object).reference = FLCopyOrRetainObject(_reference);
}
...
+ (FLZfResolveReferenceHttpGetIn*) resolveReferenceHttpGetIn
{
	return FLAutorelease([[FLZfResolveReferenceHttpGetIn alloc] init]);
}
...
@implementation FLZfResolveReferenceHttpGetIn (ValueProperties) 
@end
