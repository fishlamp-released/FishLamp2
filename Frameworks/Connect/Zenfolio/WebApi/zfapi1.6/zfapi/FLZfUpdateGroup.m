...
@implementation FLZfUpdateGroup
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUpdateGroup*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfUpdateGroup*)object).updater = FLCopyOrRetainObject(_updater);
}
...
{
	return FLAutorelease([[FLZfUpdateGroup alloc] init]);
}

@end

@implementation FLZfUpdateGroup (ValueProperties) 
