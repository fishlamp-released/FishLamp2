...
// --------------------------------------------------------------------
// FLZfRotatePhotoHttpPostIn
// --------------------------------------------------------------------
@interface FLZfRotatePhotoHttpPostIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _photoId;
	NSString* _rotation;
} 
...
@interface FLZfRotatePhotoHttpPostIn (ValueProperties) 
@end
