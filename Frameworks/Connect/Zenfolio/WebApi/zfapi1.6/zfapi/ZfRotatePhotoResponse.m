...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"RotatePhotoResult" propertyClass:[ZFPhoto class] propertyType:FLDataTypeObject] forPropertyName:@"RotatePhotoResult"];
	});
	return s_describer;
}
