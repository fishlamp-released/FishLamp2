...
// --------------------------------------------------------------------
// ZFDeleteMessageHttpGetIn
// --------------------------------------------------------------------
@interface ZFDeleteMessageHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _mailboxId;
...
@interface ZFDeleteMessageHttpGetIn (ValueProperties) 
@end
