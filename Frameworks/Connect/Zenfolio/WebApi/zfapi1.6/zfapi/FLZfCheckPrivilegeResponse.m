...
@implementation FLZfCheckPrivilegeResponse
...
{
	return FLAutorelease([[FLZfCheckPrivilegeResponse alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCheckPrivilegeResponse*)object).CheckPrivilegeResult = FLCopyOrRetainObject(_CheckPrivilegeResult);
}
...
@implementation FLZfCheckPrivilegeResponse (ValueProperties) 
