...
//
//	FLZenfolioSetPhotoSetTitlePhotoHttpGetIn.m
...
@implementation FLZenfolioSetPhotoSetTitlePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioSetPhotoSetTitlePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZenfolioSetPhotoSetTitlePhotoHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZenfolioSetPhotoSetTitlePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioSetPhotoSetTitlePhotoHttpGetIn (ValueProperties) 
@end
