...
//
//	FLZenfolioAuthenticatePlainHttpPostIn.m
...
@implementation FLZenfolioAuthenticatePlainHttpPostIn
...
{
	return FLAutorelease([[FLZenfolioAuthenticatePlainHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioAuthenticatePlainHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZenfolioAuthenticatePlainHttpPostIn*)object).password = FLCopyOrRetainObject(_password);
}
...
@implementation FLZenfolioAuthenticatePlainHttpPostIn (ValueProperties) 
@end
