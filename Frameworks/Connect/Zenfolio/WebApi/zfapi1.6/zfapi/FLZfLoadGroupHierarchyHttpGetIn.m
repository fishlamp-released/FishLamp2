...
//
//	FLZfLoadGroupHierarchyHttpGetIn.m
...
@implementation FLZfLoadGroupHierarchyHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadGroupHierarchyHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZfLoadGroupHierarchyHttpGetIn alloc] init]);
}
...
@implementation FLZfLoadGroupHierarchyHttpGetIn (ValueProperties) 
@end
