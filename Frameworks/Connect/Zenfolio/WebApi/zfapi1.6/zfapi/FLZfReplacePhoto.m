...
@implementation FLZfReplacePhoto
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReplacePhoto*)object).originalId = FLCopyOrRetainObject(_originalId);
	((FLZfReplacePhoto*)object).replacedId = FLCopyOrRetainObject(_replacedId);
}
...
{
	return FLAutorelease([[FLZfReplacePhoto alloc] init]);
}
...
@implementation FLZfReplacePhoto (ValueProperties) 
