...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFMoveGroupHttpGetIn class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFMoveGroupHttpGetOut class]];
	});
