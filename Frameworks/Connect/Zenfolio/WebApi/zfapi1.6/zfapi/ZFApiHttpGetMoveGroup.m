...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFMoveGroupHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFMoveGroupHttpGetOut class]];
	});
	return s_describer;
}
