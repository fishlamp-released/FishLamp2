...
//
//	FLZenfolioCreateFavoritesSetHttpPostIn.m
...
@implementation FLZenfolioCreateFavoritesSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioCreateFavoritesSetHttpPostIn*)object).name = FLCopyOrRetainObject(_name);
	((FLZenfolioCreateFavoritesSetHttpPostIn*)object).photographerLogin = FLCopyOrRetainObject(_photographerLogin);
	((FLZenfolioCreateFavoritesSetHttpPostIn*)object).photoIds = FLCopyOrRetainObject(_photoIds);
}
...
+ (FLZenfolioCreateFavoritesSetHttpPostIn*) createFavoritesSetHttpPostIn
{
	return FLAutorelease([[FLZenfolioCreateFavoritesSetHttpPostIn alloc] init]);
}
...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"photoIds" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"String" objectClass:[NSString class] ], nil]];
	});
	return s_describer;
}
...
@implementation FLZenfolioCreateFavoritesSetHttpPostIn (ValueProperties) 
@end
