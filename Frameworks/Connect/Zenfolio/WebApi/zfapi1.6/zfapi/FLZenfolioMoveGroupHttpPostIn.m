...
//
//	FLZenfolioMoveGroupHttpPostIn.m
...
@implementation FLZenfolioMoveGroupHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioMoveGroupHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZenfolioMoveGroupHttpPostIn*)object).destGroupId = FLCopyOrRetainObject(_destGroupId);
	((FLZenfolioMoveGroupHttpPostIn*)object).index = FLCopyOrRetainObject(_index);
}
...
{
	return FLAutorelease([[FLZenfolioMoveGroupHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioMoveGroupHttpPostIn (ValueProperties) 
@end
