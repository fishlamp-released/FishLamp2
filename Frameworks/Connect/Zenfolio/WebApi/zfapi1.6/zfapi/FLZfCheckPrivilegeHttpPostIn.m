...
//
//	FLZfCheckPrivilegeHttpPostIn.m
...
@implementation FLZfCheckPrivilegeHttpPostIn
...
{
	return FLAutorelease([[FLZfCheckPrivilegeHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCheckPrivilegeHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfCheckPrivilegeHttpPostIn*)object).privilegeName = FLCopyOrRetainObject(_privilegeName);
}
...
@implementation FLZfCheckPrivilegeHttpPostIn (ValueProperties) 
@end
