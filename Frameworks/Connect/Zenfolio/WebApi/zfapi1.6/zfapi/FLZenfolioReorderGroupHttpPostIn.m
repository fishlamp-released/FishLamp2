...
//
//	FLZenfolioReorderGroupHttpPostIn.m
...
@implementation FLZenfolioReorderGroupHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioReorderGroupHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZenfolioReorderGroupHttpPostIn*)object).shiftOrder = FLCopyOrRetainObject(_shiftOrder);
}
...
{
	return FLAutorelease([[FLZenfolioReorderGroupHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioReorderGroupHttpPostIn (ValueProperties) 
@end
