...
//
//	FLZenfolioAuthenticateVisitorHttpPostIn.m
...
@implementation FLZenfolioAuthenticateVisitorHttpPostIn
...
{
	return FLAutorelease([[FLZenfolioAuthenticateVisitorHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioAuthenticateVisitorHttpPostIn*)object).visitorKey = FLCopyOrRetainObject(_visitorKey);
}
...
@implementation FLZenfolioAuthenticateVisitorHttpPostIn (ValueProperties) 
@end
