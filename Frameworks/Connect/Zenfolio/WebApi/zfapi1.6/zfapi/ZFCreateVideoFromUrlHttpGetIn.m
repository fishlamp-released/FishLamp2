...
- (void) copySelfTo:(id) object
{
	...
	((ZFCreateVideoFromUrlHttpGetIn*)object).url = FLCopyOrRetainObject(_url);
	((ZFCreateVideoFromUrlHttpGetIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((ZFCreateVideoFromUrlHttpGetIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[ZFCreateVideoFromUrlHttpGetIn alloc] init]);
}
...
@implementation ZFCreateVideoFromUrlHttpGetIn (ValueProperties) 
@end
