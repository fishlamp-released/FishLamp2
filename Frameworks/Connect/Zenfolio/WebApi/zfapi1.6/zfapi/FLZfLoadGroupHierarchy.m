...
@implementation FLZfLoadGroupHierarchy
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadGroupHierarchy*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZfLoadGroupHierarchy alloc] init]);
}
...
@implementation FLZfLoadGroupHierarchy (ValueProperties) 
@end
