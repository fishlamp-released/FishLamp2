...
- (void) copySelfTo:(id) object
{
	...
	((ZFGetPopularSetsHttpPostIn*)object).type = FLCopyOrRetainObject(_type);
	((ZFGetPopularSetsHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((ZFGetPopularSetsHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[ZFGetPopularSetsHttpPostIn alloc] init]);
}
...
@implementation ZFGetPopularSetsHttpPostIn (ValueProperties) 
@end
