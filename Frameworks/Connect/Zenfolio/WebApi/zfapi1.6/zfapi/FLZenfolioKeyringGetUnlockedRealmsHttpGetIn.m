...
//
//	FLZenfolioKeyringGetUnlockedRealmsHttpGetIn.m
...
@implementation FLZenfolioKeyringGetUnlockedRealmsHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioKeyringGetUnlockedRealmsHttpGetIn*)object).keyring = FLCopyOrRetainObject(_keyring);
}
...
+ (FLZenfolioKeyringGetUnlockedRealmsHttpGetIn*) keyringGetUnlockedRealmsHttpGetIn
{
	return FLAutorelease([[FLZenfolioKeyringGetUnlockedRealmsHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioKeyringGetUnlockedRealmsHttpGetIn (ValueProperties) 
@end
