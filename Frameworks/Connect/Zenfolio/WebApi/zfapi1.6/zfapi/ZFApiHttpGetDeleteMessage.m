...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFDeleteMessageHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFDeleteMessageHttpGetOut class]];
	});
	return s_describer;
}
