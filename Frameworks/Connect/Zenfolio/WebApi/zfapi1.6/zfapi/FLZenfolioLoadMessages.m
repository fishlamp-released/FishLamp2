...
@implementation FLZenfolioLoadMessages
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadMessages*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZenfolioLoadMessages*)object).includeDeleted = FLCopyOrRetainObject(_includeDeleted);
	((FLZenfolioLoadMessages*)object).postedSince = FLCopyOrRetainObject(_postedSince);
}
...
{
	return FLAutorelease([[FLZenfolioLoadMessages alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"postedSince" propertyClass:[NSDate class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"includeDeleted" propertyClass:[FLBoolNumber class]] ];
	});
	return s_describer;
}
...
@implementation FLZenfolioLoadMessages (ValueProperties) 
