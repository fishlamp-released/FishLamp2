...
//
//	FLZenfolioSearchPhotoByTextHttpGetIn.m
...
@implementation FLZenfolioSearchPhotoByTextHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioSearchPhotoByTextHttpGetIn*)object).query = FLCopyOrRetainObject(_query);
	((FLZenfolioSearchPhotoByTextHttpGetIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZenfolioSearchPhotoByTextHttpGetIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZenfolioSearchPhotoByTextHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZenfolioSearchPhotoByTextHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
{
	return FLAutorelease([[FLZenfolioSearchPhotoByTextHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioSearchPhotoByTextHttpGetIn (ValueProperties) 
@end
