...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"LoadPrivateProfileResult" propertyClass:[ZFUser class] propertyType:FLDataTypeObject] forPropertyName:@"LoadPrivateProfileResult"];
	});
	return s_describer;
}
