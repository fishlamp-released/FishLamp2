...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFKeyringAddKeyPlain class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFKeyringAddKeyPlainResponse class]];
	});
