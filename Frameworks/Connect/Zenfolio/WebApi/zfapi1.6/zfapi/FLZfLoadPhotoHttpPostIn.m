...
@implementation FLZfLoadPhotoHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfLoadPhotoHttpPostIn*)object).level = FLCopyOrRetainObject(_level);
}
...
{
	return FLAutorelease([[FLZfLoadPhotoHttpPostIn alloc] init]);
}
...
@implementation FLZfLoadPhotoHttpPostIn (ValueProperties) 
@end
