...
@implementation FLZfDeletePhotoSet
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeletePhotoSet*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfDeletePhotoSet alloc] init]);
}
...
@implementation FLZfDeletePhotoSet (ValueProperties) 
