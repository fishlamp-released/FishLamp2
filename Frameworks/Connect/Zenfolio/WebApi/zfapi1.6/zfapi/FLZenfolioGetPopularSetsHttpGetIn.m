...
//
//	FLZenfolioGetPopularSetsHttpGetIn.m
...
@implementation FLZenfolioGetPopularSetsHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetPopularSetsHttpGetIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZenfolioGetPopularSetsHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetPopularSetsHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZenfolioGetPopularSetsHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioGetPopularSetsHttpGetIn (ValueProperties) 
@end
