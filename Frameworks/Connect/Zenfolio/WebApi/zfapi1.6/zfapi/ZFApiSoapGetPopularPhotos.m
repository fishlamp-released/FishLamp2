...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFGetPopularPhotos class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFGetPopularPhotosResponse class]];
	});
	return s_describer;
}
