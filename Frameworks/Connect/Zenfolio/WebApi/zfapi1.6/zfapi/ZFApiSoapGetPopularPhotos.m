...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFGetPopularPhotos class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFGetPopularPhotosResponse class]];
	});
	return s_describer;
}
