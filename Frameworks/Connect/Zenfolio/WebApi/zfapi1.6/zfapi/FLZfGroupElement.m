...
@implementation FLZfGroupElement
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGroupElement*)object).AccessDescriptor = FLCopyOrRetainObject(_AccessDescriptor);
	((FLZfGroupElement*)object).HideBranding = FLCopyOrRetainObject(_HideBranding);
	((FLZfGroupElement*)object).GroupIndex = FLCopyOrRetainObject(_GroupIndex);
	((FLZfGroupElement*)object).Title = FLCopyOrRetainObject(_Title);
	((FLZfGroupElement*)object).Owner = FLCopyOrRetainObject(_Owner);
	((FLZfGroupElement*)object).Id = FLCopyOrRetainObject(_Id);
}
...
{
	return FLAutorelease([[FLZfGroupElement alloc] init]);
}
...
@implementation FLZfGroupElement (ValueProperties) 
