...
@implementation FLZfRotatePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfRotatePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfRotatePhotoHttpGetIn*)object).rotation = FLCopyOrRetainObject(_rotation);
}
...
{
	return FLAutorelease([[FLZfRotatePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZfRotatePhotoHttpGetIn (ValueProperties) 
@end
