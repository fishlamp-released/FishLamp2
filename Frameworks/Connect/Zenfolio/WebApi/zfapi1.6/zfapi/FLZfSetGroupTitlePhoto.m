...
@implementation FLZfSetGroupTitlePhoto
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetGroupTitlePhoto*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfSetGroupTitlePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
{
	return FLAutorelease([[FLZfSetGroupTitlePhoto alloc] init]);
}
...
@implementation FLZfSetGroupTitlePhoto (ValueProperties) 
