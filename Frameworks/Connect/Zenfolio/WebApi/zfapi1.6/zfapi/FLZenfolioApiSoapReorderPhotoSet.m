...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioReorderPhotoSet class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioReorderPhotoSetResponse class]];
	});
	return s_describer;
}
