...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGroup*)object).TextCn = FLCopyOrRetainObject(_TextCn);
	((FLZfGroup*)object).Caption = FLCopyOrRetainObject(_Caption);
	((FLZfGroup*)object).TitlePhoto = FLCopyOrRetainObject(_TitlePhoto);
	((FLZfGroup*)object).PhotoCount = FLCopyOrRetainObject(_PhotoCount);
	((FLZfGroup*)object).CollectionCount = FLCopyOrRetainObject(_CollectionCount);
	((FLZfGroup*)object).CreatedOn = FLCopyOrRetainObject(_CreatedOn);
	((FLZfGroup*)object).SubGroupCount = FLCopyOrRetainObject(_SubGroupCount);
	((FLZfGroup*)object).PageUrl = FLCopyOrRetainObject(_PageUrl);
	((FLZfGroup*)object).ParentGroups = FLCopyOrRetainObject(_ParentGroups);
	((FLZfGroup*)object).ImageCount = FLCopyOrRetainObject(_ImageCount);
	((FLZfGroup*)object).VideoCount = FLCopyOrRetainObject(_VideoCount);
	((FLZfGroup*)object).Elements = FLCopyOrRetainObject(_Elements);
	((FLZfGroup*)object).MailboxId = FLCopyOrRetainObject(_MailboxId);
	((FLZfGroup*)object).GalleryCount = FLCopyOrRetainObject(_GalleryCount);
	((FLZfGroup*)object).ImmediateChildrenCount = FLCopyOrRetainObject(_ImmediateChildrenCount);
	((FLZfGroup*)object).ModifiedOn = FLCopyOrRetainObject(_ModifiedOn);
}
...
+ (FLZfGroup*) group
{
	return FLAutorelease([[FLZfGroup alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"Elements" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"Group" propertyClass:[FLZfGroup class] propertyType:FLDataTypeObject arrayTypes:nil], [FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[FLZfPhotoSet class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"Elements"];
...
@implementation FLZfGroup (ValueProperties) 
