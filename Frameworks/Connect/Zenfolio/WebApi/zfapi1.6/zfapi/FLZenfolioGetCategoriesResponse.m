...
//
//	FLZenfolioGetCategoriesResponse.m
...
@implementation FLZenfolioGetCategoriesResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetCategoriesResponse*)object).GetCategoriesResult = FLCopyOrRetainObject(_GetCategoriesResult);
}
...
{
	return FLAutorelease([[FLZenfolioGetCategoriesResponse alloc] init]);
}
...
@implementation FLZenfolioGetCategoriesResponse (ValueProperties) 
@end
