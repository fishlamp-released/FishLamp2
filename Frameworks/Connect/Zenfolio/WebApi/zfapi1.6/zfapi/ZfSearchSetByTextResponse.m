...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"SearchSetByTextResult" propertyClass:[ZFPhotoSetResult class] propertyType:FLDataTypeObject] forPropertyName:@"SearchSetByTextResult"];
	});
	return s_describer;
}
