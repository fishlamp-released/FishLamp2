...
- (void) copySelfTo:(id) object
{
	...
	((ZFKeyringGetUnlockedRealmsHttpPostIn*)object).keyring = FLCopyOrRetainObject(_keyring);
}
...
{
	return FLAutorelease([[ZFKeyringGetUnlockedRealmsHttpPostIn alloc] init]);
}
...
@implementation ZFKeyringGetUnlockedRealmsHttpPostIn (ValueProperties) 
@end
