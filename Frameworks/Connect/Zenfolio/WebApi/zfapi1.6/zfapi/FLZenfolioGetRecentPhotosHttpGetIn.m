...
//
//	FLZenfolioGetRecentPhotosHttpGetIn.m
...
@implementation FLZenfolioGetRecentPhotosHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetRecentPhotosHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetRecentPhotosHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZenfolioGetRecentPhotosHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioGetRecentPhotosHttpGetIn (ValueProperties) 
@end
