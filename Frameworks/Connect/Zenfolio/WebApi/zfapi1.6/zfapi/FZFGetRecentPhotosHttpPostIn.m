...
//
//	FLZenfolioGetRecentPhotosHttpPostIn.m
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetRecentPhotosHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetRecentPhotosHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZenfolioGetRecentPhotosHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioGetRecentPhotosHttpPostIn (ValueProperties) 
@end
