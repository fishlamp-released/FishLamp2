...
//
//	FLZfShareFavoritesSetHttpPostIn.m
...
@implementation FLZfShareFavoritesSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfShareFavoritesSetHttpPostIn*)object).sharerEmail = FLCopyOrRetainObject(_sharerEmail);
	((FLZfShareFavoritesSetHttpPostIn*)object).favoritesSetId = FLCopyOrRetainObject(_favoritesSetId);
	((FLZfShareFavoritesSetHttpPostIn*)object).favoritesSetName = FLCopyOrRetainObject(_favoritesSetName);
	((FLZfShareFavoritesSetHttpPostIn*)object).sharerName = FLCopyOrRetainObject(_sharerName);
	((FLZfShareFavoritesSetHttpPostIn*)object).sharerMessage = FLCopyOrRetainObject(_sharerMessage);
}
...
{
	return FLAutorelease([[FLZfShareFavoritesSetHttpPostIn alloc] init]);
}
...
@implementation FLZfShareFavoritesSetHttpPostIn (ValueProperties) 
@end
