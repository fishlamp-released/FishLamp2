...
@implementation FLZfAuthenticateHttpPostIn
...
{
	return FLAutorelease([[FLZfAuthenticateHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticateHttpPostIn*)object).challenge = FLCopyOrRetainObject(_challenge);
	((FLZfAuthenticateHttpPostIn*)object).proof = FLCopyOrRetainObject(_proof);
}
...
@implementation FLZfAuthenticateHttpPostIn (ValueProperties) 
@end
