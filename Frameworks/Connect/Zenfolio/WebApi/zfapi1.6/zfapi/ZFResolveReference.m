...
- (void) copySelfTo:(id) object
{
	...
	((ZFResolveReference*)object).loginName = FLCopyOrRetainObject(_loginName);
	((ZFResolveReference*)object).reference = FLCopyOrRetainObject(_reference);
}
...
{
	return FLAutorelease([[ZFResolveReference alloc] init]);
}
...
@implementation ZFResolveReference (ValueProperties) 
@end
