...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFLoadMessages class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFLoadMessagesResponse class]];
	});
	return s_describer;
}
