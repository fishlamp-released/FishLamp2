...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFGetChallenge class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFGetChallengeResponse class]];
	});
	return s_describer;
}
