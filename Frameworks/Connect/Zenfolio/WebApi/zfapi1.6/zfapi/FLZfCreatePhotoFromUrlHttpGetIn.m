...
//
//	FLZfCreatePhotoFromUrlHttpGetIn.m
...
@implementation FLZfCreatePhotoFromUrlHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreatePhotoFromUrlHttpGetIn*)object).url = FLCopyOrRetainObject(_url);
	((FLZfCreatePhotoFromUrlHttpGetIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZfCreatePhotoFromUrlHttpGetIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZfCreatePhotoFromUrlHttpGetIn alloc] init]);
}
...
@implementation FLZfCreatePhotoFromUrlHttpGetIn (ValueProperties) 
@end
