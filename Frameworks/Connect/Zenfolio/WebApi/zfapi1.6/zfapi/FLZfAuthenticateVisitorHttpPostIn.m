...
//
//	FLZfAuthenticateVisitorHttpPostIn.m
...
@implementation FLZfAuthenticateVisitorHttpPostIn
...
{
	return FLAutorelease([[FLZfAuthenticateVisitorHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticateVisitorHttpPostIn*)object).visitorKey = FLCopyOrRetainObject(_visitorKey);
}
...
@implementation FLZfAuthenticateVisitorHttpPostIn (ValueProperties) 
@end
