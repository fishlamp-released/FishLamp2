...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFUndeleteMessageHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFUndeleteMessageHttpGetOut class]];
	});
	return s_describer;
}
