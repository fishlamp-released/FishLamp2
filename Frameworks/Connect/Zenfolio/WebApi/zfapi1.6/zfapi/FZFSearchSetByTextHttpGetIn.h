...
//
//	FLZenfolioSearchSetByTextHttpGetIn.h
...
// --------------------------------------------------------------------
// FLZenfolioSearchSetByTextHttpGetIn
// --------------------------------------------------------------------
@interface FLZenfolioSearchSetByTextHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _searchId;
	NSString* _type;
	NSString* _sortOrder;
...
@interface FLZenfolioSearchSetByTextHttpGetIn (ValueProperties) 
@end
