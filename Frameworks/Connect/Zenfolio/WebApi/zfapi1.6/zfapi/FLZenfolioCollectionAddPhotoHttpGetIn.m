...
//
//	FLZenfolioCollectionAddPhotoHttpGetIn.m
...
@implementation FLZenfolioCollectionAddPhotoHttpGetIn
...
{
	return FLAutorelease([[FLZenfolioCollectionAddPhotoHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioCollectionAddPhotoHttpGetIn*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZenfolioCollectionAddPhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZenfolioCollectionAddPhotoHttpGetIn (ValueProperties) 
@end
