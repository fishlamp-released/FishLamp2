...
@implementation FLZfAuthenticate
...
{
	return FLAutorelease([[FLZfAuthenticate alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticate*)object).challenge = FLCopyOrRetainObject(_challenge);
	((FLZfAuthenticate*)object).proof = FLCopyOrRetainObject(_proof);
}
...
@implementation FLZfAuthenticate (ValueProperties) 
@end
