...
@implementation ZFUpdatePhotoAccess
...
- (void) copySelfTo:(id) object
{
	...
	((ZFUpdatePhotoAccess*)object).photoId = FLCopyOrRetainObject(_photoId);
	((ZFUpdatePhotoAccess*)object).updater = FLCopyOrRetainObject(_updater);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"updater" propertyClass:[ZFAccessUpdater class] propertyType:FLDataTypeObject] forPropertyName:@"updater"];
	});
	return s_describer;
}
...
{
	return FLAutorelease([[ZFUpdatePhotoAccess alloc] init]);
}

@end

@implementation ZFUpdatePhotoAccess (ValueProperties) 
