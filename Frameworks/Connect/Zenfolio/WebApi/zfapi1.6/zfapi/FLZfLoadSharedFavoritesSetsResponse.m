...
//
//	FLZfLoadSharedFavoritesSetsResponse.m
...
@implementation FLZfLoadSharedFavoritesSetsResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadSharedFavoritesSetsResponse*)object).LoadSharedFavoritesSetsResult = FLCopyOrRetainObject(_LoadSharedFavoritesSetsResult);
}
...
{
	return FLAutorelease([[FLZfLoadSharedFavoritesSetsResponse alloc] init]);
}
...
@implementation FLZfLoadSharedFavoritesSetsResponse (ValueProperties) 
@end
