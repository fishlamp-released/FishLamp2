...
@implementation FLZfLoadPhotoSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPhotoSetHttpGetIn*)object).level = FLCopyOrRetainObject(_level);
	((FLZfLoadPhotoSetHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfLoadPhotoSetHttpGetIn*)object).includePhotos = FLCopyOrRetainObject(_includePhotos);
}
...
{
	return FLAutorelease([[FLZfLoadPhotoSetHttpGetIn alloc] init]);
}
...
@implementation FLZfLoadPhotoSetHttpGetIn (ValueProperties) 
@end
