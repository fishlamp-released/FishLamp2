...
//
//	ZFGetVideoPlaybackUrlHttpGetIn.h
...
// --------------------------------------------------------------------
// ZFGetVideoPlaybackUrlHttpGetIn
// --------------------------------------------------------------------
@interface ZFGetVideoPlaybackUrlHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _photoId;
	NSString* _mode;
	NSString* _width;
...
@interface ZFGetVideoPlaybackUrlHttpGetIn (ValueProperties) 
@end
