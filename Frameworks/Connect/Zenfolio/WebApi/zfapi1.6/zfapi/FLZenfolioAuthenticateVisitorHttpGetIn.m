...
//
//	FLZenfolioAuthenticateVisitorHttpGetIn.m
...
@implementation FLZenfolioAuthenticateVisitorHttpGetIn
...
{
	return FLAutorelease([[FLZenfolioAuthenticateVisitorHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioAuthenticateVisitorHttpGetIn*)object).visitorKey = FLCopyOrRetainObject(_visitorKey);
}
...
@implementation FLZenfolioAuthenticateVisitorHttpGetIn (ValueProperties) 
@end
