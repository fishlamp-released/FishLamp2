...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFMovePhotoHttpPostIn class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFMovePhotoHttpPostOut class]];
	});
	return s_describer;
}
