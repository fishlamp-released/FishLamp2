...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFMovePhotoHttpPostIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFMovePhotoHttpPostOut class]];
	});
	return s_describer;
}
