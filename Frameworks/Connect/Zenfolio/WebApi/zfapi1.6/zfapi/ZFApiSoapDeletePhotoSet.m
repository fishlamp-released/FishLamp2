...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFDeletePhotoSet class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFDeletePhotoSetResponse class]];
	});
	return s_describer;
}
