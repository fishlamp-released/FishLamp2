...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFDeletePhotoSet class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFDeletePhotoSetResponse class]];
	});
	return s_describer;
}
