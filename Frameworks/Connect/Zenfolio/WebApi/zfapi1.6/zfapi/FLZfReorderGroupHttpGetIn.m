...
@implementation FLZfReorderGroupHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReorderGroupHttpGetIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfReorderGroupHttpGetIn*)object).shiftOrder = FLCopyOrRetainObject(_shiftOrder);
}
...
{
	return FLAutorelease([[FLZfReorderGroupHttpGetIn alloc] init]);
}
...
@implementation FLZfReorderGroupHttpGetIn (ValueProperties) 
@end
