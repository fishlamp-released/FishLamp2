...
@implementation FLZenfolioGetPopularSets
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetPopularSets*)object).type = FLCopyOrRetainObject(_type);
	((FLZenfolioGetPopularSets*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetPopularSets*)object).offset = FLCopyOrRetainObject(_offset);
}
...
+ (FLZenfolioGetPopularSets*) getPopularSets
{
	return FLAutorelease([[FLZenfolioGetPopularSets alloc] init]);
}
...
@implementation FLZenfolioGetPopularSets (ValueProperties) 
