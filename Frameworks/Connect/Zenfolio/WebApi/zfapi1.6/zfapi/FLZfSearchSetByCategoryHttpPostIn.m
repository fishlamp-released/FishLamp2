...
//
//	FLZfSearchSetByCategoryHttpPostIn.m
...
@implementation FLZfSearchSetByCategoryHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchSetByCategoryHttpPostIn*)object).categoryCode = FLCopyOrRetainObject(_categoryCode);
	((FLZfSearchSetByCategoryHttpPostIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchSetByCategoryHttpPostIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchSetByCategoryHttpPostIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZfSearchSetByCategoryHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZfSearchSetByCategoryHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
{
	return FLAutorelease([[FLZfSearchSetByCategoryHttpPostIn alloc] init]);
}
...
@implementation FLZfSearchSetByCategoryHttpPostIn (ValueProperties) 
@end
