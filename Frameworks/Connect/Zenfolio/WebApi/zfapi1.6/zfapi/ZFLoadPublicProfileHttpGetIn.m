...
//
//	ZFLoadPublicProfileHttpGetIn.m
...
@implementation ZFLoadPublicProfileHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((ZFLoadPublicProfileHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[ZFLoadPublicProfileHttpGetIn alloc] init]);
}
...
@implementation ZFLoadPublicProfileHttpGetIn (ValueProperties) 
@end
