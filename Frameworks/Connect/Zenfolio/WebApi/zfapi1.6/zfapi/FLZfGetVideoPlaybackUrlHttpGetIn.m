...
//
//	FLZfGetVideoPlaybackUrlHttpGetIn.m
...
@implementation FLZfGetVideoPlaybackUrlHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetVideoPlaybackUrlHttpGetIn*)object).height = FLCopyOrRetainObject(_height);
	((FLZfGetVideoPlaybackUrlHttpGetIn*)object).width = FLCopyOrRetainObject(_width);
	((FLZfGetVideoPlaybackUrlHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfGetVideoPlaybackUrlHttpGetIn*)object).mode = FLCopyOrRetainObject(_mode);
}
...
{
	return FLAutorelease([[FLZfGetVideoPlaybackUrlHttpGetIn alloc] init]);
}
...
@implementation FLZfGetVideoPlaybackUrlHttpGetIn (ValueProperties) 
@end
