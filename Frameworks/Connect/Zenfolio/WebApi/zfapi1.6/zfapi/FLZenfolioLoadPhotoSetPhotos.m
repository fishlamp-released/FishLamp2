...
//
//	FLZenfolioLoadPhotoSetPhotos.m
...
@implementation FLZenfolioLoadPhotoSetPhotos
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadPhotoSetPhotos*)object).startingIndex = FLCopyOrRetainObject(_startingIndex);
	((FLZenfolioLoadPhotoSetPhotos*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZenfolioLoadPhotoSetPhotos*)object).numberOfPhotos = FLCopyOrRetainObject(_numberOfPhotos);
}
...
{
	return FLAutorelease([[FLZenfolioLoadPhotoSetPhotos alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"startingIndex" propertyClass:[FLIntegerNumber class]] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"numberOfPhotos" propertyClass:[FLIntegerNumber class]] ];
	});
	return s_describer;
}
...
@implementation FLZenfolioLoadPhotoSetPhotos (ValueProperties) 
