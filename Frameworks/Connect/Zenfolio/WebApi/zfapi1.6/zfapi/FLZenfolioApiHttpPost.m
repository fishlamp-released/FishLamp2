...
@implementation FLZenfolioApiHttpPost


FLSynthesizeSingleton(FLZenfolioApiHttpPost);

+ (FLZenfolioApiHttpPost*) apiHttpPost
{
	return FLAutorelease([[FLZenfolioApiHttpPost alloc] init]);
}
...
@implementation FLZenfolioApiHttpPost (ValueProperties) 
@end
