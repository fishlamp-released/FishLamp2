...
+ (FLZfAddress*) address
{
	return FLAutorelease([[FLZfAddress alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAddress*)object).City = FLCopyOrRetainObject(_City);
	((FLZfAddress*)object).Url = FLCopyOrRetainObject(_Url);
	((FLZfAddress*)object).Email = FLCopyOrRetainObject(_Email);
	((FLZfAddress*)object).Street = FLCopyOrRetainObject(_Street);
	((FLZfAddress*)object).Fax = FLCopyOrRetainObject(_Fax);
	((FLZfAddress*)object).State = FLCopyOrRetainObject(_State);
	((FLZfAddress*)object).Other = FLCopyOrRetainObject(_Other);
	((FLZfAddress*)object).Street2 = FLCopyOrRetainObject(_Street2);
	((FLZfAddress*)object).Phone = FLCopyOrRetainObject(_Phone);
	((FLZfAddress*)object).FirstName = FLCopyOrRetainObject(_FirstName);
	((FLZfAddress*)object).Phone2 = FLCopyOrRetainObject(_Phone2);
	((FLZfAddress*)object).CompanyName = FLCopyOrRetainObject(_CompanyName);
	((FLZfAddress*)object).Zip = FLCopyOrRetainObject(_Zip);
	((FLZfAddress*)object).LastName = FLCopyOrRetainObject(_LastName);
	((FLZfAddress*)object).Country = FLCopyOrRetainObject(_Country);
}
...
@implementation FLZfAddress (ValueProperties) 
@end
