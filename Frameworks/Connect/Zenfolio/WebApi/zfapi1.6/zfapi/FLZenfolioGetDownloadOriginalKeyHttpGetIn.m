...
//
//	FLZenfolioGetDownloadOriginalKeyHttpGetIn.m
...
@implementation FLZenfolioGetDownloadOriginalKeyHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetDownloadOriginalKeyHttpGetIn*)object).photoIds = FLCopyOrRetainObject(_photoIds);
	((FLZenfolioGetDownloadOriginalKeyHttpGetIn*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[FLZenfolioGetDownloadOriginalKeyHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioGetDownloadOriginalKeyHttpGetIn (ValueProperties) 
@end
