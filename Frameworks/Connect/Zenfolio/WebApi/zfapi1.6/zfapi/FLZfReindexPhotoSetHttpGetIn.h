...
//
//	FLZfReindexPhotoSetHttpGetIn.h
...
// --------------------------------------------------------------------
// FLZfReindexPhotoSetHttpGetIn
// --------------------------------------------------------------------
@interface FLZfReindexPhotoSetHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
...
@interface FLZfReindexPhotoSetHttpGetIn (ValueProperties) 
@end
