...
//
//	FLZfCreateFavoritesSetHttpPostIn.m
...
@implementation FLZfCreateFavoritesSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreateFavoritesSetHttpPostIn*)object).name = FLCopyOrRetainObject(_name);
	((FLZfCreateFavoritesSetHttpPostIn*)object).photographerLogin = FLCopyOrRetainObject(_photographerLogin);
	((FLZfCreateFavoritesSetHttpPostIn*)object).photoIds = FLCopyOrRetainObject(_photoIds);
}
...
{
	return FLAutorelease([[FLZfCreateFavoritesSetHttpPostIn alloc] init]);
}
...
@implementation FLZfCreateFavoritesSetHttpPostIn (ValueProperties) 
@end
