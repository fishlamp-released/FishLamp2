...
@implementation FLZfCreatePhotoFromUrl
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreatePhotoFromUrl*)object).url = FLCopyOrRetainObject(_url);
	((FLZfCreatePhotoFromUrl*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZfCreatePhotoFromUrl*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZfCreatePhotoFromUrl alloc] init]);
}
...
@implementation FLZfCreatePhotoFromUrl (ValueProperties) 
