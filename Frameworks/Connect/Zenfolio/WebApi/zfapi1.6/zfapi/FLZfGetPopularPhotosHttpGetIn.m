...
//
//	FLZfGetPopularPhotosHttpGetIn.m
...
@implementation FLZfGetPopularPhotosHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetPopularPhotosHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetPopularPhotosHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetPopularPhotosHttpGetIn alloc] init]);
}
...
@implementation FLZfGetPopularPhotosHttpGetIn (ValueProperties) 
@end
