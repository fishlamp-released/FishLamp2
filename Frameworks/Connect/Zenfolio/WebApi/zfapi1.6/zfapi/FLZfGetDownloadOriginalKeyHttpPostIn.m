...
//
//	FLZfGetDownloadOriginalKeyHttpPostIn.m
...
@implementation FLZfGetDownloadOriginalKeyHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetDownloadOriginalKeyHttpPostIn*)object).photoIds = FLCopyOrRetainObject(_photoIds);
	((FLZfGetDownloadOriginalKeyHttpPostIn*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[FLZfGetDownloadOriginalKeyHttpPostIn alloc] init]);
}
...
@implementation FLZfGetDownloadOriginalKeyHttpPostIn (ValueProperties) 
@end
