...
- (void) copySelfTo:(id) object
{
	...
	((ZFSetGroupTitlePhotoHttpGetIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((ZFSetGroupTitlePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
{
	return FLAutorelease([[ZFSetGroupTitlePhotoHttpGetIn alloc] init]);
}
...
@implementation ZFSetGroupTitlePhotoHttpGetIn (ValueProperties) 
@end
