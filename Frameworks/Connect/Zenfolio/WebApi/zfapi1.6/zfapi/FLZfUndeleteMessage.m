...
@implementation FLZfUndeleteMessage
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUndeleteMessage*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZfUndeleteMessage*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZfUndeleteMessage alloc] init]);
}

@end

@implementation FLZfUndeleteMessage (ValueProperties) 
