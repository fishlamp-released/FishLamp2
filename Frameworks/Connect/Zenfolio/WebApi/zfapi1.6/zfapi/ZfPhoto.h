...
#import "ZFApi1_6Enums.h"
@class ZFExifTag;
@class ZFParsedCategory;

// --------------------------------------------------------------------
// ZFPhoto
// --------------------------------------------------------------------
@interface ZFPhoto : NSObject<NSCoding, NSCopying>{ 
@private
	NSNumber* _Id;
	NSNumber* _Width;
	NSNumber* _Height;
...
// Type: ZFExifTag*, forKey: ExifTags
...
// Type: ZFParsedCategory*, forKey: parsedCategory
...
@interface ZFPhoto (ValueProperties) 
...
@property (readwrite, assign, nonatomic) ZFPhotoFlags FlagsValue;
