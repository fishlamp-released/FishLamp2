...
//
//	FLZenfolioKeyringAddKeyPlainHttpPostIn.m
...
@implementation FLZenfolioKeyringAddKeyPlainHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioKeyringAddKeyPlainHttpPostIn*)object).keyring = FLCopyOrRetainObject(_keyring);
	((FLZenfolioKeyringAddKeyPlainHttpPostIn*)object).realmId = FLCopyOrRetainObject(_realmId);
	((FLZenfolioKeyringAddKeyPlainHttpPostIn*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[FLZenfolioKeyringAddKeyPlainHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioKeyringAddKeyPlainHttpPostIn (ValueProperties) 
@end
