...
//
//	FLZenfolioCollectionRemovePhotoHttpGetIn.m
...
@implementation FLZenfolioCollectionRemovePhotoHttpGetIn
...
{
	return FLAutorelease([[FLZenfolioCollectionRemovePhotoHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioCollectionRemovePhotoHttpGetIn*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZenfolioCollectionRemovePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZenfolioCollectionRemovePhotoHttpGetIn (ValueProperties) 
@end
