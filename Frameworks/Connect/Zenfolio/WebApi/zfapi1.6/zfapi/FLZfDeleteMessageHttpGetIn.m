...
@implementation FLZfDeleteMessageHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeleteMessageHttpGetIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZfDeleteMessageHttpGetIn*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZfDeleteMessageHttpGetIn alloc] init]);
}
...
@implementation FLZfDeleteMessageHttpGetIn (ValueProperties) 
@end
