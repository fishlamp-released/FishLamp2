...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"BioPhoto" propertyClass:[ZFFile class] propertyType:FLDataTypeObject] forPropertyName:@"BioPhoto"];
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"PublicAddress" propertyClass:[ZFAddress class] propertyType:FLDataTypeObject] forPropertyName:@"PublicAddress"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"PersonalAddress" propertyClass:[ZFAddress class] propertyType:FLDataTypeObject] forPropertyName:@"PersonalAddress"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"RecentPhotoSets" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[ZFPhotoSet class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"RecentPhotoSets"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"FeaturedPhotoSets" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[ZFPhotoSet class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"FeaturedPhotoSets"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"RootGroup" propertyClass:[ZFGroup class] propertyType:FLDataTypeObject] forPropertyName:@"RootGroup"];
