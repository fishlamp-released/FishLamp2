...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFUpdateGroupAccess class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFUpdateGroupAccessResponse class]];
	});
	return s_describer;
}
