...
@implementation FLZfAuthenticateResponse
...
{
	return FLAutorelease([[FLZfAuthenticateResponse alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticateResponse*)object).AuthenticateResult = FLCopyOrRetainObject(_AuthenticateResult);
}
...
@implementation FLZfAuthenticateResponse (ValueProperties) 
@end
