...
- (ZFGetPopularPhotosHttpPostIn*) input
{
	if(!_input)
	{
		_input = [[ZFGetPopularPhotosHttpPostIn alloc] init];
	}
	return _input;
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFGetPopularPhotosHttpPostIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
...
@implementation ZFApiHttpPostGetPopularPhotos (ValueProperties) 
@end


@implementation ZFApiHttpPostGetPopularPhotos (ObjectMembers) 

// This returns _input. It does NOT create it if it's NIL.
- (ZFGetPopularPhotosHttpPostIn*) inputObject
{
	return _input;
}
