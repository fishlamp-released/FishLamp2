...
@implementation FLZfLoadAccessRealmResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadAccessRealmResponse*)object).LoadAccessRealmResult = FLCopyOrRetainObject(_LoadAccessRealmResult);
}
...
{
	return FLAutorelease([[FLZfLoadAccessRealmResponse alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"LoadAccessRealmResult" propertyClass:[FLZfAccessDescriptor class] propertyType:FLDataTypeObject] forPropertyName:@"LoadAccessRealmResult"];
	});
	return s_describer;
}
...
@implementation FLZfLoadAccessRealmResponse (ValueProperties) 
@end
