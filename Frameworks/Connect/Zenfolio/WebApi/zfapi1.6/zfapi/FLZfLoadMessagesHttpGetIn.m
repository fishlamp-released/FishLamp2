...
@implementation FLZfLoadMessagesHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadMessagesHttpGetIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZfLoadMessagesHttpGetIn*)object).includeDeleted = FLCopyOrRetainObject(_includeDeleted);
	((FLZfLoadMessagesHttpGetIn*)object).postedSince = FLCopyOrRetainObject(_postedSince);
}
...
{
	return FLAutorelease([[FLZfLoadMessagesHttpGetIn alloc] init]);
}
...
@implementation FLZfLoadMessagesHttpGetIn (ValueProperties) 
@end
