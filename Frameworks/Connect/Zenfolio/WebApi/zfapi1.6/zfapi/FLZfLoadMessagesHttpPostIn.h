...
// --------------------------------------------------------------------
// FLZfLoadMessagesHttpPostIn
// --------------------------------------------------------------------
@interface FLZfLoadMessagesHttpPostIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _mailboxId;
...
@interface FLZfLoadMessagesHttpPostIn (ValueProperties) 
@end
