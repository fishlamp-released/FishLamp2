...
- (void) copySelfTo:(id) object
{
	...
	((FLZfMessage*)object).IsPrivate = FLCopyOrRetainObject(_IsPrivate);
	((FLZfMessage*)object).Index = FLCopyOrRetainObject(_Index);
	((FLZfMessage*)object).PosterName = FLCopyOrRetainObject(_PosterName);
	((FLZfMessage*)object).PosterUrl = FLCopyOrRetainObject(_PosterUrl);
	((FLZfMessage*)object).PostedOn = FLCopyOrRetainObject(_PostedOn);
	((FLZfMessage*)object).PosterLoginNane = FLCopyOrRetainObject(_PosterLoginNane);
	((FLZfMessage*)object).Body = FLCopyOrRetainObject(_Body);
	((FLZfMessage*)object).PosterEmail = FLCopyOrRetainObject(_PosterEmail);
	((FLZfMessage*)object).MailboxId = FLCopyOrRetainObject(_MailboxId);
}
...
+ (FLZfMessage*) message
{
	return FLAutorelease([[FLZfMessage alloc] init]);
}
...
@implementation FLZfMessage (ValueProperties) 
