...
- (void) copySelfTo:(id) object
{
	...
	((ZFSearchPhotoByTextHttpGetIn*)object).query = FLCopyOrRetainObject(_query);
	((ZFSearchPhotoByTextHttpGetIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((ZFSearchPhotoByTextHttpGetIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((ZFSearchPhotoByTextHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
	((ZFSearchPhotoByTextHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
{
	return FLAutorelease([[ZFSearchPhotoByTextHttpGetIn alloc] init]);
}
...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"query" withClass:[NSString class]];
...
@implementation ZFSearchPhotoByTextHttpGetIn (ValueProperties) 
@end
