...
@implementation FLZfReorderGroup
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReorderGroup*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfReorderGroup*)object).shiftOrder = FLCopyOrRetainObject(_shiftOrder);
}
...
{
	return FLAutorelease([[FLZfReorderGroup alloc] init]);
}
...
@implementation FLZfReorderGroup (ValueProperties) 
...
- (FLZfGroupShiftOrder) shiftOrderValue
{
	return [[FLZfApi1_6EnumLookup instance] groupShiftOrderFromString:self.shiftOrder];
}

- (void) setShiftOrderValue:(FLZfGroupShiftOrder) inEnumValue
{
	self.shiftOrder = [[FLZfApi1_6EnumLookup instance] stringFromGroupShiftOrder:inEnumValue];
}
@end
