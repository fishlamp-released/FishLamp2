...
//
//	FLZenfolioLoadGroupHierarchyHttpGetIn.m
...
@implementation FLZenfolioLoadGroupHierarchyHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadGroupHierarchyHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZenfolioLoadGroupHierarchyHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioLoadGroupHierarchyHttpGetIn (ValueProperties) 
@end
