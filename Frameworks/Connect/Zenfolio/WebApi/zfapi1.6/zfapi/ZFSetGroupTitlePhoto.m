...
@implementation ZFSetGroupTitlePhoto
...
- (void) copySelfTo:(id) object
{
	...
	((ZFSetGroupTitlePhoto*)object).groupId = FLCopyOrRetainObject(_groupId);
	((ZFSetGroupTitlePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
{
	return FLAutorelease([[ZFSetGroupTitlePhoto alloc] init]);
}
...
@implementation ZFSetGroupTitlePhoto (ValueProperties) 
