...
@implementation FLZfAuthenticatePlain
...
+ (FLZfAuthenticatePlain*) authenticatePlain
{
	return FLAutorelease([[FLZfAuthenticatePlain alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticatePlain*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfAuthenticatePlain*)object).password = FLCopyOrRetainObject(_password);
}
...
@implementation FLZfAuthenticatePlain (ValueProperties) 
@end
