...
//
//	FLZfUndeleteMessageHttpGetIn.m
...
@implementation FLZfUndeleteMessageHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUndeleteMessageHttpGetIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZfUndeleteMessageHttpGetIn*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZfUndeleteMessageHttpGetIn alloc] init]);
}

@end

@implementation FLZfUndeleteMessageHttpGetIn (ValueProperties) 
@end
