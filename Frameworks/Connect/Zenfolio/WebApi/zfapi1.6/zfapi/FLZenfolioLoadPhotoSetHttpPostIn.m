...
//
//	FLZenfolioLoadPhotoSetHttpPostIn.m
...
@implementation FLZenfolioLoadPhotoSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadPhotoSetHttpPostIn*)object).level = FLCopyOrRetainObject(_level);
	((FLZenfolioLoadPhotoSetHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZenfolioLoadPhotoSetHttpPostIn*)object).includePhotos = FLCopyOrRetainObject(_includePhotos);
}
...
{
	return FLAutorelease([[FLZenfolioLoadPhotoSetHttpPostIn alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"photoSetId" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"level" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"includePhotos" propertyClass:[NSString class] ] ];
	});
	return s_describer;
}
...
@implementation FLZenfolioLoadPhotoSetHttpPostIn (ValueProperties) 
@end
