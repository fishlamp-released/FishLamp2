...
//
//	FLZfLoadPublicProfileHttpGetIn.m
...
@implementation FLZfLoadPublicProfileHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPublicProfileHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZfLoadPublicProfileHttpGetIn alloc] init]);
}
...
@implementation FLZfLoadPublicProfileHttpGetIn (ValueProperties) 
@end
