...
//
//	FLZenfolioCreateGroupResponse.m
...
@implementation FLZenfolioCreateGroupResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioCreateGroupResponse*)object).CreateGroupResult = FLCopyOrRetainObject(_CreateGroupResult);
}
...
{
	return FLAutorelease([[FLZenfolioCreateGroupResponse alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"CreateGroupResult" withClass:[FLZenfolioGroup class]];
	});
	return s_describer;
}
...
@implementation FLZenfolioCreateGroupResponse (ValueProperties) 
@end
