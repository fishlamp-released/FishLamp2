...
@implementation FLZfLoadPhotoSet
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPhotoSet*)object).level = FLCopyOrRetainObject(_level);
	((FLZfLoadPhotoSet*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfLoadPhotoSet*)object).includePhotos = FLCopyOrRetainObject(_includePhotos);
}
...
{
	return FLAutorelease([[FLZfLoadPhotoSet alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"includePhotos" propertyClass:[NSNumber class] propertyType:FLDataTypeBool] forPropertyName:@"includePhotos"];
	});
	return s_describer;
}
...
@implementation FLZfLoadPhotoSet (ValueProperties) 
