...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFSetPhotoSetTitlePhotoHttpPostIn class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFSetPhotoSetTitlePhotoHttpPostOut class]];
	});
	return s_describer;
}
