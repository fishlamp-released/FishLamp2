...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFSetPhotoSetTitlePhotoHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[ZFSetPhotoSetTitlePhotoHttpPostOut class]];
	});
	return s_describer;
}
