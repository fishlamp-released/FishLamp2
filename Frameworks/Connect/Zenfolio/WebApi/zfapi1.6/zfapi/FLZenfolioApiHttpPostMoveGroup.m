...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioMoveGroupHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioMoveGroupHttpPostOut class]];
	});
	return s_describer;
}
