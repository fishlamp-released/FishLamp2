...
//
//	FLZenfolioShareFavoritesSetHttpGetIn.h
...
// --------------------------------------------------------------------
// FLZenfolioShareFavoritesSetHttpGetIn
// --------------------------------------------------------------------
@interface FLZenfolioShareFavoritesSetHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
...
@interface FLZenfolioShareFavoritesSetHttpGetIn (ValueProperties) 
@end
