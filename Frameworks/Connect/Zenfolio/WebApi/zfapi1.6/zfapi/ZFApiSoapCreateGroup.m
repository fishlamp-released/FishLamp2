...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFCreateGroup class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFCreateGroupResponse class]];
	});
	return s_describer;
}
