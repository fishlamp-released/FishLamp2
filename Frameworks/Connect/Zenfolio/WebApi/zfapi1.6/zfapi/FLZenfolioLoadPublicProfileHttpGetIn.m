...
//
//	FLZenfolioLoadPublicProfileHttpGetIn.m
...
@implementation FLZenfolioLoadPublicProfileHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadPublicProfileHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZenfolioLoadPublicProfileHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioLoadPublicProfileHttpGetIn (ValueProperties) 
@end
