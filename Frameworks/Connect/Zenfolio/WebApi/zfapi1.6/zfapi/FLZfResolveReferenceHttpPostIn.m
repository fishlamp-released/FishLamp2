...
//
//	FLZfResolveReferenceHttpPostIn.m
...
@implementation FLZfResolveReferenceHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfResolveReferenceHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfResolveReferenceHttpPostIn*)object).reference = FLCopyOrRetainObject(_reference);
}
...
+ (FLZfResolveReferenceHttpPostIn*) resolveReferenceHttpPostIn
{
	return FLAutorelease([[FLZfResolveReferenceHttpPostIn alloc] init]);
}
...
@implementation FLZfResolveReferenceHttpPostIn (ValueProperties) 
@end
