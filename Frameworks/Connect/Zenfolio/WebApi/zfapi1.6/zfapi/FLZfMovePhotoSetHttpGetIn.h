...
// --------------------------------------------------------------------
// FLZfMovePhotoSetHttpGetIn
// --------------------------------------------------------------------
@interface FLZfMovePhotoSetHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
...
@interface FLZfMovePhotoSetHttpGetIn (ValueProperties) 
@end
