...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFSearchSetByCategoryHttpPostIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFPhotoSetResult class]];
	});
	return s_describer;
}
