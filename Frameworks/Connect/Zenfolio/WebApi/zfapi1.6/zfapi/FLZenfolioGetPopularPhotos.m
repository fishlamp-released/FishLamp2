...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetPopularPhotos*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZenfolioGetPopularPhotos*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZenfolioGetPopularPhotos alloc] init]);
}
...
@implementation FLZenfolioGetPopularPhotos (ValueProperties) 
