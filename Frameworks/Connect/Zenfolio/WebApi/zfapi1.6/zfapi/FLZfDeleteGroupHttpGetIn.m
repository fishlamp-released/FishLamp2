...
@implementation FLZfDeleteGroupHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeleteGroupHttpGetIn*)object).groupId = FLCopyOrRetainObject(_groupId);
}
...
{
	return FLAutorelease([[FLZfDeleteGroupHttpGetIn alloc] init]);
}
...
@implementation FLZfDeleteGroupHttpGetIn (ValueProperties) 
@end
