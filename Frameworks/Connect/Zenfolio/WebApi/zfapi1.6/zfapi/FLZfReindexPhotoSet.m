...
@implementation FLZfReindexPhotoSet
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReindexPhotoSet*)object).startIndex = FLCopyOrRetainObject(_startIndex);
	((FLZfReindexPhotoSet*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfReindexPhotoSet*)object).mapping = FLCopyOrRetainObject(_mapping);
}
...
{
	return FLAutorelease([[FLZfReindexPhotoSet alloc] init]);
}
...
@implementation FLZfReindexPhotoSet (ValueProperties) 
