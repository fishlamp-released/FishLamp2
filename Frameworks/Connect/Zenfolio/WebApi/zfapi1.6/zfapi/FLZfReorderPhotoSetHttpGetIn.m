...
//
//	FLZfReorderPhotoSetHttpGetIn.m
...
@implementation FLZfReorderPhotoSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReorderPhotoSetHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfReorderPhotoSetHttpGetIn*)object).shiftOrder = FLCopyOrRetainObject(_shiftOrder);
}
...
{
	return FLAutorelease([[FLZfReorderPhotoSetHttpGetIn alloc] init]);
}
...
@implementation FLZfReorderPhotoSetHttpGetIn (ValueProperties) 
@end
