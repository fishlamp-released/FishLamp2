...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"FeaturedIndex" propertyClass:[FLIntegerNumber class]] ];
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"IsRandomTitlePhoto" propertyClass:[FLBoolNumber class]] ];
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"VideoUploadUrl" propertyClass:[NSString class] ] ];
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"PhotoListCn" propertyClass:[FLIntegerNumber class]] ];
	});
	return s_describer;
}
