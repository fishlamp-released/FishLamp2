...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFDeleteGroupHttpPostIn class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFDeleteGroupHttpPostOut class]];
	});
