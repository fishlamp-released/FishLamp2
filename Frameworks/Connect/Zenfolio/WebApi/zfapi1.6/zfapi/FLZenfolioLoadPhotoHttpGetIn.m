...
//
//	FLZenfolioLoadPhotoHttpGetIn.m
...
@implementation FLZenfolioLoadPhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadPhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZenfolioLoadPhotoHttpGetIn*)object).level = FLCopyOrRetainObject(_level);
}
...
{
	return FLAutorelease([[FLZenfolioLoadPhotoHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioLoadPhotoHttpGetIn (ValueProperties) 
@end
