...
@implementation FLZfDeleteMessage
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeleteMessage*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZfDeleteMessage*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZfDeleteMessage alloc] init]);
}
...
@implementation FLZfDeleteMessage (ValueProperties) 
