...
- (void) copySelfTo:(id) object
{
	...
	((FLZfFile*)object).Height = FLCopyOrRetainObject(_Height);
	((FLZfFile*)object).UrlCore = FLCopyOrRetainObject(_UrlCore);
	((FLZfFile*)object).Id = FLCopyOrRetainObject(_Id);
	((FLZfFile*)object).MimeType = FLCopyOrRetainObject(_MimeType);
	((FLZfFile*)object).UrlHost = FLCopyOrRetainObject(_UrlHost);
	((FLZfFile*)object).Sequence = FLCopyOrRetainObject(_Sequence);
	((FLZfFile*)object).Width = FLCopyOrRetainObject(_Width);
}
...
+ (FLZfFile*) file
{
	return FLAutorelease([[FLZfFile alloc] init]);
}
...
@implementation FLZfFile (ValueProperties) 
