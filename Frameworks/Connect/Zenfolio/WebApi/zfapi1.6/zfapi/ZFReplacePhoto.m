...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"originalId" withClass:[FLIntegerNumber class] ];
		[s_describer setChildForIdentifier:@"replacedId" withClass:[FLIntegerNumber class] ];
	});
	return s_describer;
}
