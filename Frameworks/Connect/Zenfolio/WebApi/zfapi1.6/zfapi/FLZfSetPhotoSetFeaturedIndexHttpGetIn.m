...
//
//	FLZfSetPhotoSetFeaturedIndexHttpGetIn.m
...
@implementation FLZfSetPhotoSetFeaturedIndexHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetPhotoSetFeaturedIndexHttpGetIn*)object).index = FLCopyOrRetainObject(_index);
	((FLZfSetPhotoSetFeaturedIndexHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
+ (FLZfSetPhotoSetFeaturedIndexHttpGetIn*) setPhotoSetFeaturedIndexHttpGetIn
{
	return FLAutorelease([[FLZfSetPhotoSetFeaturedIndexHttpGetIn alloc] init]);
}
...
@implementation FLZfSetPhotoSetFeaturedIndexHttpGetIn (ValueProperties) 
@end
