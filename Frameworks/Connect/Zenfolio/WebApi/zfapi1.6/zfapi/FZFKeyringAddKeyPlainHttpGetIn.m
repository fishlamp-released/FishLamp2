...
//
//	FLZenfolioKeyringAddKeyPlainHttpGetIn.m
...
@implementation FLZenfolioKeyringAddKeyPlainHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioKeyringAddKeyPlainHttpGetIn*)object).keyring = FLCopyOrRetainObject(_keyring);
	((FLZenfolioKeyringAddKeyPlainHttpGetIn*)object).realmId = FLCopyOrRetainObject(_realmId);
	((FLZenfolioKeyringAddKeyPlainHttpGetIn*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[FLZenfolioKeyringAddKeyPlainHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioKeyringAddKeyPlainHttpGetIn (ValueProperties) 
@end
