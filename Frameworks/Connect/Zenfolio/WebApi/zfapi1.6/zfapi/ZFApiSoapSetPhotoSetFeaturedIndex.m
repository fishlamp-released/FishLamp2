...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFSetPhotoSetFeaturedIndex class]];
		[s_describer addProperty:@"output" withClass:[ZFSetPhotoSetFeaturedIndexResponse class]];
	});
	return s_describer;
}
