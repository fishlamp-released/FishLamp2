...
//
//	FLZenfolioCheckPrivilegeHttpPostIn.m
...
@implementation FLZenfolioCheckPrivilegeHttpPostIn
...
{
	return FLAutorelease([[FLZenfolioCheckPrivilegeHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioCheckPrivilegeHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZenfolioCheckPrivilegeHttpPostIn*)object).privilegeName = FLCopyOrRetainObject(_privilegeName);
}
...
@implementation FLZenfolioCheckPrivilegeHttpPostIn (ValueProperties) 
@end
