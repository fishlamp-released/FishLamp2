...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFDeletePhotoSetHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFDeletePhotoSetHttpGetOut class]];
	});
	return s_describer;
}
