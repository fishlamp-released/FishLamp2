...
//
//	FLZfLoadGroupHierarchyHttpPostIn.m
...
@implementation FLZfLoadGroupHierarchyHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadGroupHierarchyHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZfLoadGroupHierarchyHttpPostIn alloc] init]);
}
...
@implementation FLZfLoadGroupHierarchyHttpPostIn (ValueProperties) 
@end
