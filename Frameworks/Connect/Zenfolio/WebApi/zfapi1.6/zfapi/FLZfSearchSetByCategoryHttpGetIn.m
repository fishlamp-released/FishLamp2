...
//
//	FLZfSearchSetByCategoryHttpGetIn.m
...
@implementation FLZfSearchSetByCategoryHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchSetByCategoryHttpGetIn*)object).categoryCode = FLCopyOrRetainObject(_categoryCode);
	((FLZfSearchSetByCategoryHttpGetIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchSetByCategoryHttpGetIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchSetByCategoryHttpGetIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZfSearchSetByCategoryHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZfSearchSetByCategoryHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
+ (FLZfSearchSetByCategoryHttpGetIn*) searchSetByCategoryHttpGetIn
{
	return FLAutorelease([[FLZfSearchSetByCategoryHttpGetIn alloc] init]);
}
...
@implementation FLZfSearchSetByCategoryHttpGetIn (ValueProperties) 
@end
