...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFMovePhotoHttpGetIn class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFMovePhotoHttpGetOut class]];
	});
	return s_describer;
}
