...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFMovePhotoHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFMovePhotoHttpGetOut class]];
	});
	return s_describer;
}
