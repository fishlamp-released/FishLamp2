...
@implementation FLZfGetChallengeHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetChallengeHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZfGetChallengeHttpGetIn alloc] init]);
}
...
@implementation FLZfGetChallengeHttpGetIn (ValueProperties) 
@end
