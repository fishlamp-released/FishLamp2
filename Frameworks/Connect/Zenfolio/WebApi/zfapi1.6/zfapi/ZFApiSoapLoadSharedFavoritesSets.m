...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFLoadSharedFavoritesSets class]];
		[s_describer addProperty:@"output" withClass:[ZFLoadSharedFavoritesSetsResponse class]];
	});
	return s_describer;
}
