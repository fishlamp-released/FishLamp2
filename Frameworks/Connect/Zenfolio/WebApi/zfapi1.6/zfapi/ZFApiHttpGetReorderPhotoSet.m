...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFReorderPhotoSetHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFReorderPhotoSetHttpGetOut class]];
	});
	return s_describer;
}
