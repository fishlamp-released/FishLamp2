...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFReorderPhotoSetHttpGetIn class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFReorderPhotoSetHttpGetOut class]];
	});
