...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFLoadGroup class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFLoadGroupResponse class]];
	});
	return s_describer;
}
