...
@implementation FLZfCheckPrivilegeHttpGetIn
...
{
	return FLAutorelease([[FLZfCheckPrivilegeHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCheckPrivilegeHttpGetIn*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfCheckPrivilegeHttpGetIn*)object).privilegeName = FLCopyOrRetainObject(_privilegeName);
}
...
@implementation FLZfCheckPrivilegeHttpGetIn (ValueProperties) 
@end
