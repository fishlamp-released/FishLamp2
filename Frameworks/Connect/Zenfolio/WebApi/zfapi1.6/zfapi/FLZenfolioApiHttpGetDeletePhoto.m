...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioDeletePhotoHttpGetIn class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioDeletePhotoHttpGetOut class]];
	});
	return s_describer;
}
