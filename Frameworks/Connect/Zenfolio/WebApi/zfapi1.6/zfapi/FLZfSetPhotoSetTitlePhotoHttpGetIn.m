...
//
//	FLZfSetPhotoSetTitlePhotoHttpGetIn.m
...
@implementation FLZfSetPhotoSetTitlePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetPhotoSetTitlePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfSetPhotoSetTitlePhotoHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfSetPhotoSetTitlePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZfSetPhotoSetTitlePhotoHttpGetIn (ValueProperties) 
@end
