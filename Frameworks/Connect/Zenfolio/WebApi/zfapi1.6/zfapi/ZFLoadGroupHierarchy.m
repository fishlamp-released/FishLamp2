...
@implementation ZFLoadGroupHierarchy
...
- (void) copySelfTo:(id) object
{
	...
	((ZFLoadGroupHierarchy*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[ZFLoadGroupHierarchy alloc] init]);
}
...
@implementation ZFLoadGroupHierarchy (ValueProperties) 
@end
