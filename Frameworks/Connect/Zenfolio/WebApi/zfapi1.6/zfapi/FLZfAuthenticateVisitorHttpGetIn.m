...
//
//	FLZfAuthenticateVisitorHttpGetIn.m
...
@implementation FLZfAuthenticateVisitorHttpGetIn
...
{
	return FLAutorelease([[FLZfAuthenticateVisitorHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticateVisitorHttpGetIn*)object).visitorKey = FLCopyOrRetainObject(_visitorKey);
}
...
@implementation FLZfAuthenticateVisitorHttpGetIn (ValueProperties) 
@end
