...
- (void) copySelfTo:(id) object
{
	...
	((ZFLoadPhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((ZFLoadPhotoHttpGetIn*)object).level = FLCopyOrRetainObject(_level);
}
...
{
	return FLAutorelease([[ZFLoadPhotoHttpGetIn alloc] init]);
}
...
@implementation ZFLoadPhotoHttpGetIn (ValueProperties) 
@end
