...
@implementation ZFDeleteGroupHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((ZFDeleteGroupHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
}
...
{
	return FLAutorelease([[ZFDeleteGroupHttpPostIn alloc] init]);
}
...
@implementation ZFDeleteGroupHttpPostIn (ValueProperties) 
@end
