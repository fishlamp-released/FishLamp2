...
//
//	FLZfCreateVideoFromUrlHttpPostIn.h
...
// --------------------------------------------------------------------
// FLZfCreateVideoFromUrlHttpPostIn
// --------------------------------------------------------------------
@interface FLZfCreateVideoFromUrlHttpPostIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _galleryId;
	NSString* _url;
	NSString* _cookies;
...
@interface FLZfCreateVideoFromUrlHttpPostIn (ValueProperties) 
@end
