...
//
//	FLZfGetPopularPhotosHttpPostIn.m
...
@implementation FLZfGetPopularPhotosHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetPopularPhotosHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetPopularPhotosHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetPopularPhotosHttpPostIn alloc] init]);
}
...
@implementation FLZfGetPopularPhotosHttpPostIn (ValueProperties) 
@end
