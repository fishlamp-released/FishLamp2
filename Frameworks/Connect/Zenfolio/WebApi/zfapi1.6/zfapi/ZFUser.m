...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"DisplayName" withClass:[NSString class]];
		...
		[s_describer addChildDescriberWithName:@"PrimaryEmail" withClass:[NSString class]];
		[s_describer addChildDescriberWithName:@"BioPhoto" withClass:[ZFFile class]];
		[s_describer addChildDescriberWithName:@"Bio" withClass:[NSString class]];
		...
		[s_describer addChildDescriberWithName:@"PhotoBytes" withClass:[FLLongNumber class] ];
		[s_describer addChildDescriberWithName:@"UserSince" withClass:[NSDate class]];
		[s_describer addChildDescriberWithName:@"LastUpdated" withClass:[NSDate class]];
		[s_describer addChildDescriberWithName:@"PublicAddress" withClass:[ZFAddress class]];
		[s_describer addChildDescriberWithName:@"PersonalAddress" withClass:[ZFAddress class]];
		[s_describer addChildDescriberWithName:@"RecentPhotoSets" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"PhotoSet" objectClass:[ZFPhotoSet class]], nil]];
		[s_describer addChildDescriberWithName:@"FeaturedPhotoSets" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"PhotoSet" objectClass:[ZFPhotoSet class]], nil]];
		[s_describer addChildDescriberWithName:@"RootGroup" withClass:[ZFGroup class]];
		[s_describer addChildDescriberWithName:@"ReferralCode" withClass:[NSString class]];
		[s_describer addChildDescriberWithName:@"ExpiresOn" withClass:[NSDate class]];
		[s_describer addChildDescriberWithName:@"Balance" withClass:[FLDoubleNumber class] ];
		[s_describer addChildDescriberWithName:@"DomainName" withClass:[NSString class]];
		[s_describer addChildDescriberWithName:@"StorageQuota" withClass:[FLLongNumber class] ];
		[s_describer addChildDescriberWithName:@"PhotoBytesQuota" withClass:[FLLongNumber class] ];
		[s_describer addChildDescriberWithName:@"VideoBytesQuota" withClass:[FLLongNumber class] ];
		[s_describer addChildDescriberWithName:@"VideoDurationQuota" withClass:[FLIntegerNumber class] ];
		[s_describer addChildDescriberWithName:@"HierarchyCn" withClass:[FLIntegerNumber class] ];
	});
	return s_describer;
}
