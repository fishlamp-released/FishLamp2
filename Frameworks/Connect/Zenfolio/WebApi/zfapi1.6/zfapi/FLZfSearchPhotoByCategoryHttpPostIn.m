...
//
//	FLZfSearchPhotoByCategoryHttpPostIn.m
...
@implementation FLZfSearchPhotoByCategoryHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchPhotoByCategoryHttpPostIn*)object).categoryCode = FLCopyOrRetainObject(_categoryCode);
	((FLZfSearchPhotoByCategoryHttpPostIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchPhotoByCategoryHttpPostIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchPhotoByCategoryHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZfSearchPhotoByCategoryHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
{
	return FLAutorelease([[FLZfSearchPhotoByCategoryHttpPostIn alloc] init]);
}
...
@implementation FLZfSearchPhotoByCategoryHttpPostIn (ValueProperties) 
@end
