...
//
//	FLZfKeyringGetUnlockedRealmsResponse.m
...
@implementation FLZfKeyringGetUnlockedRealmsResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfKeyringGetUnlockedRealmsResponse*)object).KeyringGetUnlockedRealmsResult = FLCopyOrRetainObject(_KeyringGetUnlockedRealmsResult);
}
...
{
	return FLAutorelease([[FLZfKeyringGetUnlockedRealmsResponse alloc] init]);
}
...
@implementation FLZfKeyringGetUnlockedRealmsResponse (ValueProperties) 
@end
