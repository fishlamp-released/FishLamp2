...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"startingIndex" withClass:[FLIntegerNumber class] ];
		[s_describer setChildForIdentifier:@"numberOfPhotos" withClass:[FLIntegerNumber class] ];
	});
	return s_describer;
}
