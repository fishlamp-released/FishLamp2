...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioLoadAccessRealm class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioLoadAccessRealmResponse class]];
	});
	return s_describer;
}
