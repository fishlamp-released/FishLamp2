...
//
//	FLZenfolioDeleteMessageHttpGetIn.m
...
@implementation FLZenfolioDeleteMessageHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioDeleteMessageHttpGetIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZenfolioDeleteMessageHttpGetIn*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZenfolioDeleteMessageHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioDeleteMessageHttpGetIn (ValueProperties) 
@end
