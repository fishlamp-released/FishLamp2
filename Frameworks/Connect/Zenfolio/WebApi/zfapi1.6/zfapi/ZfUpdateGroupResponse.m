...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"UpdateGroupResult" propertyClass:[ZFGroup class] propertyType:FLDataTypeObject] forPropertyName:@"UpdateGroupResult"];
	});
	return s_describer;
}
