...
@implementation ZFUpdateGroupAccess
...
- (void) copySelfTo:(id) object
{
	...
	((ZFUpdateGroupAccess*)object).groupId = FLCopyOrRetainObject(_groupId);
	((ZFUpdateGroupAccess*)object).updater = FLCopyOrRetainObject(_updater);
}
...
{
	return FLAutorelease([[ZFUpdateGroupAccess alloc] init]);
}

@end

@implementation ZFUpdateGroupAccess (ValueProperties) 
