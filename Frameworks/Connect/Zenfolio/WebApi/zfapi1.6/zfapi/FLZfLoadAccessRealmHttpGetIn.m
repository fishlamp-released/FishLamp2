...
//
//	FLZfLoadAccessRealmHttpGetIn.m
...
@implementation FLZfLoadAccessRealmHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadAccessRealmHttpGetIn*)object).realmId = FLCopyOrRetainObject(_realmId);
}
...
{
	return FLAutorelease([[FLZfLoadAccessRealmHttpGetIn alloc] init]);
}
...
@implementation FLZfLoadAccessRealmHttpGetIn (ValueProperties) 
@end
