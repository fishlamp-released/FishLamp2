...
@implementation FLZfDeleteGroup
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeleteGroup*)object).groupId = FLCopyOrRetainObject(_groupId);
}
...
{
	return FLAutorelease([[FLZfDeleteGroup alloc] init]);
}
...
@implementation FLZfDeleteGroup (ValueProperties) 
