...
- (void) copySelfTo:(id) object
{
	...
	((ZFGetRecentSetsHttpGetIn*)object).type = FLCopyOrRetainObject(_type);
	((ZFGetRecentSetsHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((ZFGetRecentSetsHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[ZFGetRecentSetsHttpGetIn alloc] init]);
}
...
@implementation ZFGetRecentSetsHttpGetIn (ValueProperties) 
@end
