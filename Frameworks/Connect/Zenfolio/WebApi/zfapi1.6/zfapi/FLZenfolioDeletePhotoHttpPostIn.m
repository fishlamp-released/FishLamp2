...
//
//	FLZenfolioDeletePhotoHttpPostIn.m
...
@implementation FLZenfolioDeletePhotoHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioDeletePhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
{
	return FLAutorelease([[FLZenfolioDeletePhotoHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioDeletePhotoHttpPostIn (ValueProperties) 
@end
