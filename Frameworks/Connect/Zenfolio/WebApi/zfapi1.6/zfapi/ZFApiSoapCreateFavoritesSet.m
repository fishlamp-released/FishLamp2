...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFCreateFavoritesSet class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFCreateFavoritesSetResponse class]];
	});
	return s_describer;
}
