...
//
//	FLZfUpdatePhotoSetAccessResponse.m
...
@implementation FLZfUpdatePhotoSetAccessResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUpdatePhotoSetAccessResponse*)object).UpdatePhotoSetAccessResult = FLCopyOrRetainObject(_UpdatePhotoSetAccessResult);
}
...
{
	return FLAutorelease([[FLZfUpdatePhotoSetAccessResponse alloc] init]);
}

@end

@implementation FLZfUpdatePhotoSetAccessResponse (ValueProperties) 
