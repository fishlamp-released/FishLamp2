...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"CreateGroupResult" propertyClass:[ZFGroup class] propertyType:FLDataTypeObject] forPropertyName:@"CreateGroupResult"];
	});
	return s_describer;
}
