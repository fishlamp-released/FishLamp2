...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFCreateVideoFromUrl class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFCreateVideoFromUrlResponse class]];
	});
	return s_describer;
}
