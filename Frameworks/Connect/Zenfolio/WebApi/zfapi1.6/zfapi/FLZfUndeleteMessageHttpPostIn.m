...
//
//	FLZfUndeleteMessageHttpPostIn.m
...
@implementation FLZfUndeleteMessageHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUndeleteMessageHttpPostIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZfUndeleteMessageHttpPostIn*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[FLZfUndeleteMessageHttpPostIn alloc] init]);
}

@end

@implementation FLZfUndeleteMessageHttpPostIn (ValueProperties) 
@end
