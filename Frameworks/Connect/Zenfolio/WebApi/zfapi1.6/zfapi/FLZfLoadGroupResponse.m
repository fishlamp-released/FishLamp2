...
@implementation FLZfLoadGroupResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadGroupResponse*)object).LoadGroupResult = FLCopyOrRetainObject(_LoadGroupResult);
}
...
{
	return FLAutorelease([[FLZfLoadGroupResponse alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"LoadGroupResult" propertyClass:[FLZfGroup class] propertyType:FLDataTypeObject] forPropertyName:@"LoadGroupResult"];
	});
	return s_describer;
}
...
@implementation FLZfLoadGroupResponse (ValueProperties) 
@end
