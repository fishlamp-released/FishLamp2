...
//
//	FLZenfolioDeletePhotoHttpGetIn.m
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioDeletePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
{
	return FLAutorelease([[FLZenfolioDeletePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioDeletePhotoHttpGetIn (ValueProperties) 
@end
