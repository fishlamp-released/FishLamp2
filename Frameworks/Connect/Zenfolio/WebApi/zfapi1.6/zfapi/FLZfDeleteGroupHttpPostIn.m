...
@implementation FLZfDeleteGroupHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeleteGroupHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
}
...
{
	return FLAutorelease([[FLZfDeleteGroupHttpPostIn alloc] init]);
}
...
@implementation FLZfDeleteGroupHttpPostIn (ValueProperties) 
@end
