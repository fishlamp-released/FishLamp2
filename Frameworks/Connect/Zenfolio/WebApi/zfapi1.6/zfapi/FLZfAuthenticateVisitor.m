...
@implementation FLZfAuthenticateVisitor
...
{
	return FLAutorelease([[FLZfAuthenticateVisitor alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticateVisitor*)object).visitorKey = FLCopyOrRetainObject(_visitorKey);
}
...
@implementation FLZfAuthenticateVisitor (ValueProperties) 
@end
