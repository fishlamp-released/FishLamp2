...
//
//	FLZenfolioLoadMessagesHttpPostIn.m
...
@implementation FLZenfolioLoadMessagesHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadMessagesHttpPostIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZenfolioLoadMessagesHttpPostIn*)object).includeDeleted = FLCopyOrRetainObject(_includeDeleted);
	((FLZenfolioLoadMessagesHttpPostIn*)object).postedSince = FLCopyOrRetainObject(_postedSince);
}
...
{
	return FLAutorelease([[FLZenfolioLoadMessagesHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioLoadMessagesHttpPostIn (ValueProperties) 
@end
