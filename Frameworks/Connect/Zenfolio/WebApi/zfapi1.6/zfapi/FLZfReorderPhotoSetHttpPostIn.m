...
//
//	FLZfReorderPhotoSetHttpPostIn.m
...
@implementation FLZfReorderPhotoSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReorderPhotoSetHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfReorderPhotoSetHttpPostIn*)object).shiftOrder = FLCopyOrRetainObject(_shiftOrder);
}
...
{
	return FLAutorelease([[FLZfReorderPhotoSetHttpPostIn alloc] init]);
}
...
@implementation FLZfReorderPhotoSetHttpPostIn (ValueProperties) 
@end
