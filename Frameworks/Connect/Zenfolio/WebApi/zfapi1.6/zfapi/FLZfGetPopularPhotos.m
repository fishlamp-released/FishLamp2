...
@implementation FLZfGetPopularPhotos
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetPopularPhotos*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetPopularPhotos*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetPopularPhotos alloc] init]);
}
...
@implementation FLZfGetPopularPhotos (ValueProperties) 
