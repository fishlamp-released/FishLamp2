...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioAuthenticateVisitor class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioAuthenticateVisitorResponse class]];
	});
	return s_describer;
}
