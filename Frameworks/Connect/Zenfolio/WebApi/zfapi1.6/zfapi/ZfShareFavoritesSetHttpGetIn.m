...
- (void) copySelfTo:(id) object
{
	...
	((ZFShareFavoritesSetHttpGetIn*)object).sharerEmail = FLCopyOrRetainObject(_sharerEmail);
	((ZFShareFavoritesSetHttpGetIn*)object).favoritesSetId = FLCopyOrRetainObject(_favoritesSetId);
	((ZFShareFavoritesSetHttpGetIn*)object).favoritesSetName = FLCopyOrRetainObject(_favoritesSetName);
	((ZFShareFavoritesSetHttpGetIn*)object).sharerName = FLCopyOrRetainObject(_sharerName);
	((ZFShareFavoritesSetHttpGetIn*)object).sharerMessage = FLCopyOrRetainObject(_sharerMessage);
}
...
{
	return FLAutorelease([[ZFShareFavoritesSetHttpGetIn alloc] init]);
}
...
@implementation ZFShareFavoritesSetHttpGetIn (ValueProperties) 
@end
