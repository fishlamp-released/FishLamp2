...
@implementation FLZfReorderGroupHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReorderGroupHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfReorderGroupHttpPostIn*)object).shiftOrder = FLCopyOrRetainObject(_shiftOrder);
}
...
{
	return FLAutorelease([[FLZfReorderGroupHttpPostIn alloc] init]);
}
...
@implementation FLZfReorderGroupHttpPostIn (ValueProperties) 
@end
