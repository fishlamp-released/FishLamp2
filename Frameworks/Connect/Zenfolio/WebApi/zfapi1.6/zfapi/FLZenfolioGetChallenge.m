...
@implementation FLZenfolioGetChallenge
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetChallenge*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
+ (FLZenfolioGetChallenge*) getChallenge
{
	return FLAutorelease([[FLZenfolioGetChallenge alloc] init]);
}
...
@implementation FLZenfolioGetChallenge (ValueProperties) 
@end
