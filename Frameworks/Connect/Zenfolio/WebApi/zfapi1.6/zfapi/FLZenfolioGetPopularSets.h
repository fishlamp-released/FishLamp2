...
// --------------------------------------------------------------------
// FLZenfolioGetPopularSets
// --------------------------------------------------------------------
@interface FLZenfolioGetPopularSets : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _type;
	NSNumber* _offset;
	NSNumber* _limit;
...
@interface FLZenfolioGetPopularSets (ValueProperties) 
