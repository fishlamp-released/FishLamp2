...
@implementation FLZfGetChallenge
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetChallenge*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
+ (FLZfGetChallenge*) getChallenge
{
	return FLAutorelease([[FLZfGetChallenge alloc] init]);
}
...
@implementation FLZfGetChallenge (ValueProperties) 
@end
