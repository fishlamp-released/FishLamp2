...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFSearchPhotoByCategory class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFSearchPhotoByCategoryResponse class]];
	});
	return s_describer;
}
