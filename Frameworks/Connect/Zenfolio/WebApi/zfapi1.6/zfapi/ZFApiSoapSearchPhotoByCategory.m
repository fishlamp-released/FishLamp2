...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFSearchPhotoByCategory class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFSearchPhotoByCategoryResponse class]];
	});
