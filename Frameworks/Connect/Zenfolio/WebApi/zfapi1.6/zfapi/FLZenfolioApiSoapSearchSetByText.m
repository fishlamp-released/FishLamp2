...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioSearchSetByText class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioSearchSetByTextResponse class]];
	});
	return s_describer;
}
