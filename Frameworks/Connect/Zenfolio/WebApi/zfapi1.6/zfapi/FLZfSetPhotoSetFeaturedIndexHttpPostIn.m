...
//
//	FLZfSetPhotoSetFeaturedIndexHttpPostIn.m
...
@implementation FLZfSetPhotoSetFeaturedIndexHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetPhotoSetFeaturedIndexHttpPostIn*)object).index = FLCopyOrRetainObject(_index);
	((FLZfSetPhotoSetFeaturedIndexHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfSetPhotoSetFeaturedIndexHttpPostIn alloc] init]);
}
...
@implementation FLZfSetPhotoSetFeaturedIndexHttpPostIn (ValueProperties) 
@end
