...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFLoadPhotoSet class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFLoadPhotoSetResponse class]];
	});
	return s_describer;
}
