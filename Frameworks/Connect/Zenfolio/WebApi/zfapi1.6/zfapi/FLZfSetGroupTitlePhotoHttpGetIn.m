...
//
//	FLZfSetGroupTitlePhotoHttpGetIn.m
...
@implementation FLZfSetGroupTitlePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetGroupTitlePhotoHttpGetIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfSetGroupTitlePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
{
	return FLAutorelease([[FLZfSetGroupTitlePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZfSetGroupTitlePhotoHttpGetIn (ValueProperties) 
@end
