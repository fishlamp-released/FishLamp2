...
//
//	FLZfCollectionRemovePhotoHttpGetIn.m
...
@implementation FLZfCollectionRemovePhotoHttpGetIn
...
{
	return FLAutorelease([[FLZfCollectionRemovePhotoHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCollectionRemovePhotoHttpGetIn*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZfCollectionRemovePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZfCollectionRemovePhotoHttpGetIn (ValueProperties) 
@end
