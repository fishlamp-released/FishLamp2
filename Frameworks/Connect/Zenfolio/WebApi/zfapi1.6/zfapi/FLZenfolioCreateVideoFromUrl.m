...
//
//	FLZenfolioCreateVideoFromUrl.m
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioCreateVideoFromUrl*)object).url = FLCopyOrRetainObject(_url);
	((FLZenfolioCreateVideoFromUrl*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZenfolioCreateVideoFromUrl*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZenfolioCreateVideoFromUrl alloc] init]);
}
...
@implementation FLZenfolioCreateVideoFromUrl (ValueProperties) 
