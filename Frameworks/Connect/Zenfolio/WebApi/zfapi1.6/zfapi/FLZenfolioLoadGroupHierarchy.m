...
//
//	FLZenfolioLoadGroupHierarchy.m
...
@implementation FLZenfolioLoadGroupHierarchy
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadGroupHierarchy*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZenfolioLoadGroupHierarchy alloc] init]);
}
...
@implementation FLZenfolioLoadGroupHierarchy (ValueProperties) 
@end
