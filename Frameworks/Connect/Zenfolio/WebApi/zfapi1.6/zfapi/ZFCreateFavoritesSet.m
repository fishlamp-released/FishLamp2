...
- (void) copySelfTo:(id) object
{
	...
	((ZFCreateFavoritesSet*)object).name = FLCopyOrRetainObject(_name);
	((ZFCreateFavoritesSet*)object).photographerLogin = FLCopyOrRetainObject(_photographerLogin);
	((ZFCreateFavoritesSet*)object).photoIds = FLCopyOrRetainObject(_photoIds);
}
...
{
	return FLAutorelease([[ZFCreateFavoritesSet alloc] init]);
}
...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"photoIds" withArrayTypes:[NSArray arrayWithObjects:[FLPropertyDescriber propertyDescriber:@"int" class:[FLIntegerNumber class]], nil]];
	});
...
@implementation ZFCreateFavoritesSet (ValueProperties) 
@end
