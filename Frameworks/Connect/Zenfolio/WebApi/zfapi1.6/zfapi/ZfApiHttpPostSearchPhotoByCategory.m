...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFSearchPhotoByCategoryHttpPostIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
