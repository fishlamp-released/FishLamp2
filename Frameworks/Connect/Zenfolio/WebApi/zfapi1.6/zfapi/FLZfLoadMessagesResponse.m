...
@implementation FLZfLoadMessagesResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadMessagesResponse*)object).LoadMessagesResult = FLCopyOrRetainObject(_LoadMessagesResult);
}
...
{
	return FLAutorelease([[FLZfLoadMessagesResponse alloc] init]);
}
...
@implementation FLZfLoadMessagesResponse (ValueProperties) 
@end
