...
//
//	FLZfCollectionAddPhotoHttpPostIn.m
...
@implementation FLZfCollectionAddPhotoHttpPostIn
...
{
	return FLAutorelease([[FLZfCollectionAddPhotoHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCollectionAddPhotoHttpPostIn*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZfCollectionAddPhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZfCollectionAddPhotoHttpPostIn (ValueProperties) 
@end
