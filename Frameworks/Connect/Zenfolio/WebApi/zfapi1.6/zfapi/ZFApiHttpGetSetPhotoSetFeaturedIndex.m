...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[describer setChildForIdentifier:@"input" withClass:[ZFSetPhotoSetFeaturedIndexHttpGetIn class]];
		[describer setChildForIdentifier:@"output" withClass:[ZFSetPhotoSetFeaturedIndexHttpGetOut class]];
	});
