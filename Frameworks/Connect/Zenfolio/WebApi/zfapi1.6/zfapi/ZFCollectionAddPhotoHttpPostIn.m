...
{
	return FLAutorelease([[ZFCollectionAddPhotoHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((ZFCollectionAddPhotoHttpPostIn*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((ZFCollectionAddPhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation ZFCollectionAddPhotoHttpPostIn (ValueProperties) 
@end
