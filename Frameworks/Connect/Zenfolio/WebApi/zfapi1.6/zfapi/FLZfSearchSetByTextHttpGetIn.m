...
//
//	FLZfSearchSetByTextHttpGetIn.m
...
@implementation FLZfSearchSetByTextHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchSetByTextHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfSearchSetByTextHttpGetIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchSetByTextHttpGetIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchSetByTextHttpGetIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZfSearchSetByTextHttpGetIn*)object).query = FLCopyOrRetainObject(_query);
	((FLZfSearchSetByTextHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfSearchSetByTextHttpGetIn alloc] init]);
}
...
@implementation FLZfSearchSetByTextHttpGetIn (ValueProperties) 
@end
