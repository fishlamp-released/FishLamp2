...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFReorderPhotoSet class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFReorderPhotoSetResponse class]];
	});
	return s_describer;
}
