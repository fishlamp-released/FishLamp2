...
//
//	FLZfLoadPublicProfileHttpPostIn.m
...
@implementation FLZfLoadPublicProfileHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPublicProfileHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[FLZfLoadPublicProfileHttpPostIn alloc] init]);
}
...
@implementation FLZfLoadPublicProfileHttpPostIn (ValueProperties) 
@end
