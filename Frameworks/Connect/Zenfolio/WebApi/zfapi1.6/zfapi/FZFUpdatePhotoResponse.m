...
//
//	FLZenfolioUpdatePhotoResponse.m
...
@implementation FLZenfolioUpdatePhotoResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioUpdatePhotoResponse*)object).UpdatePhotoResult = FLCopyOrRetainObject(_UpdatePhotoResult);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"UpdatePhotoResult" propertyClass:[FLZenfolioPhoto class] propertyType:FLDataTypeObject] forPropertyName:@"UpdatePhotoResult"];
	});
	return s_describer;
}
...
{
	return FLAutorelease([[FLZenfolioUpdatePhotoResponse alloc] init]);
}

@end

@implementation FLZenfolioUpdatePhotoResponse (ValueProperties) 
@end
