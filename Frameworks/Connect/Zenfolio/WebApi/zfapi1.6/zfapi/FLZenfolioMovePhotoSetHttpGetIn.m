...
//
//	FLZenfolioMovePhotoSetHttpGetIn.m
...
@implementation FLZenfolioMovePhotoSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioMovePhotoSetHttpGetIn*)object).index = FLCopyOrRetainObject(_index);
	((FLZenfolioMovePhotoSetHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZenfolioMovePhotoSetHttpGetIn*)object).destGroupId = FLCopyOrRetainObject(_destGroupId);
}
...
{
	return FLAutorelease([[FLZenfolioMovePhotoSetHttpGetIn alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"destGroupId" propertyClass:[NSString class] ] ];
...
@implementation FLZenfolioMovePhotoSetHttpGetIn (ValueProperties) 
@end
