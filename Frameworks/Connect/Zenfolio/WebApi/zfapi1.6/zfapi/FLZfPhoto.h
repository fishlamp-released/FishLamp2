...
#import "FLZfApi1_6Enums.h"
@class FLZfExifTag;
@class FLZfParsedCategory;

// --------------------------------------------------------------------
// FLZfPhoto
// --------------------------------------------------------------------
@interface FLZfPhoto : NSObject<NSCoding, NSCopying>{ 
@private
	NSNumber* _Id;
	NSNumber* _Width;
	NSNumber* _Height;
...
// Type: FLZfExifTag*, forKey: ExifTags
...
// Type: FLZfParsedCategory*, forKey: parsedCategory
...
@interface FLZfPhoto (ValueProperties) 
...
@property (readwrite, assign, nonatomic) FLZfPhotoFlags FlagsValue;
