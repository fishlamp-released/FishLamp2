...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"GetChallengeResult" propertyClass:[ZFAuthChallenge class] propertyType:FLDataTypeObject] forPropertyName:@"GetChallengeResult"];
	});
	return s_describer;
}
