...
//
//	FLZfCreateFavoritesSetResponse.m
...
@implementation FLZfCreateFavoritesSetResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreateFavoritesSetResponse*)object).CreateFavoritesSetResult = FLCopyOrRetainObject(_CreateFavoritesSetResult);
}
...
{
	return FLAutorelease([[FLZfCreateFavoritesSetResponse alloc] init]);
}
...
@implementation FLZfCreateFavoritesSetResponse (ValueProperties) 
