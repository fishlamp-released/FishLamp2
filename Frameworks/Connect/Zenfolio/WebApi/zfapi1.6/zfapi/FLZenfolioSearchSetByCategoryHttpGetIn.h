...
//
//	FLZenfolioSearchSetByCategoryHttpGetIn.h
...
// --------------------------------------------------------------------
// FLZenfolioSearchSetByCategoryHttpGetIn
// --------------------------------------------------------------------
@interface FLZenfolioSearchSetByCategoryHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _searchId;
	NSString* _type;
	NSString* _sortOrder;
...
@interface FLZenfolioSearchSetByCategoryHttpGetIn (ValueProperties) 
@end
