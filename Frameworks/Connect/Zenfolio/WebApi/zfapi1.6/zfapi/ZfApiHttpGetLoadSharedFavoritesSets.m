...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFLoadSharedFavoritesSetsHttpGetIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
