...
@implementation FLZfCollectionRemovePhoto
...
{
	return FLAutorelease([[FLZfCollectionRemovePhoto alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCollectionRemovePhoto*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZfCollectionRemovePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZfCollectionRemovePhoto (ValueProperties) 
