...
//
//	FLZenfolioGetDownloadOriginalKey.m
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioGetDownloadOriginalKey*)object).photoIds = FLCopyOrRetainObject(_photoIds);
	((FLZenfolioGetDownloadOriginalKey*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[FLZenfolioGetDownloadOriginalKey alloc] init]);
}
...
@implementation FLZenfolioGetDownloadOriginalKey (ValueProperties) 
@end
