...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFLoadPrivateProfile class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFLoadPrivateProfileResponse class]];
	});
	return s_describer;
}
