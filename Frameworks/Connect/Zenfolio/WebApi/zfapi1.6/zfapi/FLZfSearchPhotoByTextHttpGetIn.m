...
//
//	FLZfSearchPhotoByTextHttpGetIn.m
...
@implementation FLZfSearchPhotoByTextHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchPhotoByTextHttpGetIn*)object).query = FLCopyOrRetainObject(_query);
	((FLZfSearchPhotoByTextHttpGetIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchPhotoByTextHttpGetIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchPhotoByTextHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZfSearchPhotoByTextHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
+ (FLZfSearchPhotoByTextHttpGetIn*) searchPhotoByTextHttpGetIn
{
	return FLAutorelease([[FLZfSearchPhotoByTextHttpGetIn alloc] init]);
}
...
@implementation FLZfSearchPhotoByTextHttpGetIn (ValueProperties) 
@end
