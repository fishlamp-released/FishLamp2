...
- (void) copySelfTo:(id) object
{
	...
	((ZFUndeleteMessageHttpPostIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((ZFUndeleteMessageHttpPostIn*)object).messageIndex = FLCopyOrRetainObject(_messageIndex);
}
...
{
	return FLAutorelease([[ZFUndeleteMessageHttpPostIn alloc] init]);
}

@end

@implementation ZFUndeleteMessageHttpPostIn (ValueProperties) 
@end
