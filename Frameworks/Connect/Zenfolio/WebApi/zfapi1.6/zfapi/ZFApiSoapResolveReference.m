...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFResolveReference class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFResolveReferenceResponse class]];
	});
	return s_describer;
}
