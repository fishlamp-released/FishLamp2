...
//
//	FLZenfolioCreateVideoFromUrlHttpGetIn.m
...
@implementation FLZenfolioCreateVideoFromUrlHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioCreateVideoFromUrlHttpGetIn*)object).url = FLCopyOrRetainObject(_url);
	((FLZenfolioCreateVideoFromUrlHttpGetIn*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZenfolioCreateVideoFromUrlHttpGetIn*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZenfolioCreateVideoFromUrlHttpGetIn alloc] init]);
}
...
@implementation FLZenfolioCreateVideoFromUrlHttpGetIn (ValueProperties) 
@end
