...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[ZFCreateFavoritesSetHttpPostIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
