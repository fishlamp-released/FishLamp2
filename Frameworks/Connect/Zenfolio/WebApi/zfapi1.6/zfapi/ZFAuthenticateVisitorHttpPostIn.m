...
//
//	ZFAuthenticateVisitorHttpPostIn.m
...
@implementation ZFAuthenticateVisitorHttpPostIn
...
{
	return FLAutorelease([[ZFAuthenticateVisitorHttpPostIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((ZFAuthenticateVisitorHttpPostIn*)object).visitorKey = FLCopyOrRetainObject(_visitorKey);
}
...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"visitorKey" withClass:[NSString class]];
	});
	return s_describer;
}
...
@implementation ZFAuthenticateVisitorHttpPostIn (ValueProperties) 
@end
