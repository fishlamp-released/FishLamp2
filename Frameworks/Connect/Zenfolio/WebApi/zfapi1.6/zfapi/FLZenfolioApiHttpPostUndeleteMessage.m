...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioUndeleteMessageHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioUndeleteMessageHttpPostOut class]];
	});
	return s_describer;
}
