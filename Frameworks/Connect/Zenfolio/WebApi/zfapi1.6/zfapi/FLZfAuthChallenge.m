...
@implementation FLZfAuthChallenge
...
{
	return FLAutorelease([[FLZfAuthChallenge alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthChallenge*)object).PasswordSalt = FLCopyOrRetainObject(_PasswordSalt);
	((FLZfAuthChallenge*)object).Challenge = FLCopyOrRetainObject(_Challenge);
}
...
@implementation FLZfAuthChallenge (ValueProperties) 
@end
