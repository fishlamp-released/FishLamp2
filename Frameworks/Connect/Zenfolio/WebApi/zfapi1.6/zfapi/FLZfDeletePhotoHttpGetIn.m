...
@implementation FLZfDeletePhotoHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfDeletePhotoHttpGetIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
+ (FLZfDeletePhotoHttpGetIn*) deletePhotoHttpGetIn
{
	return FLAutorelease([[FLZfDeletePhotoHttpGetIn alloc] init]);
}
...
@implementation FLZfDeletePhotoHttpGetIn (ValueProperties) 
@end
