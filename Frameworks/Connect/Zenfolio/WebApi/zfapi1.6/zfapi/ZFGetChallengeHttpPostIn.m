...
@implementation ZFGetChallengeHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((ZFGetChallengeHttpPostIn*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
{
	return FLAutorelease([[ZFGetChallengeHttpPostIn alloc] init]);
}
...
@implementation ZFGetChallengeHttpPostIn (ValueProperties) 
@end
