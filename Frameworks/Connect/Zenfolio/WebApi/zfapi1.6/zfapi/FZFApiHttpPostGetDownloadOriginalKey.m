...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[FLZenfolioGetDownloadOriginalKeyHttpPostIn class] propertyType:FLDataTypeObject] forPropertyName:@"input"];
