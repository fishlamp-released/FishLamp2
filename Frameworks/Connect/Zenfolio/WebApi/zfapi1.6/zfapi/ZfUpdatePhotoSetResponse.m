...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"UpdatePhotoSetResult" propertyClass:[ZFPhotoSet class] propertyType:FLDataTypeObject] forPropertyName:@"UpdatePhotoSetResult"];
	});
	return s_describer;
}
