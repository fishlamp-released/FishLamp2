...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUser*)object).LastUpdated = FLCopyOrRetainObject(_LastUpdated);
	((FLZfUser*)object).Balance = FLCopyOrRetainObject(_Balance);
	((FLZfUser*)object).PhotoBytesQuota = FLCopyOrRetainObject(_PhotoBytesQuota);
	((FLZfUser*)object).ExpiresOn = FLCopyOrRetainObject(_ExpiresOn);
	((FLZfUser*)object).PrimaryEmail = FLCopyOrRetainObject(_PrimaryEmail);
	((FLZfUser*)object).Views = FLCopyOrRetainObject(_Views);
	((FLZfUser*)object).PublicAddress = FLCopyOrRetainObject(_PublicAddress);
	((FLZfUser*)object).LastName = FLCopyOrRetainObject(_LastName);
	((FLZfUser*)object).DomainName = FLCopyOrRetainObject(_DomainName);
	((FLZfUser*)object).Bio = FLCopyOrRetainObject(_Bio);
	((FLZfUser*)object).CollectionCount = FLCopyOrRetainObject(_CollectionCount);
	((FLZfUser*)object).FirstName = FLCopyOrRetainObject(_FirstName);
	((FLZfUser*)object).FeaturedPhotoSets = FLCopyOrRetainObject(_FeaturedPhotoSets);
	((FLZfUser*)object).LoginName = FLCopyOrRetainObject(_LoginName);
	((FLZfUser*)object).VideoBytesQuota = FLCopyOrRetainObject(_VideoBytesQuota);
	((FLZfUser*)object).StorageQuota = FLCopyOrRetainObject(_StorageQuota);
	((FLZfUser*)object).VideoDurationQuota = FLCopyOrRetainObject(_VideoDurationQuota);
	((FLZfUser*)object).RecentPhotoSets = FLCopyOrRetainObject(_RecentPhotoSets);
	((FLZfUser*)object).HierarchyCn = FLCopyOrRetainObject(_HierarchyCn);
	((FLZfUser*)object).GalleryCount = FLCopyOrRetainObject(_GalleryCount);
	((FLZfUser*)object).ReferralCode = FLCopyOrRetainObject(_ReferralCode);
	((FLZfUser*)object).RootGroup = FLCopyOrRetainObject(_RootGroup);
	((FLZfUser*)object).BioPhoto = FLCopyOrRetainObject(_BioPhoto);
	((FLZfUser*)object).PersonalAddress = FLCopyOrRetainObject(_PersonalAddress);
	((FLZfUser*)object).UserSince = FLCopyOrRetainObject(_UserSince);
	((FLZfUser*)object).DisplayName = FLCopyOrRetainObject(_DisplayName);
	((FLZfUser*)object).PhotoCount = FLCopyOrRetainObject(_PhotoCount);
	((FLZfUser*)object).PhotoBytes = FLCopyOrRetainObject(_PhotoBytes);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"BioPhoto" propertyClass:[FLZfFile class] propertyType:FLDataTypeObject] forPropertyName:@"BioPhoto"];
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"PublicAddress" propertyClass:[FLZfAddress class] propertyType:FLDataTypeObject] forPropertyName:@"PublicAddress"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"PersonalAddress" propertyClass:[FLZfAddress class] propertyType:FLDataTypeObject] forPropertyName:@"PersonalAddress"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"RecentPhotoSets" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[FLZfPhotoSet class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"RecentPhotoSets"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"FeaturedPhotoSets" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[FLZfPhotoSet class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"FeaturedPhotoSets"];
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"RootGroup" propertyClass:[FLZfGroup class] propertyType:FLDataTypeObject] forPropertyName:@"RootGroup"];
...
+ (FLZfUser*) user
{
	return FLAutorelease([[FLZfUser alloc] init]);
}

@end

@implementation FLZfUser (ValueProperties) 
