...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"SearchPhotoByCategoryResult" propertyClass:[ZFPhotoResult class] propertyType:FLDataTypeObject] forPropertyName:@"SearchPhotoByCategoryResult"];
	});
	return s_describer;
}
