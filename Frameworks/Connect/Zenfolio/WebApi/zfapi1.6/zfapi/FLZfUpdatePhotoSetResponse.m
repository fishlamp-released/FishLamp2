...
@implementation FLZfUpdatePhotoSetResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUpdatePhotoSetResponse*)object).UpdatePhotoSetResult = FLCopyOrRetainObject(_UpdatePhotoSetResult);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"UpdatePhotoSetResult" propertyClass:[FLZfPhotoSet class] propertyType:FLDataTypeObject] forPropertyName:@"UpdatePhotoSetResult"];
	});
	return s_describer;
}
...
{
	return FLAutorelease([[FLZfUpdatePhotoSetResponse alloc] init]);
}

@end

@implementation FLZfUpdatePhotoSetResponse (ValueProperties) 
@end
