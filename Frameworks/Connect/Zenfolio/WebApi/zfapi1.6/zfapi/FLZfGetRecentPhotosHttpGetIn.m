...
//
//	FLZfGetRecentPhotosHttpGetIn.m
...
@implementation FLZfGetRecentPhotosHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetRecentPhotosHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetRecentPhotosHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetRecentPhotosHttpGetIn alloc] init]);
}
...
@implementation FLZfGetRecentPhotosHttpGetIn (ValueProperties) 
@end
