...
@implementation FLZfCheckPrivilege
...
{
	return FLAutorelease([[FLZfCheckPrivilege alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfCheckPrivilege*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZfCheckPrivilege*)object).privilegeName = FLCopyOrRetainObject(_privilegeName);
}
...
@implementation FLZfCheckPrivilege (ValueProperties) 
@end
