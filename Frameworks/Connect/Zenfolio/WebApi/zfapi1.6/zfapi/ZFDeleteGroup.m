...
- (void) copySelfTo:(id) object
{
	...
	((ZFDeleteGroup*)object).groupId = FLCopyOrRetainObject(_groupId);
}
...
{
	return FLAutorelease([[ZFDeleteGroup alloc] init]);
}
...
@implementation ZFDeleteGroup (ValueProperties) 
