...
@implementation FLZfCreateVideoFromUrl
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfCreateVideoFromUrl*)object).url = FLCopyOrRetainObject(_url);
	((FLZfCreateVideoFromUrl*)object).galleryId = FLCopyOrRetainObject(_galleryId);
	((FLZfCreateVideoFromUrl*)object).cookies = FLCopyOrRetainObject(_cookies);
}
...
{
	return FLAutorelease([[FLZfCreateVideoFromUrl alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"galleryId" propertyClass:[NSNumber class] propertyType:FLDataTypeInteger] forPropertyName:@"galleryId"];
...
@implementation FLZfCreateVideoFromUrl (ValueProperties) 
