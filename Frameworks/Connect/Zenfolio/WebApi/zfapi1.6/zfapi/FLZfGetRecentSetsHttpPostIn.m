...
@implementation FLZfGetRecentSetsHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetRecentSetsHttpPostIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZfGetRecentSetsHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetRecentSetsHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetRecentSetsHttpPostIn alloc] init]);
}
...
@implementation FLZfGetRecentSetsHttpPostIn (ValueProperties) 
@end
