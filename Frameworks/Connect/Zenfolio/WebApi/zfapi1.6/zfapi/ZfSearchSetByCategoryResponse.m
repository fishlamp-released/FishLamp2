...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"SearchSetByCategoryResult" propertyClass:[ZFPhotoSetResult class] propertyType:FLDataTypeObject] forPropertyName:@"SearchSetByCategoryResult"];
	});
	return s_describer;
}
