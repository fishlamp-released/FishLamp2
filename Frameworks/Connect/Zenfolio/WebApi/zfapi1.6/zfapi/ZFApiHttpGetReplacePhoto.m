...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFReplacePhotoHttpGetIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFReplacePhotoHttpGetOut class]];
	});
	return s_describer;
}
