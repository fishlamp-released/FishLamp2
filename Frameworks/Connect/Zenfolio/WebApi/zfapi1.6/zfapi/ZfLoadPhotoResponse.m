...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"LoadPhotoResult" propertyClass:[ZFPhoto class] propertyType:FLDataTypeObject] forPropertyName:@"LoadPhotoResult"];
	});
	return s_describer;
}
