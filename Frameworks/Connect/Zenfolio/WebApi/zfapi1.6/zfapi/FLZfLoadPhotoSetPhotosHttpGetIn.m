...
//
//	FLZfLoadPhotoSetPhotosHttpGetIn.m
...
@implementation FLZfLoadPhotoSetPhotosHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPhotoSetPhotosHttpGetIn*)object).startingIndex = FLCopyOrRetainObject(_startingIndex);
	((FLZfLoadPhotoSetPhotosHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfLoadPhotoSetPhotosHttpGetIn*)object).numberOfPhotos = FLCopyOrRetainObject(_numberOfPhotos);
}
...
{
	return FLAutorelease([[FLZfLoadPhotoSetPhotosHttpGetIn alloc] init]);
}
...
@implementation FLZfLoadPhotoSetPhotosHttpGetIn (ValueProperties) 
@end
