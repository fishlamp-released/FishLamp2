...
@implementation FLZfApiHttpPost


FLSynthesizeSingleton(FLZfApiHttpPost);

+ (FLZfApiHttpPost*) apiHttpPost
{
	return FLAutorelease([[FLZfApiHttpPost alloc] init]);
}
...
@implementation FLZfApiHttpPost (ValueProperties) 
@end
