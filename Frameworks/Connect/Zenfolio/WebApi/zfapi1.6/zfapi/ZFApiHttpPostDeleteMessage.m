...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFDeleteMessageHttpPostIn class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFDeleteMessageHttpPostOut class]];
	});
	return s_describer;
}
