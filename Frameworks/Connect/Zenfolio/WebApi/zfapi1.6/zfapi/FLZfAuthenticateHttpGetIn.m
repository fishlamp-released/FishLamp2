...
@implementation FLZfAuthenticateHttpGetIn
...
{
	return FLAutorelease([[FLZfAuthenticateHttpGetIn alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZfAuthenticateHttpGetIn*)object).challenge = FLCopyOrRetainObject(_challenge);
	((FLZfAuthenticateHttpGetIn*)object).proof = FLCopyOrRetainObject(_proof);
}
...
@implementation FLZfAuthenticateHttpGetIn (ValueProperties) 
@end
