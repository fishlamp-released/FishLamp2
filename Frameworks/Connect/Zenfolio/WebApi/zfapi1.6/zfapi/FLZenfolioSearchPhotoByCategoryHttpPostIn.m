...
//
//	FLZenfolioSearchPhotoByCategoryHttpPostIn.m
...
@implementation FLZenfolioSearchPhotoByCategoryHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioSearchPhotoByCategoryHttpPostIn*)object).categoryCode = FLCopyOrRetainObject(_categoryCode);
	((FLZenfolioSearchPhotoByCategoryHttpPostIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZenfolioSearchPhotoByCategoryHttpPostIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZenfolioSearchPhotoByCategoryHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZenfolioSearchPhotoByCategoryHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
{
	return FLAutorelease([[FLZenfolioSearchPhotoByCategoryHttpPostIn alloc] init]);
}
...
@implementation FLZenfolioSearchPhotoByCategoryHttpPostIn (ValueProperties) 
@end
