...
//
//	FLZfGetDownloadOriginalKeyHttpGetIn.m
...
@implementation FLZfGetDownloadOriginalKeyHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetDownloadOriginalKeyHttpGetIn*)object).photoIds = FLCopyOrRetainObject(_photoIds);
	((FLZfGetDownloadOriginalKeyHttpGetIn*)object).password = FLCopyOrRetainObject(_password);
}
...
{
	return FLAutorelease([[FLZfGetDownloadOriginalKeyHttpGetIn alloc] init]);
}
...
@implementation FLZfGetDownloadOriginalKeyHttpGetIn (ValueProperties) 
@end
