...
@implementation FLZenfolioAuthenticatePlain
...
{
	return FLAutorelease([[FLZenfolioAuthenticatePlain alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioAuthenticatePlain*)object).loginName = FLCopyOrRetainObject(_loginName);
	((FLZenfolioAuthenticatePlain*)object).password = FLCopyOrRetainObject(_password);
}
...
@implementation FLZenfolioAuthenticatePlain (ValueProperties) 
@end
