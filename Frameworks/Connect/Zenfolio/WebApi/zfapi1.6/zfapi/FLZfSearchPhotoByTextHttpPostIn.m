...
//
//	FLZfSearchPhotoByTextHttpPostIn.m
...
@implementation FLZfSearchPhotoByTextHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchPhotoByTextHttpPostIn*)object).query = FLCopyOrRetainObject(_query);
	((FLZfSearchPhotoByTextHttpPostIn*)object).sortOrder = FLCopyOrRetainObject(_sortOrder);
	((FLZfSearchPhotoByTextHttpPostIn*)object).searchId = FLCopyOrRetainObject(_searchId);
	((FLZfSearchPhotoByTextHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
	((FLZfSearchPhotoByTextHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
}
...
{
	return FLAutorelease([[FLZfSearchPhotoByTextHttpPostIn alloc] init]);
}
...
@implementation FLZfSearchPhotoByTextHttpPostIn (ValueProperties) 
@end
