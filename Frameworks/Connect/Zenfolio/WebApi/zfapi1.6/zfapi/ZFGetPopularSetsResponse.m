...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"GetPopularSetsResult" withArrayTypes:[NSArray arrayWithObjects:[FLTypeDesc typeDesc:@"PhotoSet" class:[ZFPhotoSet class]], nil]];
	});
	return s_describer;
}
