...
@implementation FLZfMovePhotoHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfMovePhotoHttpPostIn*)object).destSetId = FLCopyOrRetainObject(_destSetId);
	((FLZfMovePhotoHttpPostIn*)object).index = FLCopyOrRetainObject(_index);
	((FLZfMovePhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfMovePhotoHttpPostIn*)object).srcSetId = FLCopyOrRetainObject(_srcSetId);
}
...
+ (FLZfMovePhotoHttpPostIn*) movePhotoHttpPostIn
{
	return FLAutorelease([[FLZfMovePhotoHttpPostIn alloc] init]);
}
...
@implementation FLZfMovePhotoHttpPostIn (ValueProperties) 
@end
