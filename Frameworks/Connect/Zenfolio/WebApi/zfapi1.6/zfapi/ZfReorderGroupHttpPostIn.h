...
// --------------------------------------------------------------------
// ZFReorderGroupHttpPostIn
// --------------------------------------------------------------------
@interface ZFReorderGroupHttpPostIn : NSObject<NSCoding, NSCopying>{ 
@private
	NSString* _groupId;
...
@interface ZFReorderGroupHttpPostIn (ValueProperties) 
@end
