...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"FeaturedIndex" withClass:[FLIntegerNumber class] ];
		[s_describer addChildDescriberWithName:@"TitlePhoto" withClass:[ZFPhoto class]];
		[s_describer addChildDescriberWithName:@"IsRandomTitlePhoto" withClass:[FLBoolNumber class] ];
		...
		[s_describer addChildDescriberWithName:@"Photos" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"Photo" objectClass:[ZFPhoto class]], nil]];
		...
		[s_describer addChildDescriberWithName:@"VideoUploadUrl" withClass:[NSString class]];
		...
		[s_describer addChildDescriberWithName:@"PhotoListCn" withClass:[FLIntegerNumber class] ];
	});
	return s_describer;
}
