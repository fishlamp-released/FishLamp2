...
@implementation FLZfMovePhotoSetHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfMovePhotoSetHttpPostIn*)object).index = FLCopyOrRetainObject(_index);
	((FLZfMovePhotoSetHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfMovePhotoSetHttpPostIn*)object).destGroupId = FLCopyOrRetainObject(_destGroupId);
}
...
{
	return FLAutorelease([[FLZfMovePhotoSetHttpPostIn alloc] init]);
}
...
@implementation FLZfMovePhotoSetHttpPostIn (ValueProperties) 
@end
