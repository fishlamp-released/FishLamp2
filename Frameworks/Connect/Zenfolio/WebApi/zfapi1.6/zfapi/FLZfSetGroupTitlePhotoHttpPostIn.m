...
//
//	FLZfSetGroupTitlePhotoHttpPostIn.m
...
@implementation FLZfSetGroupTitlePhotoHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetGroupTitlePhotoHttpPostIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfSetGroupTitlePhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
{
	return FLAutorelease([[FLZfSetGroupTitlePhotoHttpPostIn alloc] init]);
}
...
@implementation FLZfSetGroupTitlePhotoHttpPostIn (ValueProperties) 
@end
