...
//
//	FLZenfolioCreatePhotoFromUrlResponse.m
...
@implementation FLZenfolioCreatePhotoFromUrlResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioCreatePhotoFromUrlResponse*)object).CreatePhotoFromUrlResult = FLCopyOrRetainObject(_CreatePhotoFromUrlResult);
}
...
{
	return FLAutorelease([[FLZenfolioCreatePhotoFromUrlResponse alloc] init]);
}
...
@implementation FLZenfolioCreatePhotoFromUrlResponse (ValueProperties) 
