...
- (void) copySelfTo:(id) object
{
	...
	((ZFDeletePhotoSetHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[ZFDeletePhotoSetHttpPostIn alloc] init]);
}
...
@implementation ZFDeletePhotoSetHttpPostIn (ValueProperties) 
@end
