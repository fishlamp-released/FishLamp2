...
@implementation FLZfPhotoSetUpdater
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfPhotoSetUpdater*)object).Keywords = FLCopyOrRetainObject(_Keywords);
	((FLZfPhotoSetUpdater*)object).Categories = FLCopyOrRetainObject(_Categories);
	((FLZfPhotoSetUpdater*)object).Title = FLCopyOrRetainObject(_Title);
	((FLZfPhotoSetUpdater*)object).Caption = FLCopyOrRetainObject(_Caption);
	((FLZfPhotoSetUpdater*)object).CustomReference = FLCopyOrRetainObject(_CustomReference);
}
...
{
	return FLAutorelease([[FLZfPhotoSetUpdater alloc] init]);
}
...
@implementation FLZfPhotoSetUpdater (ValueProperties) 
@end
