...
@implementation FLZfUpdatePhotoAccess
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUpdatePhotoAccess*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfUpdatePhotoAccess*)object).updater = FLCopyOrRetainObject(_updater);
}
...
{
	return FLAutorelease([[FLZfUpdatePhotoAccess alloc] init]);
}

@end

@implementation FLZfUpdatePhotoAccess (ValueProperties) 
