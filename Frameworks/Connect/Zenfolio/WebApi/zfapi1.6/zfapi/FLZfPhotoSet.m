...
- (void) copySelfTo:(id) object
{
	...
	((FLZfPhotoSet*)object).Caption = FLCopyOrRetainObject(_Caption);
	((FLZfPhotoSet*)object).TitlePhoto = FLCopyOrRetainObject(_TitlePhoto);
	((FLZfPhotoSet*)object).ImageCount = FLCopyOrRetainObject(_ImageCount);
	((FLZfPhotoSet*)object).PageUrl = FLCopyOrRetainObject(_PageUrl);
	((FLZfPhotoSet*)object).PhotoListCn = FLCopyOrRetainObject(_PhotoListCn);
	((FLZfPhotoSet*)object).ParentGroups = FLCopyOrRetainObject(_ParentGroups);
	((FLZfPhotoSet*)object).Views = FLCopyOrRetainObject(_Views);
	((FLZfPhotoSet*)object).Type = FLCopyOrRetainObject(_Type);
	((FLZfPhotoSet*)object).UploadUrl = FLCopyOrRetainObject(_UploadUrl);
	((FLZfPhotoSet*)object).TextCn = FLCopyOrRetainObject(_TextCn);
	((FLZfPhotoSet*)object).VideoCount = FLCopyOrRetainObject(_VideoCount);
	((FLZfPhotoSet*)object).FeaturedIndex = FLCopyOrRetainObject(_FeaturedIndex);
	((FLZfPhotoSet*)object).IsRandomTitlePhoto = FLCopyOrRetainObject(_IsRandomTitlePhoto);
	((FLZfPhotoSet*)object).Photos = FLCopyOrRetainObject(_Photos);
	((FLZfPhotoSet*)object).Categories = FLCopyOrRetainObject(_Categories);
	((FLZfPhotoSet*)object).MailboxId = FLCopyOrRetainObject(_MailboxId);
	((FLZfPhotoSet*)object).Keywords = FLCopyOrRetainObject(_Keywords);
	((FLZfPhotoSet*)object).ModifiedOn = FLCopyOrRetainObject(_ModifiedOn);
	((FLZfPhotoSet*)object).VideoUploadUrl = FLCopyOrRetainObject(_VideoUploadUrl);
	((FLZfPhotoSet*)object).CreatedOn = FLCopyOrRetainObject(_CreatedOn);
	((FLZfPhotoSet*)object).PhotoCount = FLCopyOrRetainObject(_PhotoCount);
	((FLZfPhotoSet*)object).PhotoBytes = FLCopyOrRetainObject(_PhotoBytes);
}
...
+ (FLZfPhotoSet*) photoSet
{
	return FLAutorelease([[FLZfPhotoSet alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"TitlePhoto" propertyClass:[FLZfPhoto class] propertyType:FLDataTypeObject] forPropertyName:@"TitlePhoto"];
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"Photos" propertyClass:[NSMutableArray class] propertyType:FLDataTypeObject arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"Photo" propertyClass:[FLZfPhoto class] propertyType:FLDataTypeObject arrayTypes:nil], nil] isUnboundedArray:NO] forPropertyName:@"Photos"];
...
@implementation FLZfPhotoSet (ValueProperties) 
