...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addChildDescriberWithName:@"input" withClass:[ZFLoadPhotoSetHttpPostIn class]];
		[s_describer addChildDescriberWithName:@"output" withClass:[ZFPhotoSet class]];
	});
	return s_describer;
}
