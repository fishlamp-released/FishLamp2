...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"ResolveReferenceResult" propertyClass:[ZFResolveResult class] propertyType:FLDataTypeObject] forPropertyName:@"ResolveReferenceResult"];
	});
	return s_describer;
}
