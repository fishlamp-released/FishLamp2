...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setChildForIdentifier:@"input" withClass:[ZFSearchSetByCategory class]];
		[s_describer setChildForIdentifier:@"output" withClass:[ZFSearchSetByCategoryResponse class]];
	});
	return s_describer;
}
