...
//
//	FLZenfolioCollectionRemovePhoto.m
...
@implementation FLZenfolioCollectionRemovePhoto
...
{
	return FLAutorelease([[FLZenfolioCollectionRemovePhoto alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioCollectionRemovePhoto*)object).collectionId = FLCopyOrRetainObject(_collectionId);
	((FLZenfolioCollectionRemovePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
}
...
@implementation FLZenfolioCollectionRemovePhoto (ValueProperties) 
