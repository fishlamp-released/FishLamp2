...
//
//	FLZfShareFavoritesSetHttpGetIn.m
...
@implementation FLZfShareFavoritesSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfShareFavoritesSetHttpGetIn*)object).sharerEmail = FLCopyOrRetainObject(_sharerEmail);
	((FLZfShareFavoritesSetHttpGetIn*)object).favoritesSetId = FLCopyOrRetainObject(_favoritesSetId);
	((FLZfShareFavoritesSetHttpGetIn*)object).favoritesSetName = FLCopyOrRetainObject(_favoritesSetName);
	((FLZfShareFavoritesSetHttpGetIn*)object).sharerName = FLCopyOrRetainObject(_sharerName);
	((FLZfShareFavoritesSetHttpGetIn*)object).sharerMessage = FLCopyOrRetainObject(_sharerMessage);
}
...
{
	return FLAutorelease([[FLZfShareFavoritesSetHttpGetIn alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"favoritesSetId" propertyClass:[NSString class] propertyType:FLDataTypeString] forPropertyName:@"favoritesSetId"];
...
@implementation FLZfShareFavoritesSetHttpGetIn (ValueProperties) 
@end
