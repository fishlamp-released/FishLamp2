...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"PrimaryEmail" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"BioPhoto" propertyClass:[FLZenfolioFile class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"Bio" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"Views" propertyClass:[FLIntegerNumber class]] ];
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"PhotoBytes" propertyClass:[FLLongNumber class]] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"UserSince" propertyClass:[NSDate class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"LastUpdated" propertyClass:[NSDate class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"PublicAddress" propertyClass:[FLZenfolioAddress class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"PersonalAddress" propertyClass:[FLZenfolioAddress class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"RecentPhotoSets" propertyClass:[NSMutableArray class]  arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[FLZenfolioPhotoSet class]], nil] isUnboundedArray:NO] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"FeaturedPhotoSets" propertyClass:[NSMutableArray class]  arrayTypes:[NSArray arrayWithObjects:[FLPropertyDescription propertyDescription:@"PhotoSet" propertyClass:[FLZenfolioPhotoSet class]], nil] isUnboundedArray:NO] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"RootGroup" propertyClass:[FLZenfolioGroup class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"ReferralCode" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"ExpiresOn" propertyClass:[NSDate class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"Balance" propertyClass:[FLDoubleNumber class]] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"DomainName" propertyClass:[NSString class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"StorageQuota" propertyClass:[FLLongNumber class]] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"PhotoBytesQuota" propertyClass:[FLLongNumber class]] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"VideoBytesQuota" propertyClass:[FLLongNumber class]] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"VideoDurationQuota" propertyClass:[FLIntegerNumber class]] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"HierarchyCn" propertyClass:[FLIntegerNumber class]] ];
	});
	return s_describer;
}
