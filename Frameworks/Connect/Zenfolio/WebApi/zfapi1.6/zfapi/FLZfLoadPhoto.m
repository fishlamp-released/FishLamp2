...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadPhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfLoadPhoto*)object).level = FLCopyOrRetainObject(_level);
}
...
{
	return FLAutorelease([[FLZfLoadPhoto alloc] init]);
}
...
@implementation FLZfLoadPhoto (ValueProperties) 
