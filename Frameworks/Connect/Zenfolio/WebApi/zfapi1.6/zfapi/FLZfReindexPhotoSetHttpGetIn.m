...
//
//	FLZfReindexPhotoSetHttpGetIn.m
...
@implementation FLZfReindexPhotoSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfReindexPhotoSetHttpGetIn*)object).startIndex = FLCopyOrRetainObject(_startIndex);
	((FLZfReindexPhotoSetHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
	((FLZfReindexPhotoSetHttpGetIn*)object).mapping = FLCopyOrRetainObject(_mapping);
}
...
+ (FLZfReindexPhotoSetHttpGetIn*) reindexPhotoSetHttpGetIn
{
	return FLAutorelease([[FLZfReindexPhotoSetHttpGetIn alloc] init]);
}
...
@implementation FLZfReindexPhotoSetHttpGetIn (ValueProperties) 
@end
