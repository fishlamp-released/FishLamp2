...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"input" propertyClass:[FLZenfolioSetPhotoSetTitlePhotoHttpPostIn class] ] ];
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"output" propertyClass:[FLZenfolioSetPhotoSetTitlePhotoHttpPostOut class] ] ];
	});
	return s_describer;
}
