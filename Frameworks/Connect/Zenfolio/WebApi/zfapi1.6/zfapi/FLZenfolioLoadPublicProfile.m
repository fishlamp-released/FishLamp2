...
@implementation FLZenfolioLoadPublicProfile
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioLoadPublicProfile*)object).loginName = FLCopyOrRetainObject(_loginName);
}
...
+ (FLZenfolioLoadPublicProfile*) loadPublicProfile
{
	return FLAutorelease([[FLZenfolioLoadPublicProfile alloc] init]);
}
...
@implementation FLZenfolioLoadPublicProfile (ValueProperties) 
@end
