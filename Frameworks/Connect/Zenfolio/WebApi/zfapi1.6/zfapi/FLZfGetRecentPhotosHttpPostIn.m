...
//
//	FLZfGetRecentPhotosHttpPostIn.m
...
@implementation FLZfGetRecentPhotosHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetRecentPhotosHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetRecentPhotosHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetRecentPhotosHttpPostIn alloc] init]);
}
...
@implementation FLZfGetRecentPhotosHttpPostIn (ValueProperties) 
@end
