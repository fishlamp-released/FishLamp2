...
@implementation FLZfSearchSetByTextResponse
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSearchSetByTextResponse*)object).SearchSetByTextResult = FLCopyOrRetainObject(_SearchSetByTextResult);
}
...
{
	return FLAutorelease([[FLZfSearchSetByTextResponse alloc] init]);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"SearchSetByTextResult" propertyClass:[FLZfPhotoSetResult class] propertyType:FLDataTypeObject] forPropertyName:@"SearchSetByTextResult"];
	});
	return s_describer;
}
...
@implementation FLZfSearchSetByTextResponse (ValueProperties) 
@end
