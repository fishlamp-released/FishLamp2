...
@implementation FLZfUpdatePhoto
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUpdatePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfUpdatePhoto*)object).updater = FLCopyOrRetainObject(_updater);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"updater" propertyClass:[FLZfPhotoUpdater class] propertyType:FLDataTypeObject] forPropertyName:@"updater"];
	});
	return s_describer;
}
...
{
	return FLAutorelease([[FLZfUpdatePhoto alloc] init]);
}

@end

@implementation FLZfUpdatePhoto (ValueProperties) 
