...
@implementation FLZfUpdatePhotoSetAccess
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfUpdatePhotoSetAccess*)object).updater = FLCopyOrRetainObject(_updater);
	((FLZfUpdatePhotoSetAccess*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfUpdatePhotoSetAccess alloc] init]);
}

@end

@implementation FLZfUpdatePhotoSetAccess (ValueProperties) 
