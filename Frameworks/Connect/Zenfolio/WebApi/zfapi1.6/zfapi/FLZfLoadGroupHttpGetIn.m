...
@implementation FLZfLoadGroupHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadGroupHttpGetIn*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfLoadGroupHttpGetIn*)object).level = FLCopyOrRetainObject(_level);
	((FLZfLoadGroupHttpGetIn*)object).includeChildren = FLCopyOrRetainObject(_includeChildren);
}
...
{
	return FLAutorelease([[FLZfLoadGroupHttpGetIn alloc] init]);
}
...
@implementation FLZfLoadGroupHttpGetIn (ValueProperties) 
@end
