...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[FLZenfolioReindexPhotoSetHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[FLZenfolioReindexPhotoSetHttpPostOut class]];
	});
	return s_describer;
}
