...
- (void) copySelfTo:(id) object
{
	...
	((FLZfMoveGroup*)object).groupId = FLCopyOrRetainObject(_groupId);
	((FLZfMoveGroup*)object).destGroupId = FLCopyOrRetainObject(_destGroupId);
	((FLZfMoveGroup*)object).index = FLCopyOrRetainObject(_index);
}
...
+ (FLZfMoveGroup*) moveGroup
{
	return FLAutorelease([[FLZfMoveGroup alloc] init]);
}
...
@implementation FLZfMoveGroup (ValueProperties) 
