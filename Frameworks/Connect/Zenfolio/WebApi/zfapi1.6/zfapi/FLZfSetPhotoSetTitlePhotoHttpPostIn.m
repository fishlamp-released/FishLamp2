...
//
//	FLZfSetPhotoSetTitlePhotoHttpPostIn.m
...
@implementation FLZfSetPhotoSetTitlePhotoHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetPhotoSetTitlePhotoHttpPostIn*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfSetPhotoSetTitlePhotoHttpPostIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfSetPhotoSetTitlePhotoHttpPostIn alloc] init]);
}
...
@implementation FLZfSetPhotoSetTitlePhotoHttpPostIn (ValueProperties) 
@end
