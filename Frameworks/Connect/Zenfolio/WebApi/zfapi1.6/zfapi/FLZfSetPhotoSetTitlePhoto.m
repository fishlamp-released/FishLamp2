...
@implementation FLZfSetPhotoSetTitlePhoto
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSetPhotoSetTitlePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZfSetPhotoSetTitlePhoto*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[FLZfSetPhotoSetTitlePhoto alloc] init]);
}
...
@implementation FLZfSetPhotoSetTitlePhoto (ValueProperties) 
