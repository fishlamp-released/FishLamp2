...
@implementation FLZfLoadMessagesHttpPostIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfLoadMessagesHttpPostIn*)object).mailboxId = FLCopyOrRetainObject(_mailboxId);
	((FLZfLoadMessagesHttpPostIn*)object).includeDeleted = FLCopyOrRetainObject(_includeDeleted);
	((FLZfLoadMessagesHttpPostIn*)object).postedSince = FLCopyOrRetainObject(_postedSince);
}
...
+ (FLZfLoadMessagesHttpPostIn*) loadMessagesHttpPostIn
{
	return FLAutorelease([[FLZfLoadMessagesHttpPostIn alloc] init]);
}
...
@implementation FLZfLoadMessagesHttpPostIn (ValueProperties) 
@end
