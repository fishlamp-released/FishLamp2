...
@implementation FLZenfolioMovePhoto
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioMovePhoto*)object).destSetId = FLCopyOrRetainObject(_destSetId);
	((FLZenfolioMovePhoto*)object).index = FLCopyOrRetainObject(_index);
	((FLZenfolioMovePhoto*)object).photoId = FLCopyOrRetainObject(_photoId);
	((FLZenfolioMovePhoto*)object).srcSetId = FLCopyOrRetainObject(_srcSetId);
}
...
{
	return FLAutorelease([[FLZenfolioMovePhoto alloc] init]);
}
...
@implementation FLZenfolioMovePhoto (ValueProperties) 
