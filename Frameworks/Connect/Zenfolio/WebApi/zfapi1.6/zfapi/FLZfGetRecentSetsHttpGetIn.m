...
@implementation FLZfGetRecentSetsHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfGetRecentSetsHttpGetIn*)object).type = FLCopyOrRetainObject(_type);
	((FLZfGetRecentSetsHttpGetIn*)object).limit = FLCopyOrRetainObject(_limit);
	((FLZfGetRecentSetsHttpGetIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[FLZfGetRecentSetsHttpGetIn alloc] init]);
}
...
@implementation FLZfGetRecentSetsHttpGetIn (ValueProperties) 
@end
