...
//
//	FLZenfolioUpdatePhotoSetAccess.m
...
@implementation FLZenfolioUpdatePhotoSetAccess
...
- (void) copySelfTo:(id) object
{
	...
	((FLZenfolioUpdatePhotoSetAccess*)object).updater = FLCopyOrRetainObject(_updater);
	((FLZenfolioUpdatePhotoSetAccess*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer setPropertyDescriber:[FLPropertyDescription propertyDescription:@"updater" propertyClass:[FLZenfolioAccessUpdater class] propertyType:FLDataTypeObject] forPropertyName:@"updater"];
	});
	return s_describer;
}
...
{
	return FLAutorelease([[FLZenfolioUpdatePhotoSetAccess alloc] init]);
}

@end

@implementation FLZenfolioUpdatePhotoSetAccess (ValueProperties) 
