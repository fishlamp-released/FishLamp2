...
//
//	FLZenfolioAuthenticateVisitorResponse.m
...
@implementation FLZenfolioAuthenticateVisitorResponse
...
{
	return FLAutorelease([[FLZenfolioAuthenticateVisitorResponse alloc] init]);
}

- (void) copySelfTo:(id) object
{
	[super copySelfTo:object];
	((FLZenfolioAuthenticateVisitorResponse*)object).AuthenticateVisitorResult = FLCopyOrRetainObject(_AuthenticateVisitorResult);
}
...
+ (FLObjectDescriber*) sharedObjectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addPropertyDescriber:[FLPropertyDescription propertyDescription:@"AuthenticateVisitorResult" propertyClass:[NSString class] ] ];
	});
	return s_describer;
}
...
@implementation FLZenfolioAuthenticateVisitorResponse (ValueProperties) 
@end
