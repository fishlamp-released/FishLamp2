...
@implementation FLZfShareFavoritesSet
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfShareFavoritesSet*)object).sharerEmail = FLCopyOrRetainObject(_sharerEmail);
	((FLZfShareFavoritesSet*)object).favoritesSetId = FLCopyOrRetainObject(_favoritesSetId);
	((FLZfShareFavoritesSet*)object).favoritesSetName = FLCopyOrRetainObject(_favoritesSetName);
	((FLZfShareFavoritesSet*)object).sharerName = FLCopyOrRetainObject(_sharerName);
	((FLZfShareFavoritesSet*)object).sharerMessage = FLCopyOrRetainObject(_sharerMessage);
}
...
{
	return FLAutorelease([[FLZfShareFavoritesSet alloc] init]);
}
...
@implementation FLZfShareFavoritesSet (ValueProperties) 
