...
#import "FLZfUploadImageHttpRequest.h"

@implementation FLZfUploadImageHttpRequest
...
//        FLThrowErrorCode_v(FLZfErrorDomain, FLZfErrorCodeUploadPhotoSetNotFound, @"PhotoSet not found: %@", _photo.uploadGallery.name);
//    }
...
//        }
//        else {
//            FLThrowErrorCode_v(FLZfErrorDomain, FLZfErrorCodeUnknownObjectId, @"invalid photo id returned from server");
//        }
//    }
//    
//    return nil;
