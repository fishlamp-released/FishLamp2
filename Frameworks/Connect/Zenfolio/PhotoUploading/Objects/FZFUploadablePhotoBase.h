...
//
//	FLZenfolioUploadablePhotoBase.h
//	Project: FishLamp
//	Schema: ZenObjects
//
...
// --------------------------------------------------------------------
// FLZenfolioUploadablePhotoBase
// --------------------------------------------------------------------
@interface FLZenfolioUploadablePhotoBase : FLZenfolioPhotoUpdater<NSCopying, NSCoding>{ 
@private
	NSString* _photoDataFileName;
	NSNumber* _uploadFileId;
	NSNumber* _sortId;
	FLZenfolioUploadGallery* _uploadGallery;
...
@property (readwrite, retain, nonatomic) FLZenfolioUploadGallery* uploadGallery;
...
@interface FLZenfolioUploadablePhotoBase (ValueProperties) 
