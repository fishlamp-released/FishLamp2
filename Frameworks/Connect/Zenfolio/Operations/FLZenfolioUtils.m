...
void FLZenfolioOrangeColorizer(FLGradientButtonBaseClass* button)
{
...
@implementation FLZenfolioUtils
...
NSString *FLZenfolioSizeString(long long size)
{
	if ( size < KILO ) {
...
@implementation FLZenfolioPresentationModeOptions (Utils)

+ (FLZenfolioPresentationModeOptions*) defaultOptions
{
	FLZenfolioPresentationModeOptions* options = [FLZenfolioPresentationModeOptions presentationModeOptions];
	FLZenfolioLocalPreferences* prefs = [FLZenfolioLocalPreferences loadPreferences];
...
@implementation FLZenfolioCachedCategories (Cache)
FLSynthesizeCachedObjectHandlerProperty(FLZenfolioCachedCategories);
@end
