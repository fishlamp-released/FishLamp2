...
void FLZfOrangeColorizer(FLGradientButtonBaseClass* button)
{
...
NSString *FLZfSizeString(long long size)
{
	if ( size < KILO ) {
...
@implementation FLZfPresentationModeOptions (Utils)

+ (FLZfPresentationModeOptions*) defaultOptions
{
	FLZfPresentationModeOptions* options = [FLZfPresentationModeOptions presentationModeOptions];
	FLZfLocalPreferences* prefs = [FLZfLocalPreferences loadPreferences];
...
@implementation FLZfCachedCategories (Cache)
FLSynthesizeCachedObjectHandlerProperty(FLZfCachedCategories);
@end


@implementation FLZfBrowserViewOptions (Utils)
