...
#import "FLZfBatchSavePhotosToDevice.h"
#if IOS
...
@implementation FLZfBatchSavePhotosToDevice
...
{
	FLZfLoadImageFromCacheOperation* downloader = (FLZfLoadImageFromCacheOperation*) saver.previousOperation;
...
- (FLAction*) createActionWithCurrentQueueObject:(id) object
{
	...
	FLZfLoadImageFromCacheOperation* downloader = 
        FLAutorelease([[FLZfLoadImageFromCacheOperation alloc] initWithSubOperation: FLAutorelease([[FLZfDownloadImageHttpRequest alloc] initWithPhoto:photo photoSize:_downloadSize])]);
