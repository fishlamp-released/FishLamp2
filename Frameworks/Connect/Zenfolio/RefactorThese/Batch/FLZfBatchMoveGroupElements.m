...
#import "FLZfBatchMoveGroupElements.h"
...
@implementation FLZfBatchMoveGroupElements
...
- (FLAction*) createActionWithCurrentQueueObject:(id) object
{
	...
	{
		FLZfApiSoapMoveGroup* moveGroup = [[FLZfApiSoapMoveGroup alloc] initWithServerContext:[FLZfApiSoap instance]];
...
//        [moveGroup setDidPerformCallback:self action:@selector(updateCacheAfterMoving:)];
	...
	{
		FLZfApiSoapMovePhotoSet* moveGallery = [[FLZfApiSoapMovePhotoSet alloc] initWithServerContext:[FLZfApiSoap instance]];
