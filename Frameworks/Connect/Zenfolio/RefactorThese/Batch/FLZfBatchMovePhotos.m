...
@implementation FLZfBatchMovePhotos
...
- (FLAction*) createActionWithCurrentQueueObject:(id) object {
	...
	{
		FLZfApiSoapMovePhoto* moveOp = [[FLZfApiSoapMovePhoto alloc] initWithServerContext:[FLZfApiSoap instance]];
...
//		[moveOp setDidPerformCallback:self action:@selector(_updateCacheAfterMove:)];
	...
	{
		FLZfApiSoapCollectionAddPhoto* addToCollection = [[FLZfApiSoapCollectionAddPhoto alloc] initWithServerContext:[FLZfApiSoap instance]];
