...
@interface FLZfImageSize ()
@property (readwrite, strong) NSString* sizeName;
@end

@interface FLZfOriginalImageSize : FLZfImageSize
@end
...
+ (FLSizeEnum) smallestSizeEnumEnclosingSize:(CGSize) size  {
    ...
    FLSizeEnum outSize = FLZfPhotoSizeOriginal;
...
- (id) initWithSizeEnum:(FLSizeEnum) size {
    ...
    if(self) {
        _sizeEnum = size;
        _size = [FLZfImageSize sizeFromSizeEnum:size];
        self.sizeName = [FLZfImageSize stringFromSizeEnum:size];
...
+ (FLZfImageSize*) smallThumbnailSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kSmallThumbnail80x80]; );
}

+ (FLZfImageSize*) squareThumbnailSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kSquareThumbnail60x60]; );
}

+ (FLZfImageSize*) mediumThumbnailSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kMediumThumbnail120x120]; );
}

+ (FLZfImageSize*) largeThumbnailSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kLargeThumbnail200x200]; );
}

+ (FLZfImageSize*) smallImageSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kSmallImage400x400]; );
}

+ (FLZfImageSize*) mediumImageSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kMediumImage580x450]; );
}

+ (FLZfImageSize*) largeImageSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kLargeImage800x630]; );
}

+ (FLZfImageSize*) xLargeImageSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kXLargeImage1100x850]; );
}

+ (FLZfImageSize*) xxLargeImageSize {
    FLReturnStaticObject([[FLZfImageSize alloc] initWithSizeEnum:kXXLargeImage1550x960]; );
}

+ (FLZfImageSize*) originalImageSize {
    FLReturnStaticObject([[FLZfOriginalImageSize alloc] initWithSizeEnum:FLZfPhotoSizeOriginal]; );
}
...
+ (FLZfImageSize*) imageSizeFromSizeEnum:(FLSizeEnum) sizeEnum {
    for(FLZfImageSize* size in [self allImageSizes]) {
...
//
//+ (FLZfImageSize*) smallestSizeEnclosingSize:(CGSize) size {
//
...
- (NSURL*) urlForImage:(FLZfPhoto*) photo {
