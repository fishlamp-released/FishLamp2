...
@implementation FLZfSinglePhotoUploader

FLAssertDefaultInitNotCalled_();

- (id) initWithPhoto:(FLZfQueuedPhoto*) photo uploadQueue:(FLZfUploadQueue*) uploadQueue
{
...
- (NSSet*) uploadGalleries
{
    ...
    {
        self.photo.uploadGallery = [FLZfUploadGallery defaultUploadGallery];
