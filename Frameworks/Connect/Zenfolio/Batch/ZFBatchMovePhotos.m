...
@implementation ZFBatchMovePhotos
...
- (FLAction*) createActionWithCurrentQueueObject:(id) object {
	...
	{
		ZFApiSoapMovePhoto* moveOp = [[ZFApiSoapMovePhoto alloc] initWithServerContext:[ZFApiSoap instance]];
...
//		[moveOp setDidPerformCallback:self action:@selector(_updateCacheAfterMove:)];
	...
	{
		ZFApiSoapCollectionAddPhoto* addToCollection = [[ZFApiSoapCollectionAddPhoto alloc] initWithServerContext:[ZFApiSoap instance]];
