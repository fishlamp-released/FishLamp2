...
//
#if REFACTOR
#import "FLZenfolioBatchDeletePhotos.h"
#import "FLAction.h"
...
@implementation FLZenfolioBatchDeletePhotos
...
- (FLAction*) createActionWithCurrentQueueObject:(id) object
{
	...
	FLZenfolioPhotoSetType type = _photoSet.TypeValue;
	if(type == FLZenfolioPhotoSetTypeGallery)
	{
		FLZenfolioApiSoapDeletePhoto* operation = [[FLZenfolioApiSoapDeletePhoto alloc] initWithServerContext:[FLZenfolioApiSoap instance]];
...
//		[operation setDidPerformCallback:self action:@selector(onUpdateCacheAfterDeletedPhoto:)];
	...
	{
		FLZenfolioApiSoapCollectionRemovePhoto* operation = [[FLZenfolioApiSoapCollectionRemovePhoto alloc] initWithServerContext:[FLZenfolioApiSoap instance]];
