...
//
//	FLZenfolioSharedFavoritesSet.h
//	Project: FishLamp
//	Schema: ZenObjects
//
...
// --------------------------------------------------------------------
// FLZenfolioSharedFavoritesSet
// --------------------------------------------------------------------
@interface FLZenfolioSharedFavoritesSet : NSObject<NSCopying, NSCoding>{ 
@private
...
@interface FLZenfolioSharedFavoritesSet (ValueProperties) 
@end
