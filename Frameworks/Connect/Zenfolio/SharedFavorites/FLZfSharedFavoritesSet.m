...
@implementation FLZfSharedFavoritesSet
...
- (void) copySelfTo:(id) object
{
	...
	((FLZfSharedFavoritesSet*)object).sharedFavoritesSetId = FLCopyOrRetainObject(_sharedFavoritesSetId);
	((FLZfSharedFavoritesSet*)object).sharerName = FLCopyOrRetainObject(_sharerName);
	((FLZfSharedFavoritesSet*)object).favoritesSetName = FLCopyOrRetainObject(_favoritesSetName);
	((FLZfSharedFavoritesSet*)object).photographerLogin = FLCopyOrRetainObject(_photographerLogin);
	((FLZfSharedFavoritesSet*)object).photoIds = FLCopyOrRetainObject(_photoIds);
	((FLZfSharedFavoritesSet*)object).sharerEmail = FLCopyOrRetainObject(_sharerEmail);
	((FLZfSharedFavoritesSet*)object).sharerMessage = FLCopyOrRetainObject(_sharerMessage);
}
...
{
	return FLAutorelease([[FLZfSharedFavoritesSet alloc] init]);
}
...
@implementation FLZfSharedFavoritesSet (ValueProperties) 
@end
