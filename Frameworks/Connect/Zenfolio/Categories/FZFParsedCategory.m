...
+ (NSString*) displayFormatterDataToString:(FLZenfolioParsedCategory*) aCat
{
...
{
	return FLAutorelease([[FLZenfolioParsedCategory alloc] initEmptyCategory]);
}
