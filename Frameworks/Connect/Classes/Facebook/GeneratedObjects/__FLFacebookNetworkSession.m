...
+ (FLObjectDescriber*) objectDescriber
{
    ...
    dispatch_once(&pred, ^{
        ...
        [s_describer addProperty:@"permissions" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"permission" objectClass:[NSString class] ], nil]];
    });
    return s_describer;
}
