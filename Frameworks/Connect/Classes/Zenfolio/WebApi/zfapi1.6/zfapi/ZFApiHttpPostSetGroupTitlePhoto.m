...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFSetGroupTitlePhotoHttpPostIn class]];
		[s_describer addProperty:@"output" withClass:[ZFSetGroupTitlePhotoHttpPostOut class]];
	});
	return s_describer;
}
