...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"AccessDescriptor" withClass:[ZFAccessDescriptor class]];
		...
		[s_describer addProperty:@"ExifTagsArray" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"ExifTags" objectClass:[ZFExifTag class]], nil]];
		...
		[s_describer addProperty:@"categoryArray" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"parsedCategory" objectClass:[ZFParsedCategory class]], nil]];
	});
	return s_describer;
}
