...
//
//	ZFCollectionAddPhotoHttpGetIn.h
...
// --------------------------------------------------------------------
// ZFCollectionAddPhotoHttpGetIn
// --------------------------------------------------------------------
@interface ZFCollectionAddPhotoHttpGetIn : NSObject<NSCoding, NSCopying>{ 
@private
...
@interface ZFCollectionAddPhotoHttpGetIn (ValueProperties) 
@end
