...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"BioPhoto" withClass:[ZFFile class]];
		...
		[s_describer addProperty:@"PublicAddress" withClass:[ZFAddress class]];
		[s_describer addProperty:@"PersonalAddress" withClass:[ZFAddress class]];
		[s_describer addProperty:@"RecentPhotoSets" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"PhotoSet" objectClass:[ZFPhotoSet class]], nil]];
		[s_describer addProperty:@"FeaturedPhotoSets" withArrayTypes:[NSArray arrayWithObjects:[FLObjectDescriber objectDescriber:@"PhotoSet" objectClass:[ZFPhotoSet class]], nil]];
		[s_describer addProperty:@"RootGroup" withClass:[ZFGroup class]];
