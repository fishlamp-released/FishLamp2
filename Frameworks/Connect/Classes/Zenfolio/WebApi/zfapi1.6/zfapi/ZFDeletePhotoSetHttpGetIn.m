...
@implementation ZFDeletePhotoSetHttpGetIn
...
- (void) copySelfTo:(id) object
{
	...
	((ZFDeletePhotoSetHttpGetIn*)object).photoSetId = FLCopyOrRetainObject(_photoSetId);
}
...
{
	return FLAutorelease([[ZFDeletePhotoSetHttpGetIn alloc] init]);
}
...
@implementation ZFDeletePhotoSetHttpGetIn (ValueProperties) 
@end
