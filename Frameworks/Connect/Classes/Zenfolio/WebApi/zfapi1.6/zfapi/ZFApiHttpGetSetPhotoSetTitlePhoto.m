...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFSetPhotoSetTitlePhotoHttpGetIn class]];
		[s_describer addProperty:@"output" withClass:[ZFSetPhotoSetTitlePhotoHttpGetOut class]];
	});
	return s_describer;
}
