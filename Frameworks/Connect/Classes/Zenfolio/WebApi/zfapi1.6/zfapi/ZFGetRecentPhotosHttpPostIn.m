...
- (void) copySelfTo:(id) object
{
	...
	((ZFGetRecentPhotosHttpPostIn*)object).limit = FLCopyOrRetainObject(_limit);
	((ZFGetRecentPhotosHttpPostIn*)object).offset = FLCopyOrRetainObject(_offset);
}
...
{
	return FLAutorelease([[ZFGetRecentPhotosHttpPostIn alloc] init]);
}
...
@implementation ZFGetRecentPhotosHttpPostIn (ValueProperties) 
@end
