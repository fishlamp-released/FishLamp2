...
+ (FLObjectDescriber*) objectDescriber
{
	...
	dispatch_once(&pred, ^{
		...
		[s_describer addProperty:@"input" withClass:[ZFSetGroupTitlePhotoHttpGetIn class]];
		[s_describer addProperty:@"output" withClass:[ZFSetGroupTitlePhotoHttpGetOut class]];
	});
	return s_describer;
}
