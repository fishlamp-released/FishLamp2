...
- (id) initWithStartColor:(UIColor*) color 
    ...
    return [self initWithStartColor:[UIColor colorWithColorValues:startColor]
...
+ (FLColorRange*) iPhoneBlueGradientColorRange {
	...
	FLReturnStaticObject( 
        [[FLColorRange alloc] initWithStartColor:[UIColor iPhoneBlueColor] rangeSeperationPercentage:0.3f];
        );
...
+(FLColorRange*) redGradientColorRange {
	FLReturnStaticObject( 
        [[FLColorRange alloc] initWithStartColor:FLColorCreateWithRGBColorValues(236,19,20,1.0)  endColor:[UIColor fireEngineRed]];
        );
}
...
+(FLColorRange*) blackGradientColorRange {
	FLReturnStaticObject( 
        [[FLColorRange alloc] initWithStartColor:[UIColor darkGrayColor] endColor:[UIColor blackColor]];
        );
}
