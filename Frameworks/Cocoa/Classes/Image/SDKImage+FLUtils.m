...
- (void)imageByScalingAndCroppingForSize:(SDKImage**) outImage targetSize:(CGSize)targetSize
{
#if IOS
...
#endif    
		NSData* data = SDKImageJPEGRepresentation(self, imageData.compression);
	...
	if( nil != img)
	{
        ...
        @try {
            FLAutoreleasePool(
                ...
                newImage = FLRetain([SDKImage imageWithCGImage:imageMasked]);
            )
        }
        @finally {
