...
//
//+ (id) xmlObjectBuilder:(FLXmlObjectBuilder*) builder
//   objectWithXmlElement:(FLParsedItem*) xmlElement {
//    
//}
//
//
...
////    FLAssertNotNil(object);
//    
////- (void) xmlObjectBuilder:(FLXmlObjectBuilder*) builder 
////     addPropertiesWithXml:(FLParsedItem*) element {
////
////    FLAssert([self isModelObject]);
////    
////    FLObjectDescriber* objectDescriber = self.objectDescriber;
////
////    for(id elementName in element.elements) {
////        
////        FLPropertyDescriber* propertyDescriber = [objectDescriber propertyForName:elementName];
////        if(!propertyDescriber) {
////            FLLog(@"object builder skipped missing propertyDescriber named: %@", elementName);
////            continue;
////        }
...
////        
////        if(object) {
////            [self setValue:object forKey:elementName];
////        }
////        else {
////            FLLog(@"object not inflated for %@", [propertyDescriber description]);
////        }
////    }
////
////}
