...
- (FLPromise*) queueObject:(id<FLQueueableAsyncOperation>) object
                completion:(fl_completion_block_t) completionOrNil {
    return [self queueAsyncInitiator:[object asyncInitiatorForAsyncQueue:self withDelay:0] completion:completionOrNil];
}

- (FLPromise*) queueObject:(id<FLQueueableAsyncOperation>) object {
    return [self queueAsyncInitiator:[object asyncInitiatorForAsyncQueue:self withDelay:0] completion:nil];
}
