                                  ...
                                  intensity:(CGFloat) intensity
{
    ...
    return [FLColorRange colorRange:[UIColor colorWithColor_t:startColor] endColor:[UIColor colorWithColor_t:endColor]];
}	

+ (FLColorRange*) iPhoneBlueGradientColorRange {

	FLReturnStaticObjectFromBlock(^{ 
        return [FLColorRange gradientColorsFromColor:[UIColor iPhoneBlueColor] intensity:0.7f];
        });
...
+(FLColorRange*) redGradientColorRange {
	FLReturnStaticObjectFromBlock(^{ 
        return [FLColorRange colorRange:FLRgbColor(236,19,20,1.0)  endColor:[UIColor fireEngineRed]];
        });
}
...
//{
//    FLSynchronizedStatic(s_color, FLGradientColorPair, [[FLGradientColorPair alloc] initWithStartColor:FLRgbColor(240,127,136,1.0) endColor:[UIColor fireEngineRed]]);
...
////    FLSynchronizedStatic(s_color, FLGradientColorPair, [[FLGradientColorPair alloc] initWithStartColor:FLRgbColor(236,19,20,1.0)  endColor:[UIColor fireEngineRed]]);
//    return s_color;
//}
//
