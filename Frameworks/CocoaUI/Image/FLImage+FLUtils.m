...
@property (readwrite, retain, nonatomic) FLImage* outputImage;
...
@implementation FLImage (FLUtils)
...
- (void) shrinkImage:(FLImage**) outImage
	...
	if( nil != img)
	{
        ...
        @try {
            FLAutoreleasePool(
                ...
                newImage = FLRetain([FLImage imageWithCGImage:imageMasked]);
            )
        }
        @finally {
